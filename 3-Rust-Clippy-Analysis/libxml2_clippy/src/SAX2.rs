...
pub unsafe extern "C" fn xmlSAX2InternalSubset(
    ...
    (*(*ctxt).myDoc)
        .intSubset = xmlCreateIntSubset((*ctxt).myDoc, name, ExternalID, SystemID);
...
pub unsafe extern "C" fn xmlSAX2ExternalSubset(
            ...
            && ((*ctxt).wellFormed != 0 && !((*ctxt).myDoc).is_null()))
    {
        ...
        if ((*input).filename).is_null() {
            (*input).filename = xmlCanonicPath(SystemID) as *mut libc::c_char;
        }
...
pub unsafe extern "C" fn xmlSAX2GetEntity(
    ...
    if !ret.is_null() && ((*ctxt).validate != 0 || (*ctxt).replaceEntities != 0)
            ...
            == XML_EXTERNAL_GENERAL_PARSED_ENTITY as libc::c_int as libc::c_uint
    {
        ...
        val = xmlParseCtxtExternalEntity(
            ctxt,
            (*ret).URI,
            (*ret).ExternalID,
            &mut children,
        ...
        (*ret).owner = 1 as libc::c_int;
        if (*ret).checked == 0 as libc::c_int {
            (*ret)
...
pub unsafe extern "C" fn xmlSAX2NotationDecl(
    ...
    if publicId.is_null() && systemId.is_null() {
        ...
        return;
    } else if (*ctxt).inSubset == 1 as libc::c_int {
            ...
            loop {
                ...
                if !((*prop).ns).is_null() {
                            ...
                            || xmlStrEqual((*namespace).href, (*(*prop).ns).href) != 0)
                    {
                        ...
                        current_block = 6402390575538146407;
                        break;
                    }
                }
                prop = (*prop).next;
        ...
        900943123863005455 => {
            ...
            if !ret.is_null() {
                if (*ctxt).replaceEntities == 0 as libc::c_int && (*ctxt).html == 0 {
                    ...
                    (*ret)
                        .children = xmlNewDocText((*ctxt).myDoc as *const xmlDoc, value);
                        ...
                        && (*ctxt).inSubset == 0 as libc::c_int)
            {
                ...
                {
                    if xmlValidateNCName(value, 1 as libc::c_int) != 0 as libc::c_int {
                        xmlErrValid(
                            ctxt,
                            XML_DTD_XMLID_VALUE,
...
pub unsafe extern "C" fn xmlSAX2StartElement(
    ...
    if (*ctxt).linenumbers != 0 {
        if !((*ctxt).input).is_null() {
            if (*(*ctxt).input).line < 65535 as libc::c_int {
                (*ret).line = (*(*ctxt).input).line as libc::c_short as libc::c_ushort;
            } else {
                (*ret).line = 65535 as libc::c_int as libc::c_ushort;
            }
        }
    }
    nodePush(ctxt, ret);
    ...
    if (*ctxt).validate != 0 && (*ctxt).vctxt.finishDtd == 0xabcd1234 as libc::c_uint {
        ...
        (*ctxt).vctxt.finishDtd = 0xabcd1235 as libc::c_uint;
    }
    if !prefix.is_null() {
        xmlFree.expect("non-null function pointer")(prefix as *mut libc::c_void);
    }
...
unsafe extern "C" fn xmlSAX2TextNode(
    ...
    if (*ctxt).dictNames != 0 {
                ...
                != '!' as i32
        {
            ...
            loop {
                ...
                {
                    current_block = 7505010015112663660;
                    break;
                }
                i += 1;
                i;
    ...
    if intern.is_null() {
        ...
        (*ret).content = intern as *mut xmlChar;
    }
    if (*ctxt).linenumbers != 0 {
        if !((*ctxt).input).is_null() {
            if (*(*ctxt).input).line < 65535 as libc::c_int {
                ...
                if (*ctxt).options & XML_PARSE_BIG_LINES as libc::c_int != 0 {
                    (*ret)
                        .psvi = (*(*ctxt).input).line as ptrdiff_t as *mut libc::c_void;
                }
            }
        }
    }
...
unsafe extern "C" fn xmlSAX2DecodeAttrEntities(
    ...
    loop {
        ...
        if *fresh10 as libc::c_int == '&' as i32 {
            current_block = 8811088060468768374;
            break;
        }
    }
    match current_block {
        12675440807659640239 => return 0 as *mut xmlChar,
        _ => {
            (*ctxt).depth += 1;
            (*ctxt).depth;
...
unsafe extern "C" fn xmlSAX2AttributeNs(
    ...
    if (*ctxt).replaceEntities == 0 as libc::c_int && (*ctxt).html == 0 {
        ...
        if *valueend as libc::c_int != 0 as libc::c_int {
            ...
            (*ret)
                .children = xmlStringLenGetNodeList(
                (*ctxt).myDoc as *const xmlDoc,
                value,
                valueend.offset_from(value) as libc::c_long as libc::c_int,
            );
                ...
                && (*ctxt).inSubset == 0 as libc::c_int)
    {
                ...
                == 0 as libc::c_int
        {
            ...
            if xmlValidateNCName(dup, 1 as libc::c_int) != 0 as libc::c_int {
                xmlErrValid(
                    ctxt,
                    XML_DTD_XMLID_VALUE,
                    b"xml:id : attribute value %s is not an NCName\n\0" as *const u8
                ...
                && (*attributes.offset((j + 2 as libc::c_int) as isize)).is_null()
            {
                if (*ctxt).dictNames != 0 {
                    ...
                    if !fullname_0.is_null() {
                        ...
                        current_block_105 = 17711149709958600598;
                    } else {
                        current_block_105 = 517042441694919077;
                    }
                } else {
                    lname = xmlBuildQName(
                        *attributes.offset(j as isize),
        ...
        if coalesceText != 0 && (*ctxt).nodemem != 0 as libc::c_int {
            ...
            if (*ctxt).nodelen as size_t
                ...
                || ((*ctxt).nodemem as size_t).wrapping_add(len as size_t)
                    > -(1 as libc::c_int) as size_t / 2 as libc::c_int as size_t
            {
                xmlSAX2ErrMemory(
                    ctxt,
            ...
            if (*ctxt).nodelen + len >= (*ctxt).nodemem {
                ...
                size = size * 2 as libc::c_int as size_t;
                newbuf = xmlRealloc
                    .expect(
                        "non-null function pointer",
...
#[no_mangle]
pub unsafe extern "C" fn xmlSAX2InitDocbDefaultSAXHandler(mut hdlr: *mut xmlSAXHandler) {
    if hdlr.is_null() || (*hdlr).initialized != 0 as libc::c_int as libc::c_uint {
        return;
    }
    (*hdlr)
...
pub unsafe extern "C" fn docbDefaultSAXHandlerInit() {
    xmlSAX2InitDocbDefaultSAXHandler(__docbDefaultSAXHandler() as xmlSAXHandlerPtr);
}

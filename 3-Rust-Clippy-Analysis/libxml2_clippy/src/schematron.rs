...
unsafe extern "C" fn xmlSchematronAddTest(
    ...
    ret = xmlMalloc
        ...
        )(::core::mem::size_of::<xmlSchematronTest>() as libc::c_ulong)
...
unsafe extern "C" fn xmlSchematronAddRule(
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlSchematronRule>() as libc::c_ulong)
...
unsafe extern "C" fn xmlSchematronAddPattern(
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlSchematronPattern>() as libc::c_ulong)
...
unsafe extern "C" fn xmlSchematronNewSchematron(
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlSchematron>() as libc::c_ulong) as xmlSchematronPtr;
    if ret.is_null() {
        xmlSchematronPErrMemory(
            ctxt,
    ...
    memset(
        ret as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<xmlSchematron>() as libc::c_ulong,
    );
    (*ret).dict = (*ctxt).dict;
...
pub unsafe extern "C" fn xmlSchematronNewParserCtxt(
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlSchematronParserCtxt>() as libc::c_ulong)
    ...
    (*ret).URL = xmlDictLookup((*ret).dict, URL as *const xmlChar, -(1 as libc::c_int));
...
unsafe extern "C" fn xmlSchematronAddNamespace(
    ...
    let ref mut fresh0 = *((*ctxt).namespaces)
        .offset((2 as libc::c_int * (*ctxt).nbNamespaces) as isize);
    *fresh0 = xmlDictLookup((*ctxt).dict, ns, -(1 as libc::c_int));
    let ref mut fresh1 = *((*ctxt).namespaces)
        .offset((2 as libc::c_int * (*ctxt).nbNamespaces + 1 as libc::c_int) as isize);
    *fresh1 = xmlDictLookup((*ctxt).dict, prefix, -(1 as libc::c_int));
    (*ctxt).nbNamespaces += 1;
    (*ctxt).nbNamespaces;
    let ref mut fresh2 = *((*ctxt).namespaces)
        .offset((2 as libc::c_int * (*ctxt).nbNamespaces) as isize);
    *fresh2 = 0 as *const xmlChar;
    let ref mut fresh3 = *((*ctxt).namespaces)
        .offset((2 as libc::c_int * (*ctxt).nbNamespaces + 1 as libc::c_int) as isize);
...
unsafe extern "C" fn xmlSchematronParseRule(
    ...
    if context.is_null() {
        ...
        return;
    } else if *context.offset(0 as libc::c_int as isize) as libc::c_int
        == 0 as libc::c_int
    {
        xmlSchematronPErr(
            ctxt,
            rule,
            XML_SCHEMAP_NOROOT as libc::c_int,
            b"rule has an empty context attribute\0" as *const u8 as *const libc::c_char,
            0 as *const xmlChar,
            0 as *const xmlChar,
        );
            ...
            || xmlStrEqual((*(*root).ns).href, xmlOldSchematronNs) != 0))
    {
        ...
        if !ret.is_null() {
                    ...
                    || xmlStrEqual((*(*cur).ns).href, xmlOldSchematronNs) != 0)
            {
                ...
                if !title.is_null() {
                    (*ret)
                        .title = xmlDictLookup((*ret).dict, title, -(1 as libc::c_int));
                    xmlFree
...
pub unsafe extern "C" fn xmlSchematronNewValidCtxt(
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlSchematronValidCtxt>() as libc::c_ulong)

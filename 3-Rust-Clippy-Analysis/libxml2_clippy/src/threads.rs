...
pub unsafe extern "C" fn xmlNewMutex() -> xmlMutexPtr {
    ...
    tok = malloc(::core::mem::size_of::<xmlMutex>() as libc::c_ulong) as xmlMutexPtr;
    if tok.is_null() {
...
pub unsafe extern "C" fn xmlNewRMutex() -> xmlRMutexPtr {
    ...
    tok = malloc(::core::mem::size_of::<xmlRMutex>() as libc::c_ulong) as xmlRMutexPtr;
    if tok.is_null() {
...
unsafe extern "C" fn xmlNewGlobalState() -> xmlGlobalStatePtr {
    ...
    gs = malloc(::core::mem::size_of::<xmlGlobalState>() as libc::c_ulong)
    ...
    memset(
        ...
        0 as libc::c_int,
        ::core::mem::size_of::<xmlGlobalState>() as libc::c_ulong,
    );

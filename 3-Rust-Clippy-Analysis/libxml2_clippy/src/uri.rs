...
unsafe extern "C" fn xmlParse3986Port(
    ...
    if *cur as libc::c_int >= '0' as i32 && *cur as libc::c_int <= '9' as i32 {
        ...
        if !uri.is_null() {
            (*uri)
                .port = (port & 2147483647 as libc::c_int as libc::c_uint)
                as libc::c_int;
        }
        *str = cur;
        return 0 as libc::c_int;
...
unsafe extern "C" fn xmlParse3986Host(
    ...
    if *cur as libc::c_int == '[' as i32 {
        ...
        if *cur as libc::c_int >= '0' as i32 && *cur as libc::c_int <= '9' as i32 {
            if xmlParse3986DecOctet(&mut cur) != 0 as libc::c_int {
                current_block = 7764312884199322805;
                ...
                if xmlParse3986DecOctet(&mut cur) != 0 as libc::c_int {
                    ...
                    current_block = 18057549954189883469;
                }
            }
            match current_block {
                18057549954189883469 => {}
                _ => {
                    cur = *str;
    ...
    if !uri.is_null() {
        ...
        (*uri).authority = 0 as *mut libc::c_char;
        ...
        if cur != host {
            ...
            (*uri).server = 0 as *mut libc::c_char;
        }
    }
    *str = cur;
    return 0 as libc::c_int;
        ...
        && *str.offset(1 as libc::c_int as isize) as libc::c_int == '/' as i32
    {
        ...
        || *str as libc::c_int == '%' as i32
            && (*str.offset(1 as libc::c_int as isize) as libc::c_int >= '0' as i32
                && *str.offset(1 as libc::c_int as isize) as libc::c_int <= '9' as i32
            ...
            && (*str.offset(2 as libc::c_int as isize) as libc::c_int >= '0' as i32
                && *str.offset(2 as libc::c_int as isize) as libc::c_int <= '9' as i32
...
pub unsafe extern "C" fn xmlCreateURI() -> xmlURIPtr {
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlURI>() as libc::c_ulong) as xmlURIPtr;
    if ret.is_null() {
        xmlURIErrMemory(
    ...
    memset(
        ...
        0 as libc::c_int,
        ::core::mem::size_of::<xmlURI>() as libc::c_ulong,
    );
    return ret;
}
    ...
    if !((*uri).scheme).is_null() {
        ...
        loop {
            ...
            if len >= max {
                ...
                if temp.is_null() {
                    current_block = 5248384590780028154;
                    break;
                }
                ret = temp;
            }
                ...
                loop {
                                ...
                                || *p as libc::c_int == ')' as i32))
                    {
                        ...
                        *ret.offset(fresh4 as isize) = *fresh3 as xmlChar;
                        ...
                        let fresh5 = p;
                        p = p.offset(1);
                        let mut val: libc::c_int = *(fresh5 as *mut libc::c_uchar)
                            as libc::c_int;
                ...
                if !((*uri).server).is_null() || (*uri).port == -(1 as libc::c_int) {
                    ...
                    match current_block {
                        ...
                        _ => {
                            let fresh9 = len;
                            len = len + 1;
                            *ret.offset(fresh9 as isize) = '/' as i32 as xmlChar;
                            let fresh10 = len;
                            len = len + 1;
                            *ret.offset(fresh10 as isize) = '/' as i32 as xmlChar;
                            if !((*uri).user).is_null() {
                                p = (*uri).user;
                                loop {
                                    if !(*p as libc::c_int != 0 as libc::c_int) {
                                        ...
                                        || *p as libc::c_int == ',' as i32
                                    {
                                        ...
                                        let fresh12 = len;
                                        len = len + 1;
                                        *ret.offset(fresh12 as isize) = *fresh11 as xmlChar;
                                    } else {
                                        let fresh13 = p;
                                        p = p.offset(1);
                                        let mut val_0: libc::c_int = *(fresh13
                                        ...
                                        let fresh14 = len;
                                        len = len + 1;
                                        *ret.offset(fresh14 as isize) = '%' as i32 as xmlChar;
                                        let fresh15 = len;
                                        len = len + 1;
                                        *ret
                                            .offset(
                                    ...
                                    _ => {
                                        ...
                                        match current_block {
                                            ...
                                            _ => {
                                                let fresh17 = len;
                                                len = len + 1;
                                                *ret.offset(fresh17 as isize) = '@' as i32 as xmlChar;
                                ...
                                _ => {
                                    if !((*uri).server).is_null() {
                                        ...
                                        loop {
                                            ...
                                            let fresh19 = len;
                                            len = len + 1;
                                            *ret.offset(fresh19 as isize) = *fresh18 as xmlChar;
                                        }
                                        match current_block {
                                            5248384590780028154 => {}
                                            _ => {
                    ...
                    match current_block {
                        ...
                        _ => {
                            let fresh20 = len;
                            len = len + 1;
                            *ret.offset(fresh20 as isize) = '/' as i32 as xmlChar;
                            let fresh21 = len;
                            len = len + 1;
                            *ret.offset(fresh21 as isize) = '/' as i32 as xmlChar;
                            p = (*uri).authority;
                            loop {
                                if !(*p as libc::c_int != 0 as libc::c_int) {
                                    current_block = 496303045384785551;
                                    ...
                                    || *p as libc::c_int == '+' as i32
                                {
                                    ...
                                    let fresh23 = len;
                                    len = len + 1;
                                    *ret.offset(fresh23 as isize) = *fresh22 as xmlChar;
                                } else {
                                    let fresh24 = p;
                                    p = p.offset(1);
                                    let mut val_1: libc::c_int = *(fresh24
                                        as *mut libc::c_uchar) as libc::c_int;
                                    let mut hi_1: libc::c_int = val_1 / 0x10 as libc::c_int;
                                    let mut lo_1: libc::c_int = val_1 % 0x10 as libc::c_int;
                                    let fresh25 = len;
                                    len = len + 1;
                                    *ret.offset(fresh25 as isize) = '%' as i32 as xmlChar;
                                    let fresh26 = len;
                                    len = len + 1;
                                    *ret
                                        .offset(
                                ...
                                ) != 0
                            {
                                ...
                                match current_block {
                                    ...
                                    _ => {
                                        ...
                                        let fresh29 = len;
                                        len = len + 1;
                                        *ret.offset(fresh29 as isize) = *fresh28 as xmlChar;
                                        let fresh30 = p;
                                        p = p.offset(1);
                                        let fresh31 = len;
                                        len = len + 1;
                                        *ret.offset(fresh31 as isize) = *fresh30 as xmlChar;
                                        let fresh32 = p;
                                        p = p.offset(1);
                                        let fresh33 = len;
                                        len = len + 1;
                                        *ret.offset(fresh33 as isize) = *fresh32 as xmlChar;
                                ...
                                _ => {
                                    loop {
                                            ...
                                            || *p as libc::c_int == ',' as i32
                                        {
                                            ...
                                            let fresh35 = len;
                                            len = len + 1;
                                            *ret.offset(fresh35 as isize) = *fresh34 as xmlChar;
                                        } else {
                                            let fresh36 = p;
                                            p = p.offset(1);
                                            let mut val_2: libc::c_int = *(fresh36
                                                as *mut libc::c_uchar) as libc::c_int;
                                            let mut hi_2: libc::c_int = val_2 / 0x10 as libc::c_int;
                                            let mut lo_2: libc::c_int = val_2 % 0x10 as libc::c_int;
                                            let fresh37 = len;
                                            len = len + 1;
                                            *ret.offset(fresh37 as isize) = '%' as i32 as xmlChar;
                                            let fresh38 = len;
                                            len = len + 1;
                                            *ret
                                                .offset(
                                        ...
                                        _ => {
                                            ...
                                            *ret.offset(fresh40 as isize) = '?' as i32 as xmlChar;
                                            ...
                                            loop {
                                                ...
                                                let fresh42 = len;
                                                len = len + 1;
                                                *ret.offset(fresh42 as isize) = *fresh41 as xmlChar;
                                            }
                                        }
                                    }
                                            ...
                                            loop {
                                                        ...
                                                        || *p as libc::c_int == ']' as i32)
                                                {
                                                    ...
                                                    *ret.offset(fresh45 as isize) = *fresh44 as xmlChar;
                                                    ...
                                                    let fresh46 = p;
                                                    p = p.offset(1);
                                                    let mut val_3: libc::c_int = *(fresh46
                                                        as *mut libc::c_uchar) as libc::c_int;
                    ...
                    if !((*uri).fragment).is_null() {
                        ...
                        match current_block {
                            ...
                            _ => {
                                let fresh50 = len;
                                len = len + 1;
                                *ret.offset(fresh50 as isize) = '#' as i32 as xmlChar;
                                p = (*uri).fragment;
                                loop {
                                    if !(*p as libc::c_int != 0 as libc::c_int) {
                                            ...
                                            || *p as libc::c_int == ']' as i32)
                                    {
                                        ...
                                        let fresh52 = len;
                                        len = len + 1;
                                        *ret.offset(fresh52 as isize) = *fresh51 as xmlChar;
                                    } else {
                                        let fresh53 = p;
                                        p = p.offset(1);
                                        let mut val_4: libc::c_int = *(fresh53
                                            as *mut libc::c_uchar) as libc::c_int;
                                        let mut hi_4: libc::c_int = val_4 / 0x10 as libc::c_int;
                                        let mut lo_4: libc::c_int = val_4 % 0x10 as libc::c_int;
                                        let fresh54 = len;
                                        len = len + 1;
                                        *ret.offset(fresh54 as isize) = '%' as i32 as xmlChar;
                                        let fresh55 = len;
                                        len = len + 1;
                                        *ret
                                            .offset(
...
unsafe extern "C" fn xmlCleanURI(mut uri: xmlURIPtr) {
    ...
    (*uri).scheme = 0 as *mut libc::c_char;
    if !((*uri).server).is_null() {
    ...
    (*uri).opaque = 0 as *mut libc::c_char;
    if !((*uri).authority).is_null() {
        xmlFree
...
pub unsafe extern "C" fn xmlNormalizeURIPath(
    ...
    out = cur;
    's_32: while *cur.offset(0 as libc::c_int as isize) as libc::c_int != '\0' as i32 {
            ...
            && *cur.offset(1 as libc::c_int as isize) as libc::c_int == '/' as i32
        {
            ...
            while *cur.offset(0 as libc::c_int as isize) as libc::c_int != '/' as i32 {
                ...
                *fresh58
                    ...
                    ) = *fresh57.offset(0 as libc::c_int as isize);
            }
            while *cur.offset(0 as libc::c_int as isize) as libc::c_int == '/' as i32
                && *cur.offset(1 as libc::c_int as isize) as libc::c_int == '/' as i32
            {
            ...
            *fresh60
                .offset(
                    0 as libc::c_int as isize,
                ) = *fresh59.offset(0 as libc::c_int as isize);
        }
    }
    *out.offset(0 as libc::c_int as isize) = '\0' as i32 as libc::c_char;
    ...
    loop {
        ...
        while *segp.offset(0 as libc::c_int as isize) as libc::c_int != '/' as i32
            && *segp.offset(0 as libc::c_int as isize) as libc::c_int != '\0' as i32
        {
            segp = segp.offset(1);
            segp;
        }
        if *segp.offset(0 as libc::c_int as isize) as libc::c_int == '\0' as i32 {
            break;
        }
        segp = segp.offset(1);
        segp;
        ...
        {
            cur = segp;
        } else if *segp.offset(2 as libc::c_int as isize) as libc::c_int == '\0' as i32 {
            *cur.offset(0 as libc::c_int as isize) = '\0' as i32 as libc::c_char;
            break;
        } else {
            tmp = cur;
            ...
            loop {
                ...
                tmp = tmp.offset(1);
                *fresh62 = *fresh61;
                if !(*fresh62 as libc::c_int != 0 as libc::c_int) {
                    break;
                }
            }
            segp = cur;
    ...
    if *path.offset(0 as libc::c_int as isize) as libc::c_int == '/' as i32 {
        ...
        while *cur.offset(0 as libc::c_int as isize) as libc::c_int == '/' as i32
            ...
            && (*cur.offset(3 as libc::c_int as isize) as libc::c_int == '/' as i32
                || *cur.offset(3 as libc::c_int as isize) as libc::c_int == '\0' as i32)
        {
            cur = cur.offset(3 as libc::c_int as isize);
        }
        if cur != path {
            out = path;
            while *cur.offset(0 as libc::c_int as isize) as libc::c_int != '\0' as i32 {
                let fresh63 = cur;
                cur = cur.offset(1);
                let fresh64 = out;
                out = out.offset(1);
                *fresh64
                    .offset(
                        0 as libc::c_int as isize,
                    ) = *fresh63.offset(0 as libc::c_int as isize);
            }
    ...
    while len > 0 as libc::c_int {
            ...
            && is_hex(*in_0.offset(2 as libc::c_int as isize)) != 0
        {
            ...
            if *in_0 as libc::c_int >= '0' as i32 && *in_0 as libc::c_int <= '9' as i32 {
                *out = (*in_0 as libc::c_int - '0' as i32) as libc::c_char;
            } else if *in_0 as libc::c_int >= 'a' as i32
                && *in_0 as libc::c_int <= 'f' as i32
            {
                *out = (*in_0 as libc::c_int - 'a' as i32 + 10 as libc::c_int)
                    as libc::c_char;
            } else if *in_0 as libc::c_int >= 'A' as i32
                && *in_0 as libc::c_int <= 'F' as i32
            {
            ...
            in_0;
            if *in_0 as libc::c_int >= '0' as i32 && *in_0 as libc::c_int <= '9' as i32 {
                *out = (*out as libc::c_int * 16 as libc::c_int
                    + (*in_0 as libc::c_int - '0' as i32)) as libc::c_char;
            } else if *in_0 as libc::c_int >= 'a' as i32
                && *in_0 as libc::c_int <= 'f' as i32
            {
                *out = (*out as libc::c_int * 16 as libc::c_int
                    + (*in_0 as libc::c_int - 'a' as i32) + 10 as libc::c_int)
                    as libc::c_char;
            } else if *in_0 as libc::c_int >= 'A' as i32
                && *in_0 as libc::c_int <= 'F' as i32
            {
...
pub unsafe extern "C" fn xmlBuildURI(
    ...
    if URI.is_null() {
        ...
        ref_0 = xmlCreateURI();
        if ref_0.is_null() {
            current_block = 14516512259334948190;
        } else {
                        ...
                        _ => {
                            if ret != 0 as libc::c_int {
                                ...
                                if !((*bas).fragment).is_null() {
                                    ...
                                    (*bas).fragment = 0 as *mut libc::c_char;
                                }
                                val = xmlSaveUri(bas);
                            } else {
                                res = xmlCreateURI();
                                if !res.is_null() {
                                            ...
                                            && ((*ref_0).server).is_null())
                                    {
                                        ...
                                        if !((*ref_0).fragment).is_null() {
                                            (*res)
                                                .fragment = xmlMemStrdup
                                                .expect("non-null function pointer")((*ref_0).fragment);
                                        }
                                        current_block = 6462410171587723943;
                                                    ...
                                                    *((*res).path)
                                                            ...
                                                            as libc::c_int != 0 as libc::c_int
                                                    {
                                                        ...
                                                        if out == 0 as libc::c_int && !((*bas).server).is_null() {
                                                            ...
                                                            out = out + 1;
                                                            *((*res).path)
                                                                .offset(fresh74 as isize) = '/' as i32 as libc::c_char;
                                                        }
                                                            ...
                                                            != 0 as libc::c_int
                                                        {
                                                            ...
                                                            *((*res).path)
                                                                .offset(
                                                                    fresh76 as isize,
                                                                ) = *((*ref_0).path).offset(fresh75 as isize);
                                                        }
                                                    }
                                                    *((*res).path)
                                                        .offset(out as isize) = 0 as libc::c_int as libc::c_char;
...
pub unsafe extern "C" fn xmlBuildRelativeURI(
    ...
    if *URI.offset(0 as libc::c_int as isize) as libc::c_int != '.' as i32 {
        ret = xmlParseURIReference(ref_0, URI as *const libc::c_char);
        if ret != 0 as libc::c_int {
            current_block = 11678578203265539427;
        } else {
            current_block = 2868539653012386629;
        }
    } else {
        (*ref_0).path = xmlStrdup(URI) as *mut libc::c_char;
        current_block = 2868539653012386629;
    }
    match current_block {
        2868539653012386629 => {
            if base.is_null() || *base as libc::c_int == 0 as libc::c_int {
                ...
                if !bas.is_null() {
                        ...
                        != '.' as i32
                    {
                        ...
                        (*bas).path = xmlStrdup(base) as *mut libc::c_char;
                        current_block = 6009453772311597924;
                    }
                    match current_block {
                        11678578203265539427 => {}
                        _ => {
                                ...
                                if ((*bas).path).is_null() {
                                    ...
                                    if ((*ref_0).path).is_null() {
                                            ...
                                            == *rptr.offset(pos as isize) as libc::c_int
                                        {
                                            ...
                                            ix = pos;
                                            if *rptr.offset(ix as isize) as libc::c_int == '/' as i32
                                                && ix > 0 as libc::c_int
                                            {
                                                ix -= 1;
                                                ix;
                                            } else if *rptr.offset(ix as isize) as libc::c_int
                                                == 0 as libc::c_int && ix > 1 as libc::c_int
                                                && *rptr.offset((ix - 1 as libc::c_int) as isize)
                                                    as libc::c_int == '/' as i32
                                            {
                                                ix -= 2 as libc::c_int;
                                            }
    ...
    if remove_path != 0 as libc::c_int {
        (*ref_0).path = 0 as *mut libc::c_char;
    }
    if !ref_0.is_null() {
        xmlFreeURI(ref_0);
    }
    ...
    if !absuri.is_null() {
        ...
        if !(l <= 0 as libc::c_int || l > 20 as libc::c_int) {
            ...
            loop {
                ...
                {
                    current_block = 1220476653652442094;
                    break;
                }
                j += 1;
                j;

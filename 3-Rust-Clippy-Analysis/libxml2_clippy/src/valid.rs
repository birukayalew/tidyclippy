...
extern "C" {
    ...
    fn xmlNoValidityErr(ctx: *mut libc::c_void, msg: *const libc::c_char, _: ...);
    fn memset(
        _: *mut libc::c_void,
        _: libc::c_int,
        _: libc::c_ulong,
...
unsafe extern "C" fn xmlVErrMemory(
    ...
    if !ctxt.is_null() {
        channel = (*ctxt).error;
        data = (*ctxt).userData;
        if (*ctxt).finishDtd == 0xabcd1234 as libc::c_uint
            || (*ctxt).finishDtd == 0xabcd1235 as libc::c_uint
        {
...
unsafe extern "C" fn vstateVPush(
    ...
    if (*ctxt).vstateMax == 0 as libc::c_int || ((*ctxt).vstateTab).is_null() {
        ...
        (*ctxt)
            ...
            ((*ctxt).vstateMax as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<xmlValidState>() as libc::c_ulong),
    ...
    (*ctxt)
        .vstate = &mut *((*ctxt).vstateTab).offset((*ctxt).vstateNr as isize)
        as *mut xmlValidState;
    let ref mut fresh0 = (*((*ctxt).vstateTab).offset((*ctxt).vstateNr as isize))
        .elemDecl;
    *fresh0 = elemDecl;
    let ref mut fresh1 = (*((*ctxt).vstateTab).offset((*ctxt).vstateNr as isize)).node;
    *fresh1 = node;
    if !elemDecl.is_null()
            ...
            == XML_ELEMENT_TYPE_ELEMENT as libc::c_int as libc::c_uint
    {
        ...
        if !((*elemDecl).contModel).is_null() {
            let ref mut fresh2 = (*((*ctxt).vstateTab).offset((*ctxt).vstateNr as isize))
                .exec;
            *fresh2 = xmlRegNewExecCtxt(
                (*elemDecl).contModel,
                None,
                0 as *mut libc::c_void,
            );
...
unsafe extern "C" fn vstateVPop(mut ctxt: xmlValidCtxtPtr) -> libc::c_int {
    ...
    *fresh5 = 0 as xmlElementPtr;
    let ref mut fresh6 = (*((*ctxt).vstateTab).offset((*ctxt).vstateNr as isize)).node;
    *fresh6 = 0 as xmlNodePtr;
    ...
    let ref mut fresh7 = (*((*ctxt).vstateTab).offset((*ctxt).vstateNr as isize)).exec;
    *fresh7 = 0 as xmlRegExecCtxtPtr;
    if (*ctxt).vstateNr >= 1 as libc::c_int {
        (*ctxt)
            .vstate = &mut *((*ctxt).vstateTab)
            .offset(((*ctxt).vstateNr - 1 as libc::c_int) as isize)
            as *mut xmlValidState;
    } else {
        (*ctxt).vstate = 0 as *mut xmlValidState;
    }
    ...
    match (*content).type_0 as libc::c_uint {
        ...
        2 => {
            ...
            match (*content).ocur as libc::c_uint {
                1 => {
                    (*ctxt)
                        .state = xmlAutomataNewTransition(
                        (*ctxt).am,
                        (*ctxt).state,
...
pub unsafe extern "C" fn xmlNewValidCtxt() -> xmlValidCtxtPtr {
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlValidCtxt>() as libc::c_ulong) as xmlValidCtxtPtr;
    if ret.is_null() {
        xmlVErrMemory(
...
pub unsafe extern "C" fn xmlNewDocElementContent(
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlElementContent>() as libc::c_ulong)
    ...
    if !name.is_null() {
        ...
        if tmp.is_null() {
            ...
            (*ret).name = xmlDictLookup(dict, tmp, -(1 as libc::c_int));
        }
    }
    return ret;
}
...
pub unsafe extern "C" fn xmlCopyDocElementContent(
    ...
    if !((*cur).name).is_null() {
        if !dict.is_null() {
            (*ret).name = xmlDictLookup(dict, (*cur).name, -(1 as libc::c_int));
        } else {
    ...
    if !((*cur).prefix).is_null() {
        if !dict.is_null() {
            (*ret).prefix = xmlDictLookup(dict, (*cur).prefix, -(1 as libc::c_int));
        } else {
    ...
    if !((*cur).c2).is_null() {
        ...
        while !cur.is_null() {
            ...
            if !((*cur).name).is_null() {
                if !dict.is_null() {
                    (*tmp).name = xmlDictLookup(dict, (*cur).name, -(1 as libc::c_int));
                } else {
...
unsafe extern "C" fn xmlDumpElementContent(
    ...
    match (*content).type_0 as libc::c_uint {
        1 => {
            xmlBufferWriteChar(buf, b"#PCDATA\0" as *const u8 as *const libc::c_char);
        }
        2 => {
            ...
            if !((*content).c1).is_null()
                && ((*(*content).c1).type_0 as libc::c_uint
                    ...
                    || (*(*content).c1).type_0 as libc::c_uint
                        == XML_ELEMENT_CONTENT_SEQ as libc::c_int as libc::c_uint)
            {
                xmlDumpElementContent(buf, (*content).c1, 1 as libc::c_int);
            } else {
                xmlDumpElementContent(buf, (*content).c1, 0 as libc::c_int);
            }
            xmlBufferWriteChar(buf, b" , \0" as *const u8 as *const libc::c_char);
                ...
                && ((*(*content).c2).type_0 as libc::c_uint
                    ...
                    || (*(*content).c2).type_0 as libc::c_uint
                        ...
                        && (*(*content).c2).ocur as libc::c_uint
                            != XML_ELEMENT_CONTENT_ONCE as libc::c_int as libc::c_uint)
            {
                xmlDumpElementContent(buf, (*content).c2, 1 as libc::c_int);
            } else {
                xmlDumpElementContent(buf, (*content).c2, 0 as libc::c_int);
            }
        }
        4 => {
            if !((*content).c1).is_null()
...
pub unsafe extern "C" fn xmlAddElementDecl(
    ...
    if table.is_null() {
        ...
        (*dtd).elements = table as *mut libc::c_void;
    }
    if table.is_null() {
        xmlVErrMemory(
            ctxt,
    ...
    if !ret.is_null() {
        ...
        ret = xmlMalloc
            .expect(
                "non-null function pointer",
            )(::core::mem::size_of::<xmlElement>() as libc::c_ulong) as xmlElementPtr;
        if ret.is_null() {
            xmlVErrMemory(ctxt, b"malloc failed\0" as *const u8 as *const libc::c_char);
            if !uqname.is_null() {
                xmlFree.expect("non-null function pointer")(uqname as *mut libc::c_void);
        ...
        memset(
            ret as *mut libc::c_void,
            0 as libc::c_int,
            ::core::mem::size_of::<xmlElement>() as libc::c_ulong,
        );
    ...
    (*ret).etype = type_0;
    if !ctxt.is_null()
        && ((*ctxt).finishDtd == 0xabcd1234 as libc::c_uint
            || (*ctxt).finishDtd == 0xabcd1235 as libc::c_uint)
    {
        (*ret).content = content;
        if !content.is_null() {
            (*content).parent = 1 as libc::c_int as xmlElementContentPtr;
        }
    } else {
...
pub unsafe extern "C" fn xmlDumpElementDecl(
    ...
    match (*elem).etype as libc::c_uint {
        ...
        3 => {
            ...
            xmlBufferWriteCHAR(buf, (*elem).name);
            xmlBufferWriteChar(buf, b" \0" as *const u8 as *const libc::c_char);
            xmlDumpElementContent(buf, (*elem).content, 1 as libc::c_int);
...
pub unsafe extern "C" fn xmlCreateEnumeration(
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlEnumeration>() as libc::c_ulong)
...
pub unsafe extern "C" fn xmlCopyEnumeration(
    ...
    if !((*cur).next).is_null() {
        ...
        (*ret).next = 0 as *mut _xmlEnumeration;
    }
    return ret;
}
...
pub unsafe extern "C" fn xmlAddAttributeDecl(
    ...
    if table.is_null() {
        table = xmlHashCreateDict(0 as libc::c_int, dict);
        (*dtd).attributes = table as *mut libc::c_void;
    }
    if table.is_null() {
        xmlVErrMemory(
            ctxt,
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlAttribute>() as libc::c_ulong) as xmlAttributePtr;
    if ret.is_null() {
        xmlVErrMemory(ctxt, b"malloc failed\0" as *const u8 as *const libc::c_char);
        xmlFreeEnumeration(tree);
        return 0 as xmlAttributePtr;
    ...
    memset(
        ret as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<xmlAttribute>() as libc::c_ulong,
    );
    ...
    if !dict.is_null() {
        (*ret).name = xmlDictLookup(dict, name, -(1 as libc::c_int));
        (*ret).prefix = xmlDictLookup(dict, ns, -(1 as libc::c_int));
        (*ret).elem = xmlDictLookup(dict, elem, -(1 as libc::c_int));
    } else {
        (*ret).name = xmlStrdup(name);
    ...
    if !defaultValue.is_null() {
        if !dict.is_null() {
            (*ret).defaultValue = xmlDictLookup(dict, defaultValue, -(1 as libc::c_int));
        } else {
...
pub unsafe extern "C" fn xmlAddNotationDecl(
    ...
    if table.is_null() {
        ...
        table = xmlHashCreateDict(0 as libc::c_int, dict);
        (*dtd).notations = table as *mut libc::c_void;
    }
    if table.is_null() {
        xmlVErrMemory(
            ctxt,
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlNotation>() as libc::c_ulong) as xmlNotationPtr;
    if ret.is_null() {
        xmlVErrMemory(ctxt, b"malloc failed\0" as *const u8 as *const libc::c_char);
        return 0 as xmlNotationPtr;
    }
    memset(
        ret as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<xmlNotation>() as libc::c_ulong,
    );
    (*ret).name = xmlStrdup(name);
    if !SystemID.is_null() {
...
unsafe extern "C" fn xmlCopyNotation(
    ...
    if !((*nota).PublicID).is_null() {
        ...
        (*cur).PublicID = 0 as *const xmlChar;
    }
    if !((*nota).SystemID).is_null() {
        (*cur).SystemID = xmlStrdup((*nota).SystemID);
    } else {
        (*cur).SystemID = 0 as *const xmlChar;
    }
    return cur as *mut libc::c_void;
}
#[no_mangle]
...
pub unsafe extern "C" fn xmlAddID(
    ...
    if table.is_null() {
        ...
        (*doc).ids = table as *mut libc::c_void;
    }
    if table.is_null() {
        xmlVErrMemory(
            ctxt,
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlID>() as libc::c_ulong) as xmlIDPtr;
    if ret.is_null() {
        xmlVErrMemory(ctxt, b"malloc failed\0" as *const u8 as *const libc::c_char);
        return 0 as xmlIDPtr;
    }
    ...
    (*ret).doc = doc;
    if !ctxt.is_null() && (*ctxt).vstateNr != 0 as libc::c_int {
        if !((*doc).dict).is_null() {
            (*ret).name = xmlDictLookup((*doc).dict, (*attr).name, -(1 as libc::c_int));
        } else {
...
pub unsafe extern "C" fn xmlIsID(
        ...
        == XML_HTML_DOCUMENT_NODE as libc::c_int as libc::c_uint
    {
        ...
        fullelemname = if !((*elem).ns).is_null() && !((*(*elem).ns).prefix).is_null() {
            xmlBuildQName(
                (*elem).name,
                (*(*elem).ns).prefix,
                felem.as_mut_ptr(),
        ...
        fullattrname = if !((*attr).ns).is_null() && !((*(*attr).ns).prefix).is_null() {
            xmlBuildQName(
                (*attr).name,
                (*(*attr).ns).prefix,
                fattr.as_mut_ptr(),
        ...
        {
            xmlFree
                .expect("non-null function pointer")(fullattrname as *mut libc::c_void);
        }
        if fullelemname != felem.as_mut_ptr()
            && fullelemname != (*elem).name as *mut xmlChar
        {
            xmlFree
                .expect("non-null function pointer")(fullelemname as *mut libc::c_void);
        }
        if !attrDecl.is_null()
...
pub unsafe extern "C" fn xmlAddRef(
    ...
    if table.is_null() {
        table = xmlHashCreateDict(0 as libc::c_int, (*doc).dict);
        (*doc).refs = table as *mut libc::c_void;
    }
    if table.is_null() {
        xmlVErrMemory(
            ctxt,
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlRef>() as libc::c_ulong) as xmlRefPtr;
    if ret.is_null() {
        xmlVErrMemory(ctxt, b"malloc failed\0" as *const u8 as *const libc::c_char);
        return 0 as xmlRefPtr;
    }
    ...
    if ref_list.is_null() {
        ...
        if ref_list.is_null() {
            ...
            current_block = 8395022590456328194;
...
pub unsafe extern "C" fn xmlRemoveRef(
    ...
    let mut table: xmlRefTablePtr = 0 as *mut xmlRefTable;
    let mut ID: *mut xmlChar = 0 as *mut xmlChar;
    let mut target: xmlRemoveMemo = xmlRemoveMemo_t {
        l: 0 as *mut xmlList,
        ap: 0 as *mut xmlAttr,
    };
    if doc.is_null() {
    ...
    while *src as libc::c_int != 0 as libc::c_int {
        if *src as libc::c_int == 0x20 as libc::c_int {
            ...
            if *src as libc::c_int != 0 as libc::c_int {
                let fresh11 = dst;
                dst = dst.offset(1);
                *fresh11 = 0x20 as libc::c_int as xmlChar;
            }
        } else {
            let fresh12 = src;
            src = src.offset(1);
    ...
    while *src as libc::c_int != 0 as libc::c_int {
        if *src as libc::c_int == 0x20 as libc::c_int {
            ...
            if *src as libc::c_int != 0 as libc::c_int {
                let fresh14 = dst;
                dst = dst.offset(1);
                *fresh14 = 0x20 as libc::c_int as xmlChar;
            }
        } else {
            let fresh15 = src;
            src = src.offset(1);
...
pub unsafe extern "C" fn xmlValidateAttributeDecl(
    ...
    if doc.is_null() {
        return 0 as libc::c_int
    } else if ((*doc).intSubset).is_null() && ((*doc).extSubset).is_null() {
        return 0 as libc::c_int
    }
    if attr.is_null() {
        return 1 as libc::c_int;
    ...
    while !cur.is_null() {
        ...
        match (*cur).type_0 as libc::c_uint {
            1 => {
                ...
                current_block_33 = 2604890879466389055;
            }
            3 => {
                if xmlIsBlankNode(cur as *const xmlNode) != 0 {
                    current_block_33 = 2604890879466389055;
                } else {
                    current_block_33 = 11694504731362138453;
                }
            }
            4 | 5 => {
                current_block_33 = 11694504731362138453;
            ...
            loop {
                ...
                match (*cur).type_0 as libc::c_uint {
                    ...
                    3 => {
                        if !(xmlIsBlankNode(cur as *const xmlNode) != 0) {
                            ret = 0 as libc::c_int;
                            current_block = 16444882294865765558;
                            break;
                        }
                    }
                    4 => {
...
pub unsafe extern "C" fn xmlValidatePushCData(
    ...
    if (*ctxt).vstateNr > 0 as libc::c_int && !((*ctxt).vstate).is_null() {
        ...
        if !((*state).elemDecl).is_null() {
            ...
            match (*elemDecl).etype as libc::c_uint {
                0 => {
                    current_block = 301348909790585733;
                    match current_block {
                        301348909790585733 => {
                            ret = 0 as libc::c_int;
                        }
                ...
                1 => {
                    current_block = 10446191993226919876;
                    match current_block {
                        301348909790585733 => {
                            ret = 0 as libc::c_int;
                        }
                ...
                4 => {
                    current_block = 9569070831813553192;
                    match current_block {
                        301348909790585733 => {
                            ret = 0 as libc::c_int;
                        }
                    ...
                    while !child.is_null() {
                            ...
                            == XML_ELEMENT_NODE as libc::c_int as libc::c_uint
                        {
                                ...
                                && !((*(*child).ns).prefix).is_null()
                            {
                                ...
                                if !cont.is_null() {
                                    current_block_66 = 13051096141274073040;
                                } else {
                                    current_block_66 = 3580086814630675314;
                                }
                            } else {
                                current_block_66 = 3580086814630675314;
                            }
                            match current_block_66 {
                                13051096141274073040 => {}
                                _ => {
                                    cont = (*elemDecl).content;
                                    while !cont.is_null() {
                                        if (*cont).type_0 as libc::c_uint
            ...
            == XML_ATTRIBUTE_REQUIRED as libc::c_int as libc::c_uint
        {
                ...
                ) != 0
            {
                ...
                loop {
                    ...
                    if ((*ns).prefix).is_null() {
                        current_block = 8009598171860249001;
                        break;
                    }
                    ns = (*ns).next;
                }
    ...
    if !((*doc).intSubset).is_null() && !((*(*doc).intSubset).name).is_null() {
        if xmlStrEqual((*(*doc).intSubset).name, (*root).name) == 0 {
            if !((*root).ns).is_null() && !((*(*root).ns).prefix).is_null() {
                ...
                if ret == 1 as libc::c_int {
                    current_block = 16992358288580218090;
                } else {
...
unsafe extern "C" fn xmlValidateCheckRefCallback(
    ...
    let mut memo: xmlValidateMemo = xmlValidateMemo_t {
...
pub unsafe extern "C" fn xmlValidateDocumentFinal(
    ...
    save = (*ctxt).finishDtd;
    (*ctxt).finishDtd = 0 as libc::c_int as libc::c_uint;
    table = (*doc).refs as xmlRefTablePtr;
    (*ctxt).doc = doc;
...
pub unsafe extern "C" fn xmlValidateDtd(
    ...
    if !((*doc).ids).is_null() {
        ...
        (*doc).ids = 0 as *mut libc::c_void;
    }
    if !((*doc).refs).is_null() {
        xmlFreeRefTable((*doc).refs as xmlRefTablePtr);
        (*doc).refs = 0 as *mut libc::c_void;
    }
    root = xmlDocGetRootElement(doc as *const xmlDoc);
...
pub unsafe extern "C" fn xmlValidGetPotentialChildren(
    ...
    match (*ctree).type_0 as libc::c_uint {
        1 => {
            ...
            *fresh18 = b"#PCDATA\0" as *const u8 as *const libc::c_char as *mut xmlChar;
        }
        2 => {
            i = 0 as libc::c_int;
            while i < *len {

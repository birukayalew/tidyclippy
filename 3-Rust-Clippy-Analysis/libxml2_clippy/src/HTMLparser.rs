...
unsafe extern "C" fn htmlNodeInfoPush(
    ...
    if (*ctxt).nodeInfoNr >= (*ctxt).nodeInfoMax {
        ...
        (*ctxt)
            ...
            ((*ctxt).nodeInfoMax as libc::c_ulong)
                .wrapping_mul(
                    ::core::mem::size_of::<xmlParserNodeInfo>() as libc::c_ulong,
                ),
    ...
    *((*ctxt).nodeInfoTab).offset((*ctxt).nodeInfoNr as isize) = *value;
    (*ctxt)
        .nodeInfo = &mut *((*ctxt).nodeInfoTab).offset((*ctxt).nodeInfoNr as isize)
                ...
                & 0xc0 as libc::c_int != 0x80 as libc::c_int)
            {
                if c as libc::c_int & 0xe0 as libc::c_int == 0xe0 as libc::c_int {
                    ...
                    if *cur.offset(2 as libc::c_int as isize) as libc::c_int
                        & 0xc0 as libc::c_int != 0x80 as libc::c_int
                    {
                        current_block = 2839239705810453603;
...
static mut htmlStartClose: [*const libc::c_char; 394] = [
    b"form\0" as *const u8 as *const libc::c_char,
    b"form\0" as *const u8 as *const libc::c_char,
    b"p\0" as *const u8 as *const libc::c_char,
    b"hr\0" as *const u8 as *const libc::c_char,
...
static mut htmlStartCloseIndex: [*mut *const libc::c_char; 100] = [0
    as *const *const libc::c_char as *mut *const libc::c_char; 100];
static mut htmlStartCloseIndexinitialized: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn htmlInitAutoClose() {
    ...
    while indx < 100 as libc::c_int {
        htmlStartCloseIndex[indx as usize] = 0 as *mut *const libc::c_char;
        indx += 1;
        indx;
    }
    indx = 0 as libc::c_int;
    while !(htmlStartClose[i as usize]).is_null()
        && indx < 100 as libc::c_int - 1 as libc::c_int
    {
        let fresh4 = indx;
        indx = indx + 1;
        htmlStartCloseIndex[fresh4
            as usize] = &*htmlStartClose.as_ptr().offset(i as isize)
    ...
    htmlStartCloseIndexinitialized = 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn htmlTagLookup(mut tag: *const xmlChar) -> *const htmlElemDesc {
    ...
    while (i as libc::c_ulong)
        < (::core::mem::size_of::<[htmlElemDesc; 92]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<htmlElemDesc>() as libc::c_ulong)
    {
        if xmlStrcasecmp(tag, html40ElementTable[i as usize].name as *mut xmlChar) == 0 {
            return &*html40ElementTable.as_ptr().offset(i as isize)
                as *const htmlElemDesc as htmlElemDescPtr as *const htmlElemDesc;
        }
        i = i.wrapping_add(1);
        i;
    }
...
unsafe extern "C" fn htmlCheckAutoClose(
    ...
    let mut indx: libc::c_int = 0;
    let mut closed: *mut *const libc::c_char = 0 as *mut *const libc::c_char;
    if htmlStartCloseIndexinitialized == 0 as libc::c_int {
        htmlInitAutoClose();
    }
    indx = 0 as libc::c_int;
    while indx < 100 as libc::c_int {
        ...
        if xmlStrEqual(*closed as *mut xmlChar, newtag) != 0 {
            break;
        }
        indx += 1;
        indx;
    }
    i = closed.offset_from(htmlStartClose.as_ptr()) as libc::c_long as libc::c_int;
    i += 1;
    i;
    while !(htmlStartClose[i as usize]).is_null() {
        if xmlStrEqual(htmlStartClose[i as usize] as *mut xmlChar, oldtag) != 0 {
...
pub unsafe extern "C" fn htmlIsScriptAttribute(mut name: *const xmlChar) -> libc::c_int {
    ...
    i = 0 as libc::c_int as libc::c_uint;
    while (i as libc::c_ulong)
        < (::core::mem::size_of::<[*const libc::c_char; 18]>() as libc::c_ulong)
...
pub unsafe extern "C" fn htmlEntityLookup(
    ...
    i = 0 as libc::c_int as libc::c_uint;
    while (i as libc::c_ulong)
        < (::core::mem::size_of::<[htmlEntityDesc; 253]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<htmlEntityDesc>() as libc::c_ulong)
    {
...
pub unsafe extern "C" fn UTF8ToHtml(
    ...
    while in_0 < inend {
        ...
        } else if d < 0xe0 as libc::c_int as libc::c_uint {
    ...
    while in_0 < inend {
            ...
            && c != '>' as i32 as libc::c_uint
        {
            ...
            *fresh14 = '&' as i32 as libc::c_uchar;
            ...
            let fresh15 = out;
            out = out.offset(1);
            *fresh15 = ';' as i32 as libc::c_uchar;
        }
        processed = in_0;
    }
    *outlen = out.offset_from(outstart) as libc::c_long as libc::c_int;
...
unsafe extern "C" fn htmlNewInputStream(
    ...
    input = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<htmlParserInput>() as libc::c_ulong)
...
unsafe extern "C" fn areBlanks(
    ...
    if lastChild.is_null() {
        ...
        i = 0 as libc::c_int as libc::c_uint;
        while (i as libc::c_ulong)
            < (::core::mem::size_of::<[*const libc::c_char; 53]>() as libc::c_ulong)
                .wrapping_div(
        ...
        if *(*(*ctxt).input).cur as libc::c_int == '&' as i32 {
                ...
                == '#' as i32
            {
                ...
                while bits >= 0 as libc::c_int {
                    let fresh21 = out;
                    out = out.offset(1);
                    *fresh21 = (c >> bits & 0x3f as libc::c_int as libc::c_uint
                ...
                if name.is_null() {
                    ...
                    *fresh23 = '&' as i32 as xmlChar;
                    ...
                    while bits_0 >= 0 as libc::c_int {
                        let fresh30 = out;
                        out = out.offset(1);
                        *fresh30 = (c_0 >> bits_0 & 0x3f as libc::c_int as libc::c_uint
                            | 0x80 as libc::c_int as libc::c_uint) as xmlChar;
                        bits_0 -= 6 as libc::c_int;
                    }
                }
            ...
            if c_1 < 0x80 as libc::c_int as libc::c_uint {
                ...
                *fresh31 = c_1 as xmlChar;
                ...
                let fresh32 = out;
                out = out.offset(1);
                *fresh32 = (c_1 >> 6 as libc::c_int & 0x1f as libc::c_int as libc::c_uint
                    | 0xc0 as libc::c_int as libc::c_uint) as xmlChar;
                bits_1 = 0 as libc::c_int;
            } else if c_1 < 0x10000 as libc::c_int as libc::c_uint {
                let fresh33 = out;
                out = out.offset(1);
                *fresh33 = (c_1 >> 12 as libc::c_int & 0xf as libc::c_int as libc::c_uint
                    | 0xe0 as libc::c_int as libc::c_uint) as xmlChar;
                bits_1 = 6 as libc::c_int;
            } else {
                let fresh34 = out;
                out = out.offset(1);
                *fresh34 = (c_1 >> 18 as libc::c_int & 0x7 as libc::c_int as libc::c_uint
                    | 0xf0 as libc::c_int as libc::c_uint) as xmlChar;
            ...
            while bits_1 >= 0 as libc::c_int {
                let fresh35 = out;
                out = out.offset(1);
                *fresh35 = (c_1 >> bits_1 & 0x3f as libc::c_int as libc::c_uint
                    | 0x80 as libc::c_int as libc::c_uint) as xmlChar;
                bits_1 -= 6 as libc::c_int;
            }
            xmlNextChar(ctxt);
...
unsafe extern "C" fn htmlParseSystemLiteral(
    ...
    if *(*(*ctxt).input).cur as libc::c_int == '"' as i32 {
        ...
        while (0x9 as libc::c_int <= *(*(*ctxt).input).cur as libc::c_int
            && *(*(*ctxt).input).cur as libc::c_int <= 0xa as libc::c_int
            || *(*(*ctxt).input).cur as libc::c_int == 0xd as libc::c_int
...
unsafe extern "C" fn htmlParsePubidLiteral(mut ctxt: htmlParserCtxtPtr) -> *mut xmlChar {
    ...
    if *(*(*ctxt).input).cur as libc::c_int == '"' as i32 {
        ...
        startPosition = ((*(*ctxt).input).cur).offset_from((*(*ctxt).input).base)
            as libc::c_long as size_t;
        while xmlIsPubidChar_tab[*(*(*ctxt).input).cur as libc::c_int as usize] != 0 {
            len = len.wrapping_add(1);
            len;
            xmlNextChar(ctxt);
        }
        ...
        startPosition = ((*(*ctxt).input).cur).offset_from((*(*ctxt).input).base)
            as libc::c_long as size_t;
        while xmlIsPubidChar_tab[*(*(*ctxt).input).cur as libc::c_int as usize]
            as libc::c_int != 0 && *(*(*ctxt).input).cur as libc::c_int != '\'' as i32
        {
            len = len.wrapping_add(1);
            len;
            xmlNextChar(ctxt);
...
unsafe extern "C" fn htmlParseScript(mut ctxt: htmlParserCtxtPtr) {
    ...
    while 0x9 as libc::c_int <= cur && cur <= 0xa as libc::c_int
    ...
    if !(0x9 as libc::c_int <= cur && cur <= 0xa as libc::c_int
        || cur == 0xd as libc::c_int || 0x20 as libc::c_int <= cur)
        && !(cur == 0 as libc::c_int && (*ctxt).progressive != 0)
    {
        htmlParseErrInt(
            ctxt,
            XML_ERR_INVALID_CHAR,
...
unsafe extern "C" fn htmlParsePI(mut ctxt: htmlParserCtxtPtr) {
            ...
            == '?' as i32
    {
        ...
        if !target.is_null() {
            ...
            {
                (*ctxt).nbChars += 1 as libc::c_int as libc::c_long;
                (*(*ctxt).input)
                    .cur = ((*(*ctxt).input).cur).offset(1 as libc::c_int as isize);
                (*(*ctxt).input).col += 1 as libc::c_int;
                if !((*ctxt).sax).is_null() && (*ctxt).disableSAX == 0
...
unsafe extern "C" fn htmlParseComment(mut ctxt: htmlParserCtxtPtr) {
    ...
    *buf.offset(len as isize) = 0 as libc::c_int as xmlChar;
    ...
    if !(if q < 0x100 as libc::c_int {
        (0x9 as libc::c_int <= q && q <= 0xa as libc::c_int || q == 0xd as libc::c_int
    ...
    } == 0)
    {
        ...
        if !(if r < 0x100 as libc::c_int {
            (0x9 as libc::c_int <= r && r <= 0xa as libc::c_int
                || r == 0xd as libc::c_int || 0x20 as libc::c_int <= r) as libc::c_int
        } else {
    ...
    while (0x9 as libc::c_int <= *(*(*ctxt).input).cur as libc::c_int
        ...
        && (*(*(*ctxt).input).cur as libc::c_int != '/' as i32
            || *((*(*ctxt).input).cur).offset(1 as libc::c_int as isize) as libc::c_int
                != '>' as i32)
    {
        let mut cons: libc::c_long = (*ctxt).nbChars;
        if (*ctxt).progressive == 0 as libc::c_int
            && (((*(*ctxt).input).end).offset_from((*(*ctxt).input).cur) as libc::c_long)
                < 250 as libc::c_int as libc::c_long
        {
        ...
        if !attname.is_null() {
            ...
            loop {
                ...
                if xmlStrEqual(*atts.offset(i as isize), attname) != 0 {
                    ...
                    current_block = 13071538464528093045;
                    break;
                } else {
                    i += 2 as libc::c_int;
                }
                ...
                _ => {
                    ...
                    match current_block {
                        ...
                        _ => {
                            let fresh44 = nbatts;
                            nbatts = nbatts + 1;
                            let ref mut fresh45 = *atts.offset(fresh44 as isize);
                            *fresh45 = attname;
                            let fresh46 = nbatts;
                            nbatts = nbatts + 1;
                            let ref mut fresh47 = *atts.offset(fresh46 as isize);
                            *fresh47 = attvalue;
                            let ref mut fresh48 = *atts.offset(nbatts as isize);
                            *fresh48 = 0 as *const xmlChar;
                            let ref mut fresh49 = *atts
...
unsafe extern "C" fn htmlParseEndTag(mut ctxt: htmlParserCtxtPtr) -> libc::c_int {
        ...
        || *(*(*ctxt).input).cur as libc::c_int != '>' as i32
    {
        ...
        if (*ctxt).recovery != 0 {
            while *(*(*ctxt).input).cur as libc::c_int != '\0' as i32
                && *(*(*ctxt).input).cur as libc::c_int != '>' as i32
            {
                xmlNextChar(ctxt);
            }
...
unsafe extern "C" fn htmlInitParserCtxt(mut ctxt: htmlParserCtxtPtr) -> libc::c_int {
    ...
    memset(
        ctxt as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<htmlParserCtxt>() as libc::c_ulong,
    );
    ...
    sax = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<htmlSAXHandler>() as libc::c_ulong)
    ...
    (*ctxt)
        ...
        (5 as libc::c_int as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<htmlParserInputPtr>() as libc::c_ulong),
    ...
    (*ctxt)
        ...
        (10 as libc::c_int as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<htmlNodePtr>() as libc::c_ulong),
    ) as *mut htmlNodePtr;
...
pub unsafe extern "C" fn htmlNewParserCtxt() -> htmlParserCtxtPtr {
    ...
    ctxt = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlParserCtxt>() as libc::c_ulong) as xmlParserCtxtPtr;
    if ctxt.is_null() {
        htmlErrMemory(
            0 as xmlParserCtxtPtr,
    ...
    memset(
        ctxt as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<xmlParserCtxt>() as libc::c_ulong,
    );
...
unsafe extern "C" fn htmlParseLookupSequence(
    ...
    let mut incomment: libc::c_int = 0 as libc::c_int;
    ...
    while base < len {
        if incomment == 0 && (base + 4 as libc::c_int) < len && iscomment == 0 {
            if *buf.offset(base as isize) as libc::c_int == '<' as i32
                && *buf.offset((base + 1 as libc::c_int) as isize) as libc::c_int
                    == '!' as i32
                && *buf.offset((base + 2 as libc::c_int) as isize) as libc::c_int
                    == '-' as i32
                && *buf.offset((base + 3 as libc::c_int) as isize) as libc::c_int
                    == '-' as i32
            {
                ...
                || *buf.offset(base as isize) as libc::c_int == '\'' as i32
            {
                if invalue != 0 {
                        ...
                        == valdellim as libc::c_int
                    {
                        ...
                        current_block_35 = 4956146061682418353;
                    } else {
                        current_block_35 = 652864300344834934;
                    }
                } else {
        ...
        match current_block_35 {
            652864300344834934 => {
                ...
                } else if *buf.offset(base as isize) as libc::c_int
                    == first as libc::c_int
                {
                    if third as libc::c_int != 0 as libc::c_int {
                                ...
                                as libc::c_int != third as libc::c_int
                        {
                            ...
                            current_block_35 = 790185930182612747;
                        }
...
unsafe extern "C" fn htmlParseLookupChars(
    mut ctxt: htmlParserCtxtPtr,
    mut stop: *const xmlChar,
    mut stopLen: libc::c_int,
) -> libc::c_int {
    let mut base: libc::c_int = 0;
    let mut len: libc::c_int = 0;
    let mut in_0: htmlParserInputPtr = 0 as *mut xmlParserInput;
    ...
    while base < len {
        if incomment == 0 && (base + 4 as libc::c_int) < len {
            if *buf.offset(base as isize) as libc::c_int == '<' as i32
                && *buf.offset((base + 1 as libc::c_int) as isize) as libc::c_int
                    == '!' as i32
                && *buf.offset((base + 2 as libc::c_int) as isize) as libc::c_int
        ...
        if incomment != 0 {
            ...
            while i < stopLen {
                if *buf.offset(base as isize) as libc::c_int
                    == *stop.offset(i as isize) as libc::c_int
                {
                    (*ctxt).checkIndex = 0 as libc::c_int as libc::c_long;
                    return (base as libc::c_long
                        - ((*in_0).cur).offset_from((*in_0).base) as libc::c_long)
...
unsafe extern "C" fn htmlParseTryOrFinish(
    ...
    loop {
        ...
        if ((*in_0).buf).is_null() {
            ...
            avail = (xmlBufUse((*(*in_0).buf).buffer))
                .wrapping_sub(
                    ((*in_0).cur).offset_from((*in_0).base) as libc::c_long as size_t,
                ) as libc::c_int;
        }
        if avail == 0 as libc::c_int && terminate != 0 {
            htmlAutoCloseOnEnd(ctxt);
            if (*ctxt).nameNr == 0 as libc::c_int
                && (*ctxt).instate as libc::c_int != XML_PARSER_EOF as libc::c_int
            {
        ...
        if cur as libc::c_int == 0 as libc::c_int {
            ...
            match (*ctxt).instate as libc::c_int {
                ...
                7 => {
                    ...
                    if avail == 1 as libc::c_int && terminate != 0 {
                        cur = *((*in_0).cur).offset(0 as libc::c_int as isize);
                        if cur as libc::c_int != '<' as i32
...
pub unsafe extern "C" fn htmlCreateFileParserCtxt(
    ...
    if !encoding.is_null() {
        ...
        if l < 1000 as libc::c_int as size_t {

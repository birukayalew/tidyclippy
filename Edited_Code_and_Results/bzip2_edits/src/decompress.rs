...
pub unsafe extern "C" fn BZ2_decompress(mut s: *mut DState) -> Int32 {
    ...
    match (*s).state {
        ...
        12 => {
            current_block = 15822148388160763871;
        }
        13 => {
            current_block = 17624611356365383229;
        }
        14 => {
            current_block = 17940414525757527936;
        }
        15 => {
            current_block = 2590488702144278656;
        }
        16 => {
            current_block = 3317322622165405134;
        }
        17 => {
            current_block = 4521442665782964970;
        }
        18 => {
            current_block = 3513440520300748193;
        }
        19 => {
            current_block = 8248800716151944504;
        }
        20 => {
            current_block = 3653295323910715944;
        }
        21 => {
            current_block = 11207152455964152426;
        }
        22 => {
            current_block = 16428312855482794360;
        }
        23 => {
            current_block = 5602626330413423453;
        }
        24 => {
            current_block = 16635047652729014944;
        }
        25 => {
            current_block = 7976107961069065813;
        }
        26 => {
            current_block = 11243153971040152478;
        }
        27 => {
            current_block = 15929484006563318316;
        }
        28 => {
            current_block = 9658771359317796075;
        }
        29 => {
            current_block = 7792017157978204430;
        }
        30 => {
            current_block = 12806518214944893120;
        }
        31 => {
            current_block = 18155493197920413301;
        }
        32 => {
            current_block = 4869278537926010812;
        }
        33 => {
            current_block = 11133198759790587203;
        }
        34 => {
            current_block = 11067245223857074510;
        }
        35 => {
            current_block = 3123355793440412162;
        }
        36 => {
            current_block = 2350172673136162805;
        }
        37 => {
            current_block = 1609852172382859098;
        }
        38 => {
        ...
        40 => {
            current_block = 6074289683437631076;
        }
        41 => {
            current_block = 2208493066468587437;
        }
        42 => {
            current_block = 1694289921508091492;
        }
        43 => {
            current_block = 1638367639094989545;
        }
        44 => {
            current_block = 2073871437045787192;
        }
        45 => {
            current_block = 6704443978691967461;
        }
        46 => {
            current_block = 4153393827823564820;
        }
        47 => {
            current_block = 2462599351455862350;
        }
        48 => {
            current_block = 5297164956346212986;
        }
        49 => {
            current_block = 15899409638110872183;
        }
        50 => {
            current_block = 2006328803036286434;
        }
        _ => {
                ...
                loop {
                    if (*s).bsLive >= zn {
                        ...
                        v_30 = (*s).bsBuff >> (*s).bsLive - zn
                            & (((1 as libc::c_int) << zn) - 1 as libc::c_int) as UInt32;
                        (*s).bsLive -= zn;
                        zvec = v_30 as Int32;
                        break;
                    } else if (*(*s).strm).avail_in == 0 as libc::c_int as libc::c_uint {
                        ...
                        if nextSym == 0 as libc::c_int || nextSym == 1 as libc::c_int {
                            ...
                            if nn < 16 as libc::c_int as UInt32 {
                                ...
                                while nn > 3 as libc::c_int as UInt32 {
                                    ...
                                    nn = nn.wrapping_sub(4 as libc::c_int as UInt32);
                                }
                                while nn > 0 as libc::c_int as UInt32 {
                                    (*s)
                                        .mtfa[(pp as UInt32).wrapping_add(nn)
                                        as usize] = (*s)
                                        .mtfa[(pp as UInt32)
                                        .wrapping_add(nn)
                                        .wrapping_sub(1 as libc::c_int as UInt32) as usize];
                                    nn = nn.wrapping_sub(1);
                                    nn;
                                }
                                (*s).mtfa[pp as usize] = uc;
                            } else {
                                lno = (nn / 16 as libc::c_int as UInt32) as Int32;
                                off = (nn % 16 as libc::c_int as UInt32) as Int32;
                            ...
                            if (*s).smallDecompress != 0 {
                                ...
                                while i < nblock {
                                    uc = (*((*s).tt).offset(i as isize)
                                        & 0xff as libc::c_int as UInt32) as UChar;
                                    *((*s).tt).offset((*s).cftab[uc as usize] as isize)
                                        |= (i << 8 as libc::c_int) as UInt32;

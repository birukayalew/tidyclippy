...
extern "C" {
    ...
    fn mk_pointer(type_0: *mut CType);
    fn vstore();
    fn indir();
    fn get_sym_ref(
        type_0: *mut CType,
...
#[no_mangle]
pub static mut target_machine_defs: *const libc::c_char = b"__aarch64__\0__AARCH64EL__\0\0"
...
unsafe extern "C" fn intr(mut r: libc::c_int) -> uint32_t {
    if TREG_R(0 as libc::c_int) <= r && r <= TREG_R10 as libc::c_int {} else {
        __assert_fail(
            b"TREG_R(0) <= r && r <= TREG_R30\0" as *const u8 as *const libc::c_char,
            b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                as *const u8 as *const libc::c_char,
            104 as libc::c_int as libc::c_uint,
            (*::core::mem::transmute::<
                &[u8; 19],
                &[libc::c_char; 19],
            >(b"uint32_t intr(int)\0"))
                .as_ptr(),
        );
    }
    'c_12415: {
    ...
    return (if r < TREG_R10 as libc::c_int { r } else { 30 as libc::c_int }) as uint32_t;
}
unsafe extern "C" fn fltr(mut r: libc::c_int) -> uint32_t {
    if TREG_F(0 as libc::c_int) <= r && r <= TREG_F(7 as libc::c_int) {} else {
        __assert_fail(
            b"TREG_F(0) <= r && r <= TREG_F(7)\0" as *const u8 as *const libc::c_char,
            b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                as *const u8 as *const libc::c_char,
    ...
    'c_14907: {
        if TREG_F(0 as libc::c_int) <= r && r <= TREG_F(7 as libc::c_int) {} else {
            __assert_fail(
                b"TREG_F(0) <= r && r <= TREG_F(7)\0" as *const u8
    ...
    return (r - TREG_F(0 as libc::c_int)) as uint32_t;
}
#[no_mangle]
...
unsafe extern "C" fn arm64_encode_bimm64(mut x: uint64_t) -> libc::c_int {
    let mut neg: libc::c_int = (x & 1 as libc::c_int as uint64_t) as libc::c_int;
    ...
    if x >> 2 as libc::c_int
        == x
            & ((1 as libc::c_int as uint64_t) << 64 as libc::c_int - 2 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as uint64_t)
    {
        ...
        x
            &= ((1 as libc::c_int as uint64_t) << 2 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as uint64_t);
    } else if x >> 4 as libc::c_int
        == x
            & ((1 as libc::c_int as uint64_t) << 64 as libc::c_int - 4 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as uint64_t)
    {
        rep = 4 as libc::c_int;
        x
            &= ((1 as libc::c_int as uint64_t) << 4 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as uint64_t);
    } else if x >> 8 as libc::c_int
        == x
            & ((1 as libc::c_int as uint64_t) << 64 as libc::c_int - 8 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as uint64_t)
    {
        rep = 8 as libc::c_int;
        x
            &= ((1 as libc::c_int as uint64_t) << 8 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as uint64_t);
    } else if x >> 16 as libc::c_int
        == x
            & ((1 as libc::c_int as uint64_t) << 64 as libc::c_int - 16 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as uint64_t)
    {
        rep = 16 as libc::c_int;
        x
            &= ((1 as libc::c_int as uint64_t) << 16 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as uint64_t);
    } else if x >> 32 as libc::c_int
        == x
            & ((1 as libc::c_int as uint64_t) << 64 as libc::c_int - 32 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as uint64_t)
    {
        rep = 32 as libc::c_int;
        x
            &= ((1 as libc::c_int as uint64_t) << 32 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as uint64_t);
    } else {
        rep = 64 as libc::c_int;
    }
    pos = 0 as libc::c_int;
    if x
        & ((1 as libc::c_int as uint64_t) << 32 as libc::c_int)
            .wrapping_sub(1 as libc::c_int as uint64_t) == 0
    {
        x >>= 32 as libc::c_int;
        pos += 32 as libc::c_int;
    }
    if x
        & ((1 as libc::c_int as uint64_t) << 16 as libc::c_int)
            .wrapping_sub(1 as libc::c_int as uint64_t) == 0
    ...
    if x
        & ((1 as libc::c_int as uint64_t) << 1 as libc::c_int)
            .wrapping_sub(1 as libc::c_int as uint64_t) == 0
    {
        x >>= 1 as libc::c_int;
        pos += 1 as libc::c_int;
    ...
    if neg != 0 {
        pos = pos + len & rep - 1 as libc::c_int;
        len = rep - len;
    }
    return 0x1000 as libc::c_int & rep << 6 as libc::c_int
        | (rep - 1 as libc::c_int ^ 31 as libc::c_int) << 1 as libc::c_int
            & 63 as libc::c_int
        | (rep - pos & rep - 1 as libc::c_int) << 6 as libc::c_int
        | len - 1 as libc::c_int;
}
unsafe extern "C" fn arm64_movi(mut r: libc::c_int, mut x: uint64_t) -> uint32_t {
    let mut m: uint64_t = 0xffff as libc::c_int as uint64_t;
    let mut e: libc::c_int = 0;
    if x & !m == 0 {
        return ((0x52800000 as libc::c_int | r) as uint64_t | x << 5 as libc::c_int)
            as uint32_t;
    }
    if x & !(m << 16 as libc::c_int) == 0 {
        return ((0x52a00000 as libc::c_int | r) as uint64_t | x >> 11 as libc::c_int)
            as uint32_t;
    }
    if x & !(m << 32 as libc::c_int) == 0 {
        return ((0xd2c00000 as libc::c_uint | r as libc::c_uint) as uint64_t
            | x >> 27 as libc::c_int) as uint32_t;
    }
    if x & !(m << 48 as libc::c_int) == 0 {
        return ((0xd2e00000 as libc::c_uint | r as libc::c_uint) as uint64_t
            | x >> 43 as libc::c_int) as uint32_t;
    }
    if x & !m == m << 16 as libc::c_int {
        return ((0x12800000 as libc::c_int | r) as uint64_t
            | !x << 5 as libc::c_int & 0x1fffe0 as libc::c_int as uint64_t) as uint32_t;
    }
    if x & !(m << 16 as libc::c_int) == m {
        return ((0x12a00000 as libc::c_int | r) as uint64_t
            | !x >> 11 as libc::c_int & 0x1fffe0 as libc::c_int as uint64_t) as uint32_t;
    }
    if !(x | m) == 0 {
        return ((0x92800000 as libc::c_uint | r as libc::c_uint) as uint64_t
            | !x << 5 as libc::c_int & 0x1fffe0 as libc::c_int as uint64_t) as uint32_t;
    }
    if !(x | m << 16 as libc::c_int) == 0 {
        return ((0x92a00000 as libc::c_uint | r as libc::c_uint) as uint64_t
            | !x >> 11 as libc::c_int & 0x1fffe0 as libc::c_int as uint64_t) as uint32_t;
    }
    if !(x | m << 32 as libc::c_int) == 0 {
        return ((0x92c00000 as libc::c_uint | r as libc::c_uint) as uint64_t
            | !x >> 27 as libc::c_int & 0x1fffe0 as libc::c_int as uint64_t) as uint32_t;
    }
    if !(x | m << 48 as libc::c_int) == 0 {
        return ((0x92e00000 as libc::c_uint | r as libc::c_uint) as uint64_t
            | !x >> 43 as libc::c_int & 0x1fffe0 as libc::c_int as uint64_t) as uint32_t;
    }
    if x >> 32 as libc::c_int == 0
        && {
            e = arm64_encode_bimm64(x | x << 32 as libc::c_int);
            e >= 0 as libc::c_int
        }
    {
        return (0x320003e0 as libc::c_int | r) as uint32_t
            | (e as uint32_t) << 10 as libc::c_int;
    }
    e = arm64_encode_bimm64(x);
    if e >= 0 as libc::c_int {
        return 0xb20003e0 as libc::c_uint | r as libc::c_uint
            | (e as uint32_t) << 10 as libc::c_int;
    }
    return 0 as libc::c_int as uint32_t;
}
unsafe extern "C" fn arm64_movimm(mut r: libc::c_int, mut x: uint64_t) {
    ...
    if i != 0 {
        ...
        let mut mov1: uint32_t = 0xd2800000 as libc::c_uint;
        let mut x1: uint64_t = x;
        i = 0 as libc::c_int as uint32_t;
        while i < 64 as libc::c_int as uint32_t {
            z += (x >> i & 0xffff as libc::c_int as uint64_t == 0) as libc::c_int;
            m += (!x >> i & 0xffff as libc::c_int as uint64_t == 0) as libc::c_int;
            i = i.wrapping_add(16 as libc::c_int as uint32_t);
        }
        if m > z {
            x1 = !x;
            mov1 = 0x92800000 as libc::c_uint;
        }
        i = 0 as libc::c_int as uint32_t;
        while i < 64 as libc::c_int as uint32_t {
            if x1 >> i & 0xffff as libc::c_int as uint64_t != 0 {
                o(
                    ((mov1 | r as uint32_t) as uint64_t
                        | (x1 >> i & 0xffff as libc::c_int as uint64_t)
                            << 5 as libc::c_int | (i << 17 as libc::c_int) as uint64_t)
                        as libc::c_uint,
                );
                break;
            } else {
        ...
        while i < 64 as libc::c_int as uint32_t {
            if x1 >> i & 0xffff as libc::c_int as uint64_t != 0 {
                o(
                    ((0xf2800000 as libc::c_uint | r as libc::c_uint) as uint64_t
                        | (x >> i & 0xffff as libc::c_int as uint64_t)
                            << 5 as libc::c_int | (i << 17 as libc::c_int) as uint64_t)
                        as libc::c_uint,
                );
            }
...
pub unsafe extern "C" fn gsym_addr(mut t_: libc::c_int, mut a_: libc::c_int) {
    ...
    while t != 0 {
        ...
        if a.wrapping_sub(t).wrapping_add(0x8000000 as libc::c_int as uint32_t)
            >= 0x10000000 as libc::c_int as uint32_t
        {
            _tcc_error(b"branch out of range\0" as *const u8 as *const libc::c_char);
        }
        write32le(
            ptr,
            if a.wrapping_sub(t) == 4 as libc::c_int as uint32_t {
                0xd503201f as libc::c_uint
            } else {
                0x14000000 as libc::c_int as uint32_t
                    | a.wrapping_sub(t) >> 2 as libc::c_int
...
unsafe extern "C" fn arm64_spoff(mut reg: libc::c_int, mut off: uint64_t) {
    let mut sub: uint32_t = (off >> 63 as libc::c_int) as uint32_t;
    if sub != 0 {
        off = off.wrapping_neg();
    }
    if off < 4096 as libc::c_int as uint64_t {
        o(
            ((0x910003e0 as libc::c_uint | sub << 30 as libc::c_int
                | reg as libc::c_uint) as uint64_t | off << 10 as libc::c_int)
                as libc::c_uint,
        );
    } else {
        arm64_movimm(30 as libc::c_int, off);
        o(0x8b3e63e0 as libc::c_uint | sub << 30 as libc::c_int | reg as libc::c_uint);
    };
}
unsafe extern "C" fn arm64_check_offset(
    mut invert: libc::c_int,
    mut sz_: libc::c_int,
    mut off: uint64_t,
) -> uint64_t {
    let mut sz: uint32_t = sz_ as uint32_t;
    if off & !((0xfff as libc::c_int as uint32_t) << sz) as uint64_t == 0
        || (off < 256 as libc::c_int as uint64_t
            || off.wrapping_neg() <= 256 as libc::c_int as uint64_t)
    {
        return if invert != 0 { off } else { 0 as libc::c_ulong }
    } else if off & ((0xfff as libc::c_int as uint32_t) << sz) as uint64_t != 0 {
        return if invert != 0 {
            off & ((0xfff as libc::c_int as uint32_t) << sz) as uint64_t
        } else {
            off & !((0xfff as libc::c_int as uint32_t) << sz) as uint64_t
        }
    } else if off & 0x1ff as libc::c_int as uint64_t != 0 {
        return if invert != 0 {
            off & 0x1ff as libc::c_int as uint64_t
        } else {
            off & !(0x1ff as libc::c_int) as uint64_t
        }
    } else {
        return if invert != 0 { 0 as libc::c_ulong } else { off }
    };
}
unsafe extern "C" fn arm64_ldrx(
    mut sg: libc::c_int,
    mut sz_: libc::c_int,
    mut dst: libc::c_int,
    mut bas: libc::c_int,
    ...
    let mut sz: uint32_t = sz_ as uint32_t;
    if sz >= 2 as libc::c_int as uint32_t {
        sg = 0 as libc::c_int;
    }
    if off & !((0xfff as libc::c_int as uint32_t) << sz) as uint64_t == 0 {
        o(
            ((0x39400000 as libc::c_int | dst | bas << 5 as libc::c_int) as uint64_t
                | off << (10 as libc::c_int as uint32_t).wrapping_sub(sz)
                | (((sg != 0) as libc::c_int as uint32_t) << 23 as libc::c_int)
                    as uint64_t | (sz << 30 as libc::c_int) as uint64_t) as libc::c_uint,
        );
    } else if off < 256 as libc::c_int as uint64_t
        || off.wrapping_neg() <= 256 as libc::c_int as uint64_t
    {
        o(
            ((0x38400000 as libc::c_int | dst | bas << 5 as libc::c_int) as uint64_t
                | (off & 511 as libc::c_int as uint64_t) << 12 as libc::c_int
                | (((sg != 0) as libc::c_int as uint32_t) << 23 as libc::c_int)
                    as uint64_t | (sz << 30 as libc::c_int) as uint64_t) as libc::c_uint,
        );
    } else {
        arm64_movimm(30 as libc::c_int, off);
        o(
            (0x38206800 as libc::c_int | dst | bas << 5 as libc::c_int) as uint32_t
                | (30 as libc::c_int as uint32_t) << 16 as libc::c_int
                | (((sg != 0) as libc::c_int + 1 as libc::c_int) as uint32_t)
                    << 22 as libc::c_int | sz << 30 as libc::c_int,
        );
    };
}
unsafe extern "C" fn arm64_ldrv(
    mut sz_: libc::c_int,
    mut dst: libc::c_int,
    mut bas: libc::c_int,
    mut off: uint64_t,
    ...
    if off & !((0xfff as libc::c_int as uint32_t) << sz) as uint64_t == 0 {
        o(
            ((0x3d400000 as libc::c_int | dst | bas << 5 as libc::c_int) as uint64_t
                | off << (10 as libc::c_int as uint32_t).wrapping_sub(sz)
                | ((sz & 4 as libc::c_int as uint32_t) << 21 as libc::c_int) as uint64_t
                | ((sz & 3 as libc::c_int as uint32_t) << 30 as libc::c_int) as uint64_t)
                as libc::c_uint,
        );
    } else if off < 256 as libc::c_int as uint64_t
        || off.wrapping_neg() <= 256 as libc::c_int as uint64_t
    {
        o(
            ((0x3c400000 as libc::c_int | dst | bas << 5 as libc::c_int) as uint64_t
                | (off & 511 as libc::c_int as uint64_t) << 12 as libc::c_int
                | ((sz & 4 as libc::c_int as uint32_t) << 21 as libc::c_int) as uint64_t
                | ((sz & 3 as libc::c_int as uint32_t) << 30 as libc::c_int) as uint64_t)
                as libc::c_uint,
        ...
        arm64_movimm(30 as libc::c_int, off);
        o(
            (0x3c606800 as libc::c_int | dst | bas << 5 as libc::c_int) as uint32_t
                | (30 as libc::c_int as uint32_t) << 16 as libc::c_int
                | sz << 30 as libc::c_int
                | (sz & 4 as libc::c_int as uint32_t) << 21 as libc::c_int,
        );
    };
}
unsafe extern "C" fn arm64_ldrs(mut reg_: libc::c_int, mut size: libc::c_int) {
    let mut reg: uint32_t = reg_ as uint32_t;
    match size {
        0 => {}
        1 => {
            arm64_ldrx(
        ...
        3 => {
            ...
            o(0x2a0043c0 as libc::c_int as uint32_t | reg | reg << 16 as libc::c_int);
        }
        4 => {
            arm64_ldrx(
                0 as libc::c_int,
        ...
        5 => {
            ...
            o(0xaa0083c0 as libc::c_uint | reg | reg << 16 as libc::c_int);
        }
        6 => {
            arm64_ldrx(
                0 as libc::c_int,
        ...
        7 => {
            ...
            o(0x53087c00 as libc::c_int as uint32_t | reg | reg << 5 as libc::c_int);
            o(0xaa0083c0 as libc::c_uint | reg | reg << 16 as libc::c_int);
        }
        8 => {
            arm64_ldrx(
        ...
        9 => {
            arm64_ldrx(
                0 as libc::c_int,
                0 as libc::c_int,
                reg.wrapping_add(1 as libc::c_int as uint32_t) as libc::c_int,
                reg as libc::c_int,
        ...
        11 => {
            ...
            o(
                0x53087c00 as libc::c_int as uint32_t
                    | reg.wrapping_add(1 as libc::c_int as uint32_t)
                    | reg.wrapping_add(1 as libc::c_int as uint32_t) << 5 as libc::c_int,
            );
            arm64_ldrx(
                0 as libc::c_int,
                3 as libc::c_int,
        ...
        16 => {
            o(
                0xa9400000 as libc::c_uint | reg
                    | reg.wrapping_add(1 as libc::c_int as uint32_t) << 10 as libc::c_int
                    | reg << 5 as libc::c_int,
            );
        }
        _ => {
...
unsafe extern "C" fn arm64_strx(
    ...
    if off & !((0xfff as libc::c_int as uint32_t) << sz) as uint64_t == 0 {
        o(
            ((0x39000000 as libc::c_int | dst | bas << 5 as libc::c_int) as uint64_t
                | off << (10 as libc::c_int as uint32_t).wrapping_sub(sz)
                | (sz << 30 as libc::c_int) as uint64_t) as libc::c_uint,
        );
    } else if off < 256 as libc::c_int as uint64_t
        || off.wrapping_neg() <= 256 as libc::c_int as uint64_t
    {
        o(
            ((0x38000000 as libc::c_int | dst | bas << 5 as libc::c_int) as uint64_t
                | (off & 511 as libc::c_int as uint64_t) << 12 as libc::c_int
                | (sz << 30 as libc::c_int) as uint64_t) as libc::c_uint,
        );
    } else {
...
unsafe extern "C" fn arm64_strv(
    ...
    if off & !((0xfff as libc::c_int as uint32_t) << sz) as uint64_t == 0 {
        o(
            ((0x3d000000 as libc::c_int | dst | bas << 5 as libc::c_int) as uint64_t
                | off << (10 as libc::c_int as uint32_t).wrapping_sub(sz)
                | ((sz & 4 as libc::c_int as uint32_t) << 21 as libc::c_int) as uint64_t
                | ((sz & 3 as libc::c_int as uint32_t) << 30 as libc::c_int) as uint64_t)
                as libc::c_uint,
    ...
    {
        o(
            ((0x3c000000 as libc::c_int | dst | bas << 5 as libc::c_int) as uint64_t
                | (off & 511 as libc::c_int as uint64_t) << 12 as libc::c_int
                | ((sz & 4 as libc::c_int as uint32_t) << 21 as libc::c_int) as uint64_t
                | ((sz & 3 as libc::c_int as uint32_t) << 30 as libc::c_int) as uint64_t)
                as libc::c_uint,
        ...
        arm64_movimm(30 as libc::c_int, off);
        o(
            (0x3c206800 as libc::c_int | dst | bas << 5 as libc::c_int) as uint32_t
                | (30 as libc::c_int as uint32_t) << 16 as libc::c_int
                | sz << 30 as libc::c_int
                | (sz & 4 as libc::c_int as uint32_t) << 21 as libc::c_int,
        );
...
unsafe extern "C" fn arm64_sym(
    mut r: libc::c_int,
    mut sym: *mut Sym,
    mut addend: libc::c_ulong,
) {
    greloca(
    ...
    o(0x90000000 as libc::c_uint | r as libc::c_uint);
    greloca(
        (*tcc_state).cur_text_section,
        sym,
        ind as libc::c_ulong,
    ...
    o(
        0xf9400000 as libc::c_uint | r as libc::c_uint
            | (r << 5 as libc::c_int) as libc::c_uint,
    );
    if addend != 0 {
        if addend & 0xfff as libc::c_ulong != 0 {
            o(
                ((0x91000000 as libc::c_uint | r as libc::c_uint
                    | (r << 5 as libc::c_int) as libc::c_uint) as libc::c_ulong
                    | (addend & 0xfff as libc::c_int as libc::c_ulong)
                        << 10 as libc::c_int) as libc::c_uint,
            );
        }
        if addend > 0xfff as libc::c_ulong {
            if addend & 0xfff000 as libc::c_ulong != 0 {
                o(
                    ((0x91400000 as libc::c_uint | r as libc::c_uint
                        | (r << 5 as libc::c_int) as libc::c_uint) as libc::c_ulong
                        | (addend >> 12 as libc::c_int
                            & 0xfff as libc::c_int as libc::c_ulong)
                            << 10 as libc::c_int) as libc::c_uint,
                );
            }
            if addend > 0xffffff as libc::c_ulong {
                let mut t: libc::c_int = if r != 0 {
                    0 as libc::c_int
                } else {
                    1 as libc::c_int
                };
                o(0xf81f0fe0 as libc::c_uint | t as libc::c_uint);
                arm64_movimm(t, addend & !(0xffffff as libc::c_ulong));
                o(
                    0x91000000 as libc::c_uint | r as libc::c_uint
                        | (t << 5 as libc::c_int) as libc::c_uint,
                );
                o(0xf84107e0 as libc::c_uint | t as libc::c_uint);
            }
        }
    }
}
...
pub unsafe extern "C" fn load(mut r: libc::c_int, mut sv: *mut SValue) {
    let mut svtt: libc::c_int = (*sv).type_0.t;
    let mut svr: libc::c_int = (*sv).r as libc::c_int
        & !(0x8000 as libc::c_int | 0x1000 as libc::c_int);
    let mut svrv: libc::c_int = svr & 0x3f as libc::c_int;
    let mut svcul: uint64_t = (*sv).c2rust_unnamed.c.i as uint32_t as uint64_t;
    svcul = if svcul >> 31 as libc::c_int & 1 as libc::c_int as uint64_t != 0 {
        svcul.wrapping_sub((1 as libc::c_int as uint64_t) << 32 as libc::c_int)
    } else {
        svcul
    };
    if svr == 0x32 as libc::c_int | 0x100 as libc::c_int {
        if r >= TREG_F(0 as libc::c_int) {
            arm64_ldrv(
                arm64_type_size(svtt),
                fltr(r) as libc::c_int,
                29 as libc::c_int,
                svcul,
            );
        } else {
            arm64_ldrx(
                (svtt & 0x10 as libc::c_int == 0) as libc::c_int,
                arm64_type_size(svtt),
                intr(r) as libc::c_int,
                29 as libc::c_int,
                svcul,
            );
        }
    ...
    if svr == 0x30 as libc::c_int | 0x100 as libc::c_int {
        if !((*sv).c2rust_unnamed_0.sym).is_null() {
            arm64_sym(
                30 as libc::c_int,
            ...
            arm64_movimm(30 as libc::c_int, (*sv).c2rust_unnamed.c.i);
        }
        if r >= TREG_F(0 as libc::c_int) {
            arm64_ldrv(
                arm64_type_size(svtt),
    ...
    if svr & !(0x3f as libc::c_int) == 0x100 as libc::c_int && svrv < 0x30 as libc::c_int
    {
        if svtt & 0xf as libc::c_int != 0 as libc::c_int {
            if r >= TREG_F(0 as libc::c_int) {
                arm64_ldrv(
                    arm64_type_size(svtt),
                    fltr(r) as libc::c_int,
                    intr(svrv) as libc::c_int,
                    0 as libc::c_int as uint64_t,
                );
            } else {
                arm64_ldrx(
    ...
    if svr == 0x30 as libc::c_int | 0x100 as libc::c_int | 0x200 as libc::c_int {
        arm64_sym(
            30 as libc::c_int,
            (*sv).c2rust_unnamed_0.sym,
            arm64_check_offset(0 as libc::c_int, arm64_type_size(svtt), svcul),
        );
        if r >= TREG_F(0 as libc::c_int) {
            arm64_ldrv(
                arm64_type_size(svtt),
                fltr(r) as libc::c_int,
                30 as libc::c_int,
                arm64_check_offset(1 as libc::c_int, arm64_type_size(svtt), svcul),
            );
        } else {
            arm64_ldrx(
                (svtt & 0x10 as libc::c_int == 0) as libc::c_int,
    ...
    if svr == 0x30 as libc::c_int | 0x200 as libc::c_int {
        arm64_sym(intr(r) as libc::c_int, (*sv).c2rust_unnamed_0.sym, svcul);
        return;
    }
    if svr == 0x30 as libc::c_int {
        if svtt & 0xf as libc::c_int != 0 as libc::c_int {
            arm64_movimm(
                intr(r) as libc::c_int,
                if arm64_type_size(svtt) == 3 as libc::c_int {
                    (*sv).c2rust_unnamed.c.i
                } else {
                    svcul as uint32_t as uint64_t
                },
            );
        }
        return;
    ...
    if svr < 0x30 as libc::c_int {
        if r >= TREG_F(0 as libc::c_int) && svr >= TREG_F(0 as libc::c_int) {
            if svtt == 10 as libc::c_int {
                o(
                    0x4ea01c00 as libc::c_int as uint32_t | fltr(r)
                        | fltr(svr) << 5 as libc::c_int,
                );
            } else {
                o(
                    0x1e604000 as libc::c_int as uint32_t | fltr(r)
                        | fltr(svr) << 5 as libc::c_int,
                );
            }
        } else if !(r >= TREG_F(0 as libc::c_int)) && !(svr >= TREG_F(0 as libc::c_int))
        {
            o(0xaa0003e0 as libc::c_uint | intr(r) | intr(svr) << 16 as libc::c_int);
        } else {
            __assert_fail(
                b"0\0" as *const u8 as *const libc::c_char,
                b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
    ...
    if svr == 0x32 as libc::c_int {
        if svcul.wrapping_neg() < 0x1000 as libc::c_int as uint64_t {
            o(
                ((0xd10003a0 as libc::c_uint | intr(r)) as uint64_t
                    | svcul.wrapping_neg() << 10 as libc::c_int) as libc::c_uint,
            );
        } else {
            arm64_movimm(30 as libc::c_int, svcul.wrapping_neg());
            o(
                0xcb0003a0 as libc::c_uint | intr(r)
                    | (30 as libc::c_int as uint32_t) << 16 as libc::c_int,
            );
        }
        return;
    }
    if svr == 0x34 as libc::c_int || svr == 0x35 as libc::c_int {
        let mut t: libc::c_int = (svr == 0x35 as libc::c_int) as libc::c_int;
        arm64_movimm(intr(r) as libc::c_int, t as uint64_t);
        o(0x14000002 as libc::c_int as libc::c_uint);
        gsym(svcul as libc::c_int);
        arm64_movimm(intr(r) as libc::c_int, (t ^ 1 as libc::c_int) as uint64_t);
        return;
    }
    if svr == 0x31 as libc::c_int | 0x100 as libc::c_int {
        arm64_ldrx(
            0 as libc::c_int,
            3 as libc::c_int,
            30 as libc::c_int,
...
pub unsafe extern "C" fn store(mut r: libc::c_int, mut sv: *mut SValue) {
    let mut svtt: libc::c_int = (*sv).type_0.t;
    let mut svr: libc::c_int = (*sv).r as libc::c_int & !(0x8000 as libc::c_int);
    let mut svrv: libc::c_int = svr & 0x3f as libc::c_int;
    let mut svcul: uint64_t = (*sv).c2rust_unnamed.c.i as uint32_t as uint64_t;
    svcul = if svcul >> 31 as libc::c_int & 1 as libc::c_int as uint64_t != 0 {
        svcul.wrapping_sub((1 as libc::c_int as uint64_t) << 32 as libc::c_int)
...
unsafe extern "C" fn arm64_gen_bl_or_b(mut b: libc::c_int) {
    if (*vtop).r as libc::c_int & (0x3f as libc::c_int | 0x100 as libc::c_int)
        == 0x30 as libc::c_int && (*vtop).r as libc::c_int & 0x200 as libc::c_int != 0
    {
        greloca(
            (*tcc_state).cur_text_section,
            (*vtop).c2rust_unnamed_0.sym,
            ind as libc::c_ulong,
            if b != 0 { 282 as libc::c_int } else { 283 as libc::c_int },
            0 as libc::c_int as Elf64_Addr,
        );
        o(
            0x14000000 as libc::c_int as uint32_t
                | ((b == 0) as libc::c_int as uint32_t) << 31 as libc::c_int,
        );
    } else {
        (*vtop)
            .r = ((*vtop).r as libc::c_int & !(0x4000 as libc::c_int)) as libc::c_ushort;
    };
}
...
unsafe extern "C" fn gen_bounds_epilog() {
    ...
    *bounds_ptr = 0 as libc::c_int as Elf64_Addr;
    ...
    if offset_modified != 0 {
        ...
        o(0x90000000 as libc::c_uint | 0 as libc::c_int as libc::c_uint);
        greloca(
            (*tcc_state).cur_text_section,
            sym_data,
            ind as libc::c_ulong,
        ...
        o(
            0xf9400000 as libc::c_uint | 0 as libc::c_int as libc::c_uint
                | ((0 as libc::c_int) << 5 as libc::c_int) as libc::c_uint,
        );
        gen_bounds_call(TOK___bound_local_new as libc::c_int);
        ind = saved_ind as libc::c_int;
    }
    o(0xa9bf07e0 as libc::c_uint);
    o(0x3c9f0fe0 as libc::c_int as libc::c_uint);
    greloca(
        (*tcc_state).cur_text_section,
        sym_data,
        ind as libc::c_ulong,
    ...
    o(0x3cc107e0 as libc::c_int as libc::c_uint);
    o(0xa8c107e0 as libc::c_uint);
}
unsafe extern "C" fn arm64_hfa_aux(
    ...
    if is_float((*type_0).t) != 0 {
        ...
        let mut n: libc::c_int = type_size(type_0, &mut a);
        if num >= 4 as libc::c_int || *fsize != 0 && *fsize != n {
            return -(1 as libc::c_int);
        }
        *fsize = n;
        return num + 1 as libc::c_int;
    } else if (*type_0).t & 0xf as libc::c_int == 7 as libc::c_int {
        let mut is_struct: libc::c_int = 0 as libc::c_int;
        let mut field: *mut Sym = 0 as *mut Sym;
        field = (*(*type_0).ref_0).c2rust_unnamed_0.next;
        while !field.is_null() {
            if (*field).c2rust_unnamed.c2rust_unnamed.c != 0 {
                is_struct = 1 as libc::c_int;
                break;
            } else {
        ...
        if is_struct != 0 {
            let mut num0: libc::c_int = num;
            field = (*(*type_0).ref_0).c2rust_unnamed_0.next;
            while !field.is_null() {
                if (*field).c2rust_unnamed.c2rust_unnamed.c != (num - num0) * *fsize {
                    return -(1 as libc::c_int);
                }
                num = arm64_hfa_aux(&mut (*field).type_0, fsize, num);
                if num == -(1 as libc::c_int) {
                    return -(1 as libc::c_int);
                }
                field = (*field).c2rust_unnamed_0.next;
            }
            if (*(*type_0).ref_0).c2rust_unnamed.c2rust_unnamed.c
                != (num - num0) * *fsize
            {
                return -(1 as libc::c_int);
            }
            ...
            let mut num0_0: libc::c_int = num;
            field = (*(*type_0).ref_0).c2rust_unnamed_0.next;
            while !field.is_null() {
                let mut num1: libc::c_int = arm64_hfa_aux(
                    &mut (*field).type_0,
                    fsize,
                    num0_0,
                );
        ...
        && (*type_0).t & 0xf as libc::c_int != 5 as libc::c_int
    {
        let mut num1_0: libc::c_int = 0;
        if (*(*type_0).ref_0).c2rust_unnamed.c2rust_unnamed.c == 0 {
            return num;
        }
        num1_0 = arm64_hfa_aux(&mut (*(*type_0).ref_0).type_0, fsize, num);
        if num1_0 == -(1 as libc::c_int)
            || num1_0 != num
                && (*(*type_0).ref_0).c2rust_unnamed.c2rust_unnamed.c > 4 as libc::c_int
        {
            return -(1 as libc::c_int);
        }
        num1_0 = num
            + (*(*type_0).ref_0).c2rust_unnamed.c2rust_unnamed.c * (num1_0 - num);
        if num1_0 > 4 as libc::c_int {
            return -(1 as libc::c_int);
        }
        return num1_0;
    }
...
unsafe extern "C" fn arm64_hfa(
    mut type_0: *mut CType,
    mut fsize: *mut libc::c_uint,
) -> libc::c_int {
            ...
            && (*type_0).t & 0xf as libc::c_int != 5 as libc::c_int
    {
        ...
        let mut n: libc::c_int = arm64_hfa_aux(type_0, &mut sz, 0 as libc::c_int);
        if (0 as libc::c_int) < n && n <= 4 as libc::c_int {
            if !fsize.is_null() {
                *fsize = sz as libc::c_uint;
            }
            return n;
        }
    }
...
unsafe extern "C" fn arm64_pcs_aux(
    mut variadic: libc::c_int,
    mut n: libc::c_int,
    mut type_0: *mut *mut CType,
    mut a: *mut libc::c_ulong,
) -> libc::c_ulong {
    let mut nx: libc::c_int = 0 as libc::c_int;
    let mut nv: libc::c_int = 0 as libc::c_int;
    let mut ns: libc::c_ulong = 32 as libc::c_int as libc::c_ulong;
    let mut i: libc::c_int = 0;
    let mut current_block_43: u64;
    i = 0 as libc::c_int;
    while i < n {
        let mut hfa: libc::c_int = arm64_hfa(
            *type_0.offset(i as isize),
            0 as *mut libc::c_uint,
        );
        let mut size: libc::c_int = 0;
        let mut align: libc::c_int = 0;
        if (**type_0.offset(i as isize)).t & 0x40 as libc::c_int != 0
            || (**type_0.offset(i as isize)).t & 0xf as libc::c_int == 6 as libc::c_int
        {
            align = 8 as libc::c_int;
            size = align;
        } else {
            size = type_size(*type_0.offset(i as isize), &mut align);
        }
        if hfa != 0 {
            current_block_43 = 17407779659766490442;
        } else if size > 16 as libc::c_int {
            if nx < 8 as libc::c_int {
                let fresh0 = nx;
                nx = nx + 1;
                *a
                    .offset(
                        i as isize,
                    ) = (fresh0 << 1 as libc::c_int | 1 as libc::c_int) as libc::c_ulong;
            } else {
                ns = ns.wrapping_add(7 as libc::c_int as libc::c_ulong)
                    & !(7 as libc::c_int) as libc::c_ulong;
                *a.offset(i as isize) = ns | 1 as libc::c_int as libc::c_ulong;
                ns = ns.wrapping_add(8 as libc::c_int as libc::c_ulong);
            }
            current_block_43 = 8258075665625361029;
        } else {
            if (**type_0.offset(i as isize)).t & 0xf as libc::c_int == 7 as libc::c_int {
                size = size + 7 as libc::c_int & !(7 as libc::c_int);
            }
            current_block_43 = 17407779659766490442;
        }
        match current_block_43 {
            17407779659766490442 => {
                if is_float((**type_0.offset(i as isize)).t) != 0
                    && nv < 8 as libc::c_int
                {
                    let fresh1 = nv;
                    nv = nv + 1;
                    *a
                        .offset(
                            i as isize,
                        ) = (16 as libc::c_int + (fresh1 << 1 as libc::c_int))
                        as libc::c_ulong;
                } else if hfa != 0 && nv + hfa <= 8 as libc::c_int {
                    *a
                        .offset(
                            i as isize,
                        ) = (16 as libc::c_int + (nv << 1 as libc::c_int))
                        as libc::c_ulong;
                    nv += hfa;
                } else {
                    if hfa != 0 {
                    ...
                    if hfa != 0
                        || (**type_0.offset(i as isize)).t & 0xf as libc::c_int
                            == 10 as libc::c_int
                    {
                        ns = ns.wrapping_add(7 as libc::c_int as libc::c_ulong)
                            & !(7 as libc::c_int) as libc::c_ulong;
                    ...
                    if (**type_0.offset(i as isize)).t & 0xf as libc::c_int
                        == 8 as libc::c_int
                    {
                        size = 8 as libc::c_int;
                    }
                    if hfa != 0 || is_float((**type_0.offset(i as isize)).t) != 0 {
                        *a.offset(i as isize) = ns;
                        ns = ns.wrapping_add(size as libc::c_ulong);
                    } else if (**type_0.offset(i as isize)).t & 0xf as libc::c_int
                        != 7 as libc::c_int && size <= 8 as libc::c_int
                        && nx < 8 as libc::c_int
                    {
                        let fresh2 = nx;
                        nx = nx + 1;
                        *a
                        ...
                        if align == 16 as libc::c_int {
                            nx = nx + 1 as libc::c_int & !(1 as libc::c_int);
                        }
                        if (**type_0.offset(i as isize)).t & 0xf as libc::c_int
                            != 7 as libc::c_int && size == 16 as libc::c_int
                            && nx < 7 as libc::c_int
                        {
                            *a
                                .offset(
                                    i as isize,
                                ) = (nx << 1 as libc::c_int) as libc::c_ulong;
                            nx += 2 as libc::c_int;
                        } else if (**type_0.offset(i as isize)).t & 0xf as libc::c_int
                            == 7 as libc::c_int
                            && size <= (8 as libc::c_int - nx) * 8 as libc::c_int
                        {
                            *a
                                .offset(
                                    i as isize,
                                ) = (nx << 1 as libc::c_int) as libc::c_ulong;
                            nx += size + 7 as libc::c_int >> 3 as libc::c_int;
                        } else {
                            nx = 8 as libc::c_int;
                            ns = ns.wrapping_add(7 as libc::c_int as libc::c_ulong)
                                & !(7 as libc::c_int) as libc::c_ulong;
    ...
    return ns.wrapping_sub(32 as libc::c_int as libc::c_ulong);
}
unsafe extern "C" fn arm64_pcs(
    mut variadic: libc::c_int,
    mut n: libc::c_int,
    mut type_0: *mut *mut CType,
    mut a: *mut libc::c_ulong,
) -> libc::c_ulong {
    let mut stack: libc::c_ulong = 0;
    if (**type_0.offset(0 as libc::c_int as isize)).t & 0xf as libc::c_int
        == 0 as libc::c_int
    {
        *a.offset(0 as libc::c_int as isize) = -(1 as libc::c_int) as libc::c_ulong;
    } else {
        arm64_pcs_aux(0 as libc::c_int, 1 as libc::c_int, type_0, a);
        if *a.offset(0 as libc::c_int as isize) == 0 as libc::c_int as libc::c_ulong
            || *a.offset(0 as libc::c_int as isize) == 1 as libc::c_int as libc::c_ulong
            || *a.offset(0 as libc::c_int as isize) == 16 as libc::c_int as libc::c_ulong
        {} else {
            __assert_fail(
                b"a[0] == 0 || a[0] == 1 || a[0] == 16\0" as *const u8
                    as *const libc::c_char,
                b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                    as *const u8 as *const libc::c_char,
                ...
                (*::core::mem::transmute::<
                    &[u8; 61],
                    &[libc::c_char; 61],
                >(b"unsigned long arm64_pcs(int, int, CType **, unsigned long *)\0"))
                    .as_ptr(),
            );
        }
        'c_20340: {
    ...
    stack = arm64_pcs_aux(
        variadic,
        n,
        type_0.offset(1 as libc::c_int as isize),
        a.offset(1 as libc::c_int as isize),
    );
    return stack;
}
unsafe extern "C" fn n_func_args(mut type_0: *mut CType) -> libc::c_int {
    let mut n_args: libc::c_int = 0 as libc::c_int;
    let mut arg: *mut Sym = 0 as *mut Sym;
    arg = (*(*type_0).ref_0).c2rust_unnamed_0.next;
    while !arg.is_null() {
        n_args += 1;
        n_args;
...
pub unsafe extern "C" fn gfunc_call(mut nb_args: libc::c_int) {
    let mut return_type: *mut CType = 0 as *mut CType;
    let mut t: *mut *mut CType = 0 as *mut *mut CType;
    let mut a: *mut libc::c_ulong = 0 as *mut libc::c_ulong;
    let mut a1: *mut libc::c_ulong = 0 as *mut libc::c_ulong;
    let mut stack: libc::c_ulong = 0;
    let mut i: libc::c_int = 0;
    let mut variadic: libc::c_int = (((*(*vtop.offset(-nb_args as isize)).type_0.ref_0)
        .c2rust_unnamed
        .c2rust_unnamed
        .c2rust_unnamed
        .f)
        .func_type() as libc::c_int == 3 as libc::c_int) as libc::c_int;
    let mut var_nb_arg: libc::c_int = n_func_args(
        &mut (*vtop.offset(-nb_args as isize)).type_0,
    );
    if (*tcc_state).do_bounds_check != 0 {
        gbound_args(nb_args);
    }
    return_type = &mut (*(*vtop.offset(-nb_args as isize)).type_0.ref_0).type_0;
    if (*return_type).t & 0xf as libc::c_int == 7 as libc::c_int {
        nb_args -= 1;
        nb_args;
    }
    t = tcc_malloc(
        ((nb_args + 1 as libc::c_int) as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<*mut CType>() as libc::c_ulong),
    ) as *mut *mut CType;
    a = tcc_malloc(
        ((nb_args + 1 as libc::c_int) as libc::c_ulong)
    ...
    let ref mut fresh3 = *t.offset(0 as libc::c_int as isize);
    *fresh3 = return_type;
    i = 0 as libc::c_int;
    while i < nb_args {
        let ref mut fresh4 = *t.offset((nb_args - i) as isize);
        *fresh4 = &mut (*vtop.offset(-i as isize)).type_0;
        i += 1;
        i;
    }
    stack = arm64_pcs(
        if variadic != 0 { var_nb_arg } else { 0 as libc::c_int },
        nb_args,
        t,
        a,
    );
    i = nb_args;
    while i != 0 {
        if *a.offset(i as isize) & 1 as libc::c_int as libc::c_ulong != 0 {
            let mut arg: *mut SValue = &mut *vtop.offset((i - nb_args) as isize)
                as *mut SValue;
            let mut align: libc::c_int = 0;
            let mut size: libc::c_int = type_size(&mut (*arg).type_0, &mut align);
            if (*arg).type_0.t & 0xf as libc::c_int == 7 as libc::c_int {} else {
                __assert_fail(
                    b"(arg->type.t & VT_BTYPE) == VT_STRUCT\0" as *const u8
                        as *const libc::c_char,
                    b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                        as *const u8 as *const libc::c_char,
            ...
            stack = stack
                ...
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                & -align as libc::c_ulong;
            *a1.offset(i as isize) = stack;
            stack = stack.wrapping_add(size as libc::c_ulong);
        }
        i -= 1;
        i;
    }
    stack = (stack.wrapping_add(15 as libc::c_int as libc::c_ulong) >> 4 as libc::c_int)
        << 4 as libc::c_int;
    if stack >= 0x1000000 as libc::c_int as libc::c_ulong {
        _tcc_error(
            b"stack size too big %lu\0" as *const u8 as *const libc::c_char,
            stack,
        );
    }
    if stack & 0xfff as libc::c_int as libc::c_ulong != 0 {
        o(
            (0xd10003ff as libc::c_uint as libc::c_ulong
                | (stack & 0xfff as libc::c_int as libc::c_ulong) << 10 as libc::c_int)
                as libc::c_uint,
        );
    }
    if stack >> 12 as libc::c_int != 0 {
        o(
            (0xd14003ff as libc::c_uint as libc::c_ulong
                | (stack >> 12 as libc::c_int) << 10 as libc::c_int) as libc::c_uint,
        );
    }
    i = nb_args;
    while i != 0 {
        vpushv(vtop.offset(-(nb_args as isize)).offset(i as isize));
        if *a.offset(i as isize) & 1 as libc::c_int as libc::c_ulong != 0 {
            let mut r: libc::c_int = get_reg(0x1 as libc::c_int);
            arm64_spoff(intr(r) as libc::c_int, *a1.offset(i as isize));
            vset(&mut (*vtop).type_0, r | 0x100 as libc::c_int, 0 as libc::c_int);
            vswap();
            vstore();
            if *a.offset(i as isize) >= 32 as libc::c_int as libc::c_ulong {
        ...
        } else if *a.offset(i as isize) >= 32 as libc::c_int as libc::c_ulong {
            if (*vtop).type_0.t & 0xf as libc::c_int == 7 as libc::c_int {
                let mut r_0: libc::c_int = get_reg(0x1 as libc::c_int);
                arm64_spoff(
                    intr(r_0) as libc::c_int,
                    (*a.offset(i as isize))
                        .wrapping_sub(32 as libc::c_int as libc::c_ulong),
                );
                vset(&mut (*vtop).type_0, r_0 | 0x100 as libc::c_int, 0 as libc::c_int);
                vswap();
                vstore();
            } else if is_float((*vtop).type_0.t) != 0 {
                gv(0x2 as libc::c_int);
                arm64_strv(
                    arm64_type_size((*vtop.offset(0 as libc::c_int as isize)).type_0.t),
                    fltr((*vtop.offset(0 as libc::c_int as isize)).r as libc::c_int)
                        as libc::c_int,
                    31 as libc::c_int,
                    (*a.offset(i as isize))
                        .wrapping_sub(32 as libc::c_int as libc::c_ulong),
                ...
                arm64_strx(
                    3 as libc::c_int,
                    intr((*vtop.offset(0 as libc::c_int as isize)).r as libc::c_int)
                        as libc::c_int,
                    31 as libc::c_int,
                    (*a.offset(i as isize))
                        .wrapping_sub(32 as libc::c_int as libc::c_ulong),
    ...
    i = nb_args;
    while i != 0 {
        if *a.offset(i as isize) < 16 as libc::c_int as libc::c_ulong
            && *a.offset(i as isize) & 1 as libc::c_int as libc::c_ulong == 0
        {
            if (*vtop).type_0.t & 0xf as libc::c_int == 7 as libc::c_int {
                let mut align_0: libc::c_int = 0;
                let mut size_0: libc::c_int = type_size(
                    &mut (*vtop).type_0,
                    &mut align_0,
                );
                if size_0 != 0 {
        ...
        } else if *a.offset(i as isize) < 16 as libc::c_int as libc::c_ulong {
            arm64_spoff(
                (*a.offset(i as isize)).wrapping_div(2 as libc::c_int as libc::c_ulong)
                    as libc::c_int,
                *a1.offset(i as isize),
            );
        } else if *a.offset(i as isize) < 32 as libc::c_int as libc::c_ulong {
            if (*vtop).type_0.t & 0xf as libc::c_int == 7 as libc::c_int {
                let mut j: uint32_t = 0;
                let mut sz: uint32_t = 0;
                let mut n: uint32_t = arm64_hfa(&mut (*vtop).type_0, &mut sz)
                    as uint32_t;
                (*vtop).type_0.t = 5 as libc::c_int;
                gaddrof();
                ...
                while j < n {
                    o(
                        ((0x3d4003c0 as libc::c_int as uint32_t
                            | (sz & 16 as libc::c_int as uint32_t) << 19 as libc::c_int
                            | (sz & 8 as libc::c_int as uint32_t).wrapping_neg()
                                << 27 as libc::c_int
                            | (sz & 4 as libc::c_int as uint32_t) << 29 as libc::c_int)
                            as libc::c_ulong
                            | (*a.offset(i as isize))
                                .wrapping_div(2 as libc::c_int as libc::c_ulong)
                                .wrapping_sub(8 as libc::c_int as libc::c_ulong)
                                .wrapping_add(j as libc::c_ulong)
                            | (j << 10 as libc::c_int) as libc::c_ulong) as libc::c_uint,
                    );
                    j = j.wrapping_add(1);
                    j;
                }
    ...
    if (*return_type).t & 0xf as libc::c_int == 7 as libc::c_int {
        if *a.offset(0 as libc::c_int as isize) == 1 as libc::c_int as libc::c_ulong {
            gv(RC_R(8 as libc::c_int));
            vtop = vtop.offset(-1);
            vtop;
        } else {
            vswap();
    ...
    arm64_gen_bl_or_b(0 as libc::c_int);
    vtop = vtop.offset(-1);
    vtop;
    if stack & 0xfff as libc::c_int as libc::c_ulong != 0 {
        o(
            (0x910003ff as libc::c_uint as libc::c_ulong
                | (stack & 0xfff as libc::c_int as libc::c_ulong) << 10 as libc::c_int)
                as libc::c_uint,
        );
    }
    if stack >> 12 as libc::c_int != 0 {
        o(
            (0x914003ff as libc::c_uint as libc::c_ulong
                | (stack >> 12 as libc::c_int) << 10 as libc::c_int) as libc::c_uint,
        );
    }
    let mut rt: libc::c_int = (*return_type).t;
    let mut bt: libc::c_int = rt & 0xf as libc::c_int;
    if bt == 7 as libc::c_int
        && *a.offset(0 as libc::c_int as isize) & 1 as libc::c_int as libc::c_ulong == 0
    {
        gv(RC_R(8 as libc::c_int));
        vtop = vtop.offset(-1);
        vtop;
        if *a.offset(0 as libc::c_int as isize) == 0 as libc::c_int as libc::c_ulong {
            let mut align_1: libc::c_int = 0;
            let mut size_1: libc::c_int = type_size(return_type, &mut align_1);
            if size_1 <= 16 as libc::c_int {} else {
                __assert_fail(
                    b"size <= 16\0" as *const u8 as *const libc::c_char,
                    b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                        as *const u8 as *const libc::c_char,
            ...
            if size_1 > 8 as libc::c_int {
                o(0xa9000500 as libc::c_uint);
            } else if size_1 != 0 {
                arm64_strx(
                    if size_1 > 4 as libc::c_int {
                        3 as libc::c_int
                    } else if size_1 > 2 as libc::c_int {
                        2 as libc::c_int
                    } else {
                        (size_1 > 1 as libc::c_int) as libc::c_int
                    },
                    0 as libc::c_int,
                    8 as libc::c_int,
                    0 as libc::c_int as uint64_t,
        ...
        } else if *a.offset(0 as libc::c_int as isize)
            == 16 as libc::c_int as libc::c_ulong
        {
            let mut j_0: uint32_t = 0;
            let mut sz_0: uint32_t = 0;
            let mut n_0: uint32_t = arm64_hfa(return_type, &mut sz_0) as uint32_t;
            j_0 = 0 as libc::c_int as uint32_t;
            while j_0 < n_0 {
                o(
                    ((0x3d000100 as libc::c_int as uint32_t
                        | (sz_0 & 16 as libc::c_int as uint32_t) << 19 as libc::c_int
                        | (sz_0 & 8 as libc::c_int as uint32_t).wrapping_neg()
                            << 27 as libc::c_int
                        | (sz_0 & 4 as libc::c_int as uint32_t) << 29 as libc::c_int)
                        as libc::c_ulong
                        | (*a.offset(i as isize))
                            .wrapping_div(2 as libc::c_int as libc::c_ulong)
                            .wrapping_sub(8 as libc::c_int as libc::c_ulong)
                            .wrapping_add(j_0 as libc::c_ulong)
                        | (j_0 << 10 as libc::c_int) as libc::c_ulong) as libc::c_uint,
                );
    ...
    tcc_free(a1 as *mut libc::c_void);
    tcc_free(a as *mut libc::c_void);
    tcc_free(t as *mut libc::c_void);
}
static mut arm64_func_va_list_stack: libc::c_ulong = 0;
static mut arm64_func_va_list_gr_offs: libc::c_int = 0;
static mut arm64_func_va_list_vr_offs: libc::c_int = 0;
static mut arm64_func_sub_sp_offset: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn gfunc_prolog(mut func_sym: *mut Sym) {
    ...
    let mut t: *mut *mut CType = 0 as *mut *mut CType;
    let mut a: *mut libc::c_ulong = 0 as *mut libc::c_ulong;
    let mut use_x8: libc::c_int = 0 as libc::c_int;
    let mut last_int: libc::c_int = 0 as libc::c_int;
    let mut last_float: libc::c_int = 0 as libc::c_int;
    let mut variadic: libc::c_int = (((*(*func_sym).type_0.ref_0)
        .c2rust_unnamed
        .c2rust_unnamed
        .c2rust_unnamed
        .f)
        .func_type() as libc::c_int == 3 as libc::c_int) as libc::c_int;
    let mut var_nb_arg: libc::c_int = n_func_args(&mut (*func_sym).type_0);
    func_vc = 144 as libc::c_int;
    sym = (*func_type).ref_0;
    while !sym.is_null() {
        n += 1;
        n;
    ...
    while !sym.is_null() {
        let fresh5 = i;
        i = i + 1;
        let ref mut fresh6 = *t.offset(fresh5 as isize);
        *fresh6 = &mut (*sym).type_0;
        sym = (*sym).c2rust_unnamed_0.next;
    }
    arm64_func_va_list_stack = arm64_pcs(
        if variadic != 0 { var_nb_arg } else { 0 as libc::c_int },
        n - 1 as libc::c_int,
        t,
        a,
    ...
    if variadic != 0 {
        use_x8 = 1 as libc::c_int;
        last_int = 4 as libc::c_int;
        last_float = 4 as libc::c_int;
    }
    if !a.is_null()
        && *a.offset(0 as libc::c_int as isize) == 1 as libc::c_int as libc::c_ulong
    {
    ...
    i = 1 as libc::c_int;
    sym = (*(*func_type).ref_0).c2rust_unnamed_0.next;
    while !sym.is_null() {
        if *a.offset(i as isize) < 16 as libc::c_int as libc::c_ulong {
            let mut last: libc::c_int = 0;
            let mut align: libc::c_int = 0;
            let mut size: libc::c_int = type_size(&mut (*sym).type_0, &mut align);
            last = (*a.offset(i as isize))
                .wrapping_div(4 as libc::c_int as libc::c_ulong)
                .wrapping_add(1 as libc::c_int as libc::c_ulong)
                .wrapping_add(
                    ((size - 1 as libc::c_int) / 8 as libc::c_int) as libc::c_ulong,
                ) as libc::c_int;
            last_int = if last > last_int { last } else { last_int };
        } else if *a.offset(i as isize) < 32 as libc::c_int as libc::c_ulong {
            let mut last_0: libc::c_int = 0;
            let mut hfa: libc::c_int = arm64_hfa(
                &mut (*sym).type_0,
                0 as *mut libc::c_uint,
            );
            last_0 = (*a.offset(i as isize))
                .wrapping_div(4 as libc::c_int as libc::c_ulong)
                .wrapping_sub(3 as libc::c_int as libc::c_ulong)
                .wrapping_add(
                    (if hfa != 0 { hfa - 1 as libc::c_int } else { 0 as libc::c_int })
                        as libc::c_ulong,
                ) as libc::c_int;
            last_float = if last_0 > last_float { last_0 } else { last_float };
        }
        i += 1;
        i;
        sym = (*sym).c2rust_unnamed_0.next;
    }
    last_int = if last_int > 4 as libc::c_int { 4 as libc::c_int } else { last_int };
    last_float = if last_float > 4 as libc::c_int {
        4 as libc::c_int
    } else {
        last_float
    };
    o(0xa9b27bfd as libc::c_uint);
    i = 0 as libc::c_int;
    while i < last_float {
        o(
            (0xad0087e0 as libc::c_uint)
                .wrapping_add((i * 0x10000 as libc::c_int) as libc::c_uint)
                .wrapping_add((i << 11 as libc::c_int) as libc::c_uint)
                .wrapping_add((i << 1 as libc::c_int) as libc::c_uint),
        );
        i += 1;
        i;
    }
    if use_x8 != 0 {
        o(0xa90923e8 as libc::c_uint);
    }
    i = 0 as libc::c_int;
    while i < last_int {
        o(
            (0xa90a07e0 as libc::c_uint)
                .wrapping_add((i * 0x10000 as libc::c_int) as libc::c_uint)
                .wrapping_add((i << 11 as libc::c_int) as libc::c_uint)
                .wrapping_add((i << 1 as libc::c_int) as libc::c_uint),
        );
    ...
    arm64_func_va_list_gr_offs = -(64 as libc::c_int);
    arm64_func_va_list_vr_offs = -(128 as libc::c_int);
    i = 1 as libc::c_int;
    sym = (*(*func_type).ref_0).c2rust_unnamed_0.next;
    while !sym.is_null() {
        let mut off: libc::c_int = (if *a.offset(i as isize)
            < 16 as libc::c_int as libc::c_ulong
        {
        ...
        if *a.offset(i as isize) < 16 as libc::c_int as libc::c_ulong {
            let mut align_0: libc::c_int = 0;
            let mut size_0: libc::c_int = type_size(&mut (*sym).type_0, &mut align_0);
            arm64_func_va_list_gr_offs = (*a.offset(i as isize))
                .wrapping_div(2 as libc::c_int as libc::c_ulong)
                .wrapping_sub(7 as libc::c_int as libc::c_ulong)
                .wrapping_add(
                    (*a.offset(i as isize) & 1 as libc::c_int as libc::c_ulong == 0
                        && size_0 > 8 as libc::c_int) as libc::c_int as libc::c_ulong,
                )
                .wrapping_mul(8 as libc::c_int as libc::c_ulong) as libc::c_int;
        } else if *a.offset(i as isize) < 32 as libc::c_int as libc::c_ulong {
            let mut hfa_0: uint32_t = arm64_hfa(
                &mut (*sym).type_0,
                0 as *mut libc::c_uint,
            ) as uint32_t;
            arm64_func_va_list_vr_offs = (*a.offset(i as isize))
                .wrapping_div(2 as libc::c_int as libc::c_ulong)
                .wrapping_sub(16 as libc::c_int as libc::c_ulong)
                .wrapping_add(
                    (if hfa_0 != 0 { hfa_0 } else { 1 as libc::c_int as uint32_t })
                        as libc::c_ulong,
                )
                .wrapping_mul(16 as libc::c_int as libc::c_ulong) as libc::c_int;
        }
        if 16 as libc::c_int as libc::c_ulong <= *a.offset(i as isize)
            && *a.offset(i as isize) < 32 as libc::c_int as libc::c_ulong
            && (*sym).type_0.t & 0xf as libc::c_int == 7 as libc::c_int
        {
            let mut j: uint32_t = 0;
            let mut sz: uint32_t = 0;
            let mut k: uint32_t = arm64_hfa(&mut (*sym).type_0, &mut sz) as uint32_t;
            if sz < 16 as libc::c_int as uint32_t {
                j = 0 as libc::c_int as uint32_t;
                while j < k {
                    o(
                        ((0x3d0003e0 as libc::c_int as uint32_t
                            | (sz & 8 as libc::c_int as uint32_t).wrapping_neg()
                                << 27 as libc::c_int
                            | (sz & 4 as libc::c_int as uint32_t) << 29 as libc::c_int)
                            as libc::c_ulong
                            | (*a.offset(i as isize))
                                ...
                                .wrapping_div(2 as libc::c_int as libc::c_ulong)
                                .wrapping_add(j as libc::c_ulong)
                            | ((off as uint32_t / sz).wrapping_add(j)
                                << 10 as libc::c_int) as libc::c_ulong) as libc::c_uint,
                    );
                    j = j.wrapping_add(1);
                    j;
                }
...
pub unsafe extern "C" fn gen_va_start() {
    ...
    vtop;
    gaddrof();
    r = intr(gv(0x1 as libc::c_int)) as libc::c_int;
    if arm64_func_va_list_stack != 0 {
        arm64_movimm(
            30 as libc::c_int,
            arm64_func_va_list_stack.wrapping_add(224 as libc::c_int as libc::c_ulong),
        );
        o(0x8b1e03be as libc::c_uint);
    } else {
        o(0x910383be as libc::c_uint);
    }
    o(0xf900001e as libc::c_uint | (r << 5 as libc::c_int) as libc::c_uint);
    if arm64_func_va_list_gr_offs != 0 {
        if arm64_func_va_list_stack != 0 {
            o(0x910383be as libc::c_uint);
        }
        o(0xf900041e as libc::c_uint | (r << 5 as libc::c_int) as libc::c_uint);
    }
    if arm64_func_va_list_vr_offs != 0 {
        o(0x910243be as libc::c_uint);
        o(0xf900081e as libc::c_uint | (r << 5 as libc::c_int) as libc::c_uint);
    }
    arm64_movimm(30 as libc::c_int, arm64_func_va_list_gr_offs as uint64_t);
    o(0xb900181e as libc::c_uint | (r << 5 as libc::c_int) as libc::c_uint);
    arm64_movimm(30 as libc::c_int, arm64_func_va_list_vr_offs as uint64_t);
    o(0xb9001c1e as libc::c_uint | (r << 5 as libc::c_int) as libc::c_uint);
    vtop = vtop.offset(-1);
    vtop;
}
#[no_mangle]
pub unsafe extern "C" fn gen_va_arg(mut t: *mut CType) {
    let mut align: libc::c_int = 0;
    let mut size: libc::c_int = type_size(t, &mut align);
    let mut fsize: libc::c_uint = 0;
    let mut hfa: libc::c_uint = arm64_hfa(t, &mut fsize) as libc::c_uint;
    let mut r0: uint32_t = 0;
    let mut r1: uint32_t = 0;
    if is_float((*t).t) != 0 {
        hfa = 1 as libc::c_int as libc::c_uint;
        fsize = size as libc::c_uint;
    }
    gaddrof();
    r0 = intr(gv(0x1 as libc::c_int));
    r1 = get_reg(0x1 as libc::c_int) as uint32_t;
    (*vtop.offset(0 as libc::c_int as isize))
        .r = (r1 | 0x100 as libc::c_int as uint32_t) as libc::c_ushort;
    r1 = intr(r1 as libc::c_int);
    if hfa == 0 {
        let mut n: uint32_t = (if size > 16 as libc::c_int {
            8 as libc::c_int
        } else {
            size + 7 as libc::c_int & -(8 as libc::c_int)
        }) as uint32_t;
        o(0xb940181e as libc::c_uint | r0 << 5 as libc::c_int);
        if align == 16 as libc::c_int {
            __assert_fail(
                b"0\0" as *const u8 as *const libc::c_char,
                b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
            ...
            o(0x11003fde as libc::c_int as libc::c_uint);
            o(0x121c6fde as libc::c_int as libc::c_uint);
        }
        o(0x310003c0 as libc::c_int as uint32_t | r1 | n << 10 as libc::c_int);
        o(0x540000ad as libc::c_int as libc::c_uint);
        o(0xf9400000 as libc::c_uint | r1 | r0 << 5 as libc::c_int);
        o(0x9100001e as libc::c_uint | r1 << 5 as libc::c_int | n << 10 as libc::c_int);
        o(0xf900001e as libc::c_uint | r0 << 5 as libc::c_int);
        o(0x14000004 as libc::c_int as libc::c_uint);
        o(0xb9001800 as libc::c_uint | r1 | r0 << 5 as libc::c_int);
        o(0xf9400400 as libc::c_uint | r1 | r0 << 5 as libc::c_int);
        o(0x8b3ec000 as libc::c_uint | r1 | r1 << 5 as libc::c_int);
        if size > 16 as libc::c_int {
            o(0xf9400000 as libc::c_uint | r1 | r1 << 5 as libc::c_int);
        }
    } else {
        let mut ssz: uint32_t = (size + 7 as libc::c_int) as uint32_t
            & (8 as libc::c_int as uint32_t).wrapping_neg();
        let mut rsz: uint32_t = hfa << 4 as libc::c_int;
        let mut b1: uint32_t = 0;
        let mut b2: uint32_t = 0;
        o(0xb9401c1e as libc::c_uint | r0 << 5 as libc::c_int);
        o(0x310003c0 as libc::c_int as uint32_t | r1 | rsz << 10 as libc::c_int);
        b1 = ind as uint32_t;
        o(0x5400000d as libc::c_int as libc::c_uint);
        o(0xf9400000 as libc::c_uint | r1 | r0 << 5 as libc::c_int);
        if fsize == 16 as libc::c_int as libc::c_uint {
            o(0x91003c00 as libc::c_uint | r1 | r1 << 5 as libc::c_int);
            o(0x927cec00 as libc::c_uint | r1 | r1 << 5 as libc::c_int);
        }
        o(
            0x9100001e as libc::c_uint | r1 << 5 as libc::c_int
                | ssz << 10 as libc::c_int,
        );
        o(0xf900001e as libc::c_uint | r0 << 5 as libc::c_int);
        b2 = ind as uint32_t;
        o(0x14000000 as libc::c_int as libc::c_uint);
        write32le(
            ((*(*tcc_state).cur_text_section).data).offset(b1 as isize),
            0x5400000d as libc::c_int as uint32_t
                | (ind as uint32_t).wrapping_sub(b1) << 3 as libc::c_int,
        );
        o(0xb9001c00 as libc::c_uint | r1 | r0 << 5 as libc::c_int);
        o(0xf9400800 as libc::c_uint | r1 | r0 << 5 as libc::c_int);
        if hfa == 1 as libc::c_int as libc::c_uint
            || fsize == 16 as libc::c_int as libc::c_uint
        {
            o(0x8b3ec000 as libc::c_uint | r1 | r1 << 5 as libc::c_int);
        } else {
            loc = ((loc - size) as uint32_t & (align as uint32_t).wrapping_neg())
                as libc::c_int;
            o(
                0x8b3ec000 as libc::c_uint | 30 as libc::c_int as libc::c_uint
                    | r1 << 5 as libc::c_int,
            );
            arm64_movimm(r1 as libc::c_int, loc as uint64_t);
            o(0x8b0003a0 as libc::c_uint | r1 | r1 << 16 as libc::c_int);
            o(
                0x4c402bdc as libc::c_int as uint32_t | fsize << 7 as libc::c_int
                    | ((hfa == 2 as libc::c_int as libc::c_uint) as libc::c_int
                        as uint32_t) << 15 as libc::c_int
                    | ((hfa == 3 as libc::c_int as libc::c_uint) as libc::c_int
                        as uint32_t) << 14 as libc::c_int,
            );
            o(
                0xd00801c as libc::c_int as uint32_t | r1 << 5 as libc::c_int
                    | (((fsize == 8 as libc::c_int as libc::c_uint) as libc::c_int)
                        << 10 as libc::c_int) as uint32_t
                    | ((hfa != 2 as libc::c_int as libc::c_uint) as libc::c_int
                        as uint32_t) << 13 as libc::c_int
                    | ((hfa != 3 as libc::c_int as libc::c_uint) as libc::c_int
                        as uint32_t) << 21 as libc::c_int,
            );
        }
        write32le(
            ((*(*tcc_state).cur_text_section).data).offset(b2 as isize),
            0x14000000 as libc::c_int as uint32_t
                | (ind as uint32_t).wrapping_sub(b2) >> 2 as libc::c_int,
        );
    };
}
#[no_mangle]
pub unsafe extern "C" fn gfunc_sret(
    ...
    mut variadic: libc::c_int,
    mut ret: *mut CType,
    mut align: *mut libc::c_int,
    mut regsize: *mut libc::c_int,
) -> libc::c_int {
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn gfunc_return(mut func_type: *mut CType) {
    let mut t: *mut CType = func_type;
    let mut a: libc::c_ulong = 0;
    arm64_pcs(0 as libc::c_int, 0 as libc::c_int, &mut t, &mut a);
    match a {
        18446744073709551615 => {}
        0 => {
            if (*func_type).t & 0xf as libc::c_int == 7 as libc::c_int {
                let mut align: libc::c_int = 0;
                let mut size: libc::c_int = type_size(func_type, &mut align);
                gaddrof();
                gv(RC_R(0 as libc::c_int));
                arm64_ldrs(0 as libc::c_int, size);
            } else {
                gv(0x4 as libc::c_int);
            }
        }
        1 => {
            let mut type_0: CType = *func_type;
        ...
        16 => {
            if (*func_type).t & 0xf as libc::c_int == 7 as libc::c_int {
                ...
                while j < n {
                    o(
                        0x3d400000 as libc::c_int as uint32_t
                            | (sz & 16 as libc::c_int as uint32_t) << 19 as libc::c_int
                            | (sz & 8 as libc::c_int as uint32_t).wrapping_neg()
                                << 27 as libc::c_int
                            | (sz & 4 as libc::c_int as uint32_t) << 29 as libc::c_int
...
pub unsafe extern "C" fn gfunc_epilog() {
    ...
    if loc != 0 {
        let mut ptr: *mut libc::c_uchar = ((*(*tcc_state).cur_text_section).data)
            .offset(arm64_func_sub_sp_offset as isize);
        let mut diff: uint64_t = (-loc + 15 as libc::c_int & !(15 as libc::c_int))
            as uint64_t;
        if diff >> 24 as libc::c_int == 0 {
            if diff & 0xfff as libc::c_int as uint64_t != 0 {
                write32le(
                    ptr,
                    (0xd10003ff as libc::c_uint as uint64_t
                        | (diff & 0xfff as libc::c_int as uint64_t) << 10 as libc::c_int)
                        as uint32_t,
                );
            }
            if diff >> 12 as libc::c_int != 0 {
                write32le(
                    ptr.offset(4 as libc::c_int as isize),
                    (0xd14003ff as libc::c_uint as uint64_t
                        | (diff >> 12 as libc::c_int) << 10 as libc::c_int) as uint32_t,
                );
            }
        } else {
            let mut i: libc::c_int = 0 as libc::c_int;
            let mut j: libc::c_int = 0 as libc::c_int;
            while diff >> 20 as libc::c_int != 0 {
                diff = diff.wrapping_add(0xffff as libc::c_int as uint64_t)
                    >> 16 as libc::c_int;
                i += 1;
                i;
            }
            while diff >> 16 as libc::c_int != 0 {
                diff = diff.wrapping_add(1 as libc::c_int as uint64_t)
                    >> 1 as libc::c_int;
                j += 1;
                j;
            }
            write32le(
                ptr,
                (0xd2800010 as libc::c_uint as uint64_t | diff << 5 as libc::c_int
                    | (i << 21 as libc::c_int) as uint64_t) as uint32_t,
            );
            write32le(
                ptr.offset(4 as libc::c_int as isize),
                0xcb3063ff as libc::c_uint | (j << 10 as libc::c_int) as libc::c_uint,
            );
        }
    }
    o(0x910003bf as libc::c_uint);
    o(0xa8ce7bfd as libc::c_uint);
    o(0xd65f03c0 as libc::c_uint);
}
#[no_mangle]
...
pub unsafe extern "C" fn gjmp_addr(mut a: libc::c_int) {
    if (a - ind + 0x8000000 as libc::c_int) < 0x10000000 as libc::c_int {} else {
        __assert_fail(
            b"a - ind + 0x8000000 < 0x10000000\0" as *const u8 as *const libc::c_char,
            b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                as *const u8 as *const libc::c_char,
    ...
    'c_22053: {
        if (a - ind + 0x8000000 as libc::c_int) < 0x10000000 as libc::c_int {} else {
            __assert_fail(
                b"a - ind + 0x8000000 < 0x10000000\0" as *const u8
                    as *const libc::c_char,
                b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                    as *const u8 as *const libc::c_char,
                1527 as libc::c_int as libc::c_uint,
    ...
    o(
        (0x14000000 as libc::c_int
            | a - ind >> 2 as libc::c_int & 0x3ffffff as libc::c_int) as libc::c_uint,
    );
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn arm64_vset_VT_CMP(mut op: libc::c_int) {
    if op >= 0x92 as libc::c_int && op <= 0x9f as libc::c_int {
        (*vtop).c2rust_unnamed_0.c2rust_unnamed.cmp_r = (*vtop).r;
        vset_VT_CMP(0x80 as libc::c_int);
    }
}
unsafe extern "C" fn arm64_load_cmp(mut r: libc::c_int, mut sv: *mut SValue) {
    (*sv).r = (*sv).c2rust_unnamed_0.c2rust_unnamed.cmp_r;
    if (*sv).c2rust_unnamed.c.i & 1 as libc::c_int as uint64_t != 0 {
        vpushi(1 as libc::c_int);
        arm64_gen_opil('^' as i32, 0 as libc::c_int as uint32_t);
    }
    if r != (*sv).r as libc::c_int {
        load(r, sv);
        (*sv).r = r as libc::c_ushort;
    }
}
#[no_mangle]
pub unsafe extern "C" fn gjmp_cond(
    ...
    let mut inv: libc::c_int = op & 1 as libc::c_int;
    (*vtop).r = (*vtop).c2rust_unnamed_0.c2rust_unnamed.cmp_r;
    if bt == 10 as libc::c_int {
        let mut a: uint32_t = 0;
        let mut b: uint32_t = 0;
        let mut f: uint32_t = fltr(gv(0x2 as libc::c_int));
        a = get_reg(0x1 as libc::c_int) as uint32_t;
        vpushi(0 as libc::c_int);
        (*vtop.offset(0 as libc::c_int as isize)).r = a as libc::c_ushort;
        b = get_reg(0x1 as libc::c_int) as uint32_t;
        a = intr(a as libc::c_int);
        b = intr(b as libc::c_int);
        o(0x4e083c00 as libc::c_int as uint32_t | a | f << 5 as libc::c_int);
        o(0x4e183c00 as libc::c_int as uint32_t | b | f << 5 as libc::c_int);
        o(
            0xaa000400 as libc::c_uint | a | a << 5 as libc::c_int
                | b << 16 as libc::c_int,
        );
        o(
            0xb4000040 as libc::c_uint | a
                | (((inv != 0) as libc::c_int) << 24 as libc::c_int) as libc::c_uint,
        );
        vtop = vtop.offset(-1);
        vtop;
    } else if bt == 8 as libc::c_int || bt == 9 as libc::c_int {
        let mut a_0: uint32_t = fltr(gv(0x2 as libc::c_int));
        o(
            0x1e202008 as libc::c_int as uint32_t | a_0 << 5 as libc::c_int
                | (((bt != 8 as libc::c_int) as libc::c_int) << 22 as libc::c_int)
                    as uint32_t,
        );
        o((0x54000040 as libc::c_int | (inv != 0) as libc::c_int) as libc::c_uint);
    } else {
        let mut ll: uint32_t = (bt == 5 as libc::c_int || bt == 4 as libc::c_int)
            as libc::c_int as uint32_t;
        let mut a_1: uint32_t = intr(gv(0x1 as libc::c_int));
        o(
            0x34000040 as libc::c_int as uint32_t | a_1
                | (((inv != 0) as libc::c_int) << 24 as libc::c_int) as uint32_t
                | ll << 31 as libc::c_int,
        );
    }
    return gjmp(t);
}
unsafe extern "C" fn arm64_iconst(
    ...
    if !val.is_null() {
        let mut t: libc::c_int = (*sv).type_0.t;
        let mut bt: libc::c_int = t & 0xf as libc::c_int;
        *val = if bt == 4 as libc::c_int || bt == 5 as libc::c_int {
            (*sv).c2rust_unnamed.c.i
        } else {
            (*sv).c2rust_unnamed.c.i as uint32_t as uint64_t
                | (if t & 0x10 as libc::c_int != 0 {
                    0 as libc::c_int as uint64_t
                } else {
                    ((*sv).c2rust_unnamed.c.i & 0x80000000 as libc::c_uint as uint64_t)
                        .wrapping_neg()
                })
        };
    }
...
unsafe extern "C" fn arm64_gen_opic(
    mut op: libc::c_int,
    mut l: uint32_t,
    mut rev: libc::c_int,
    mut val: uint64_t,
    ...
    val = if l != 0 { val } else { val as uint32_t as uint64_t };
    's_181: {
        match op {
            43 => {
                let mut s: uint32_t = (if l != 0 {
                    val >> 63 as libc::c_int
                } else {
                    val >> 31 as libc::c_int
                }) as uint32_t;
                val = if s != 0 { val.wrapping_neg() } else { val };
                val = if l != 0 { val } else { val as uint32_t as uint64_t };
                if val & !(0xfff as libc::c_int as uint64_t) == 0 {
                    o(
                        ((0x11000000 as libc::c_int as uint32_t | l << 31 as libc::c_int
                            | s << 30 as libc::c_int | x | a << 5 as libc::c_int)
                            as uint64_t | val << 10 as libc::c_int) as libc::c_uint,
                    );
                } else if val & !(0xfff000 as libc::c_int as uint64_t) == 0 {
                    o(
                        ((0x11400000 as libc::c_int as uint32_t | l << 31 as libc::c_int
                            | s << 30 as libc::c_int | x | a << 5 as libc::c_int)
                            as uint64_t
                            | (val >> 12 as libc::c_int) << 10 as libc::c_int)
                            as libc::c_uint,
                    );
                } else {
                    arm64_movimm(30 as libc::c_int, val);
                    o(
                        0xb1e0000 as libc::c_int as uint32_t | l << 31 as libc::c_int
                            | s << 30 as libc::c_int | x | a << 5 as libc::c_int,
                    );
                }
                return 1 as libc::c_int;
            ...
            45 => {
                if val == 0 {
                    o(
                        0x4b0003e0 as libc::c_int as uint32_t | l << 31 as libc::c_int
                    ...
                    == (if l != 0 {
                        ...
                        -(1 as libc::c_int) as uint32_t as uint64_t
                    })
                {
                    o(
                        0x2a2003e0 as libc::c_int as uint32_t | l << 31 as libc::c_int
                            | x | a << 16 as libc::c_int,
                    );
                } else {
                    arm64_movimm(30 as libc::c_int, val);
                    o(
                        0x4b0003c0 as libc::c_int as uint32_t | l << 31 as libc::c_int
                            | x | a << 16 as libc::c_int,
                    );
                }
                return 1 as libc::c_int;
            ...
            94 => {
                if val == -(1 as libc::c_int) as uint64_t
                    || val == 0xffffffff as libc::c_uint as uint64_t && l == 0
                {
                    o(
                        0x2a2003e0 as libc::c_int as uint32_t | l << 31 as libc::c_int
                            | x | a << 16 as libc::c_int,
            ...
            38 | 124 => {}
            62 | 60 | 139 => {
                let mut n: uint32_t = ((32 as libc::c_int) << l) as uint32_t;
                val = val & n.wrapping_sub(1 as libc::c_int as uint32_t) as uint64_t;
                if rev != 0 {
                    return 0 as libc::c_int;
                }
                if val == 0 {
                    o(
                        0x2a0003e0 as libc::c_int as uint32_t | l << 31 as libc::c_int
                            | a << 16 as libc::c_int,
                    );
                    return 1 as libc::c_int;
                } else if op == '<' as i32 {
                    o(
                        ((0x53000000 as libc::c_int as uint32_t | l << 31 as libc::c_int
                            | l << 22 as libc::c_int | x | a << 5 as libc::c_int)
                            as uint64_t
                            | (n as uint64_t).wrapping_sub(val) << 16 as libc::c_int
                            | (n.wrapping_sub(1 as libc::c_int as uint32_t) as uint64_t)
                                .wrapping_sub(val) << 10 as libc::c_int) as libc::c_uint,
                    );
                } else {
                    o(
                        (((0x13000000 as libc::c_int
                            | ((op == 0x8b as libc::c_int) as libc::c_int)
                                << 30 as libc::c_int) as uint32_t | l << 31 as libc::c_int
                            | l << 22 as libc::c_int | x | a << 5 as libc::c_int)
                            as uint64_t | val << 16 as libc::c_int
                            | (n.wrapping_sub(1 as libc::c_int as uint32_t)
                                << 10 as libc::c_int) as uint64_t) as libc::c_uint,
                    );
                }
                return 1 as libc::c_int;
            }
        ...
        let mut e: libc::c_int = arm64_encode_bimm64(
            if l != 0 { val } else { val | val << 32 as libc::c_int },
        );
        if e < 0 as libc::c_int {
            return 0 as libc::c_int;
        }
        o(
            (if op == '&' as i32 {
                0x12000000 as libc::c_int
            } else {
                (if op == '|' as i32 {
                    0x32000000 as libc::c_int
                } else {
                    0x52000000 as libc::c_int
                })
            }) as uint32_t | l << 31 as libc::c_int | x | a << 5 as libc::c_int
                | (e as uint32_t) << 10 as libc::c_int,
        );
        return 1 as libc::c_int;
    }
...
unsafe extern "C" fn arm64_gen_opil(mut op: libc::c_int, mut l: uint32_t) {
    let mut x: uint32_t = 0;
    let mut a: uint32_t = 0;
    let mut b: uint32_t = 0;
    let mut val: uint64_t = 0;
    let mut rev: libc::c_int = 1 as libc::c_int;
    if arm64_iconst(0 as *mut uint64_t, &mut *vtop.offset(0 as libc::c_int as isize))
        != 0
    {
        vswap();
        rev = 0 as libc::c_int;
    }
    if arm64_iconst(&mut val, &mut *vtop.offset(-(1 as libc::c_int) as isize)) != 0 {
        gv(0x1 as libc::c_int);
        a = intr((*vtop.offset(0 as libc::c_int as isize)).r as libc::c_int);
        vtop = vtop.offset(-1);
        vtop;
        x = get_reg(0x1 as libc::c_int) as uint32_t;
        vtop = vtop.offset(1);
        vtop;
        if arm64_gen_opic(op, l, rev, val, intr(x as libc::c_int), a) != 0 {
            (*vtop.offset(0 as libc::c_int as isize)).r = x as libc::c_ushort;
            vswap();
            vtop = vtop.offset(-1);
            vtop;
            return;
    ...
    {} else {
        __assert_fail(
            b"vtop[-1].r < VT_CONST && vtop[0].r < VT_CONST\0" as *const u8
                as *const libc::c_char,
            b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                as *const u8 as *const libc::c_char,
            ...
            (*::core::mem::transmute::<
                &[u8; 35],
                &[libc::c_char; 35],
            >(b"void arm64_gen_opil(int, uint32_t)\0"))
                .as_ptr(),
        );
    }
    'c_12517: {
    ...
    a = intr((*vtop.offset(-(1 as libc::c_int) as isize)).r as libc::c_int);
    b = intr((*vtop.offset(0 as libc::c_int as isize)).r as libc::c_int);
    vtop = vtop.offset(-(2 as libc::c_int as isize));
    x = get_reg(0x1 as libc::c_int) as uint32_t;
    vtop = vtop.offset(1);
    vtop;
    (*vtop.offset(0 as libc::c_int as isize)).r = x as libc::c_ushort;
    x = intr(x as libc::c_int);
    match op {
        37 => {
            o(
                0x1ac00c00 as libc::c_int as uint32_t | l << 31 as libc::c_int
                    | 30 as libc::c_int as uint32_t | a << 5 as libc::c_int
                    | b << 16 as libc::c_int,
            );
            o(
                0x1b008000 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | (30 as libc::c_int as uint32_t) << 5 as libc::c_int
                    | b << 16 as libc::c_int | a << 10 as libc::c_int,
            );
        }
        38 => {
            o(
                0xa000000 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        42 => {
            o(
                0x1b007c00 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        43 => {
            o(
                0xb000000 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        45 => {
            o(
                0x4b000000 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        47 => {
            o(
                0x1ac00c00 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        94 => {
            o(
                0x4a000000 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        124 => {
            o(
                0x2a000000 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        148 => {
            o(
                0x6b00001f as libc::c_int as uint32_t | l << 31 as libc::c_int
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
            o(0x1a9f17e0 as libc::c_int as uint32_t | x);
        }
        157 => {
            o(
                0x6b00001f as libc::c_int as uint32_t | l << 31 as libc::c_int
            ...
            o(0x1a9fb7e0 as libc::c_int as uint32_t | x);
        }
        159 => {
            o(
                0x6b00001f as libc::c_int as uint32_t | l << 31 as libc::c_int
            ...
            o(0x1a9fd7e0 as libc::c_int as uint32_t | x);
        }
        158 => {
            o(
                0x6b00001f as libc::c_int as uint32_t | l << 31 as libc::c_int
            ...
            o(0x1a9fc7e0 as libc::c_int as uint32_t | x);
        }
        156 => {
            o(
                0x6b00001f as libc::c_int as uint32_t | l << 31 as libc::c_int
            ...
            o(0x1a9fa7e0 as libc::c_int as uint32_t | x);
        }
        149 => {
            o(
                0x6b00001f as libc::c_int as uint32_t | l << 31 as libc::c_int
            ...
            o(0x1a9f07e0 as libc::c_int as uint32_t | x);
        }
        62 => {
            o(
                0x1ac02800 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        60 => {
            o(
                0x1ac02000 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        139 => {
            o(
                0x1ac02400 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        131 | 133 => {
            o(
                0x1ac00800 as libc::c_int as uint32_t | l << 31 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        147 => {
            ...
            o(0x1a9f37e0 as libc::c_int as uint32_t | x);
        }
        151 => {
            o(
                0x6b00001f as libc::c_int as uint32_t | l << 31 as libc::c_int
            ...
            o(0x1a9f97e0 as libc::c_int as uint32_t | x);
        }
        146 => {
            o(
                0x6b00001f as libc::c_int as uint32_t | l << 31 as libc::c_int
            ...
            o(0x1a9f27e0 as libc::c_int as uint32_t | x);
        }
        150 => {
            o(
                0x6b00001f as libc::c_int as uint32_t | l << 31 as libc::c_int
            ...
            o(0x1a9f87e0 as libc::c_int as uint32_t | x);
        }
        132 => {
            o(
                0x1ac00800 as libc::c_int as uint32_t | l << 31 as libc::c_int
                    | 30 as libc::c_int as uint32_t | a << 5 as libc::c_int
                    | b << 16 as libc::c_int,
            );
            o(
...
pub unsafe extern "C" fn gen_opi(mut op: libc::c_int) {
    arm64_gen_opil(op, 0 as libc::c_int as uint32_t);
    arm64_vset_VT_CMP(op);
}
#[no_mangle]
pub unsafe extern "C" fn gen_opl(mut op: libc::c_int) {
    arm64_gen_opil(op, 1 as libc::c_int as uint32_t);
    arm64_vset_VT_CMP(op);
}
#[no_mangle]
pub unsafe extern "C" fn gen_opf(mut op: libc::c_int) {
    ...
    let mut a: uint32_t = 0;
    let mut b: uint32_t = 0;
    let mut dbl: uint32_t = 0;
    if (*vtop.offset(0 as libc::c_int as isize)).type_0.t == 10 as libc::c_int {
        let mut type_0: CType = (*vtop.offset(0 as libc::c_int as isize)).type_0;
        ...
        match op {
            ...
            156 => {
                cond = 10 as libc::c_int;
            }
            157 => {
                cond = 11 as libc::c_int;
            }
            158 => {
                cond = 12 as libc::c_int;
            }
            159 => {
                cond = 13 as libc::c_int;
            }
            _ => {
                __assert_fail(
                    b"0\0" as *const u8 as *const libc::c_char,
        ...
        if cond < 0 as libc::c_int {
            ...
            o(0x7100001f as libc::c_int as libc::c_uint);
            o(
                0x1a9f07e0 as libc::c_int as uint32_t
                    | (cond as uint32_t) << 12 as libc::c_int,
            );
        }
        return;
    }
    dbl = ((*vtop.offset(0 as libc::c_int as isize)).type_0.t != 8 as libc::c_int)
        as libc::c_int as uint32_t;
    ...
    a = fltr((*vtop.offset(-(1 as libc::c_int) as isize)).r as libc::c_int);
    b = fltr((*vtop.offset(0 as libc::c_int as isize)).r as libc::c_int);
    vtop = vtop.offset(-(2 as libc::c_int as isize));
    match op {
        148 | 149 | 156 | 157 | 158 | 159 => {
            x = get_reg(0x1 as libc::c_int) as uint32_t;
            vtop = vtop.offset(1);
            vtop;
            (*vtop.offset(0 as libc::c_int as isize)).r = x as libc::c_ushort;
        ...
        _ => {
            x = get_reg(0x2 as libc::c_int) as uint32_t;
            vtop = vtop.offset(1);
            vtop;
            (*vtop.offset(0 as libc::c_int as isize)).r = x as libc::c_ushort;
            x = fltr(x as libc::c_int);
        }
    }
    match op {
        42 => {
            o(
                0x1e200800 as libc::c_int as uint32_t | dbl << 22 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        43 => {
            o(
                0x1e202800 as libc::c_int as uint32_t | dbl << 22 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        45 => {
            o(
                0x1e203800 as libc::c_int as uint32_t | dbl << 22 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        47 => {
            o(
                0x1e201800 as libc::c_int as uint32_t | dbl << 22 as libc::c_int | x
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
        }
        148 => {
            o(
                0x1e202000 as libc::c_int as uint32_t | dbl << 22 as libc::c_int
                    | a << 5 as libc::c_int | b << 16 as libc::c_int,
            );
            o(0x1a9f17e0 as libc::c_int as uint32_t | x);
        }
        ...
        156 => {
            ...
            o(0x1a9f57e0 as libc::c_int as uint32_t | x);
        }
        149 => {
            o(
                0x1e202000 as libc::c_int as uint32_t | dbl << 22 as libc::c_int
        ...
        _ => {
            __assert_fail(
                ...
                b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                    as *const u8 as *const libc::c_char,
                1934 as libc::c_int as libc::c_uint,
                (*::core::mem::transmute::<
                    &[u8; 18],
                    &[libc::c_char; 18],
                >(b"void gen_opf(int)\0"))
...
pub unsafe extern "C" fn gen_cvt_sxtw() {
    let mut r: uint32_t = intr(gv(0x1 as libc::c_int));
    o(0x93407c00 as libc::c_uint | r | r << 5 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn gen_cvt_csti(mut t: libc::c_int) {
    let mut r: libc::c_int = intr(gv(0x1 as libc::c_int)) as libc::c_int;
    o(
        (0x13001c00 as libc::c_int
            | ((t & 0xf as libc::c_int == 2 as libc::c_int) as libc::c_int)
                << 13 as libc::c_int) as uint32_t
            | ((t & 0x10 as libc::c_int != 0) as libc::c_int as uint32_t)
                << 30 as libc::c_int | r as uint32_t
            | (r << 5 as libc::c_int) as uint32_t,
    );
}
#[no_mangle]
pub unsafe extern "C" fn gen_cvt_itof(mut t: libc::c_int) {
    if t == 10 as libc::c_int {
        let mut f: libc::c_int = (*vtop).type_0.t;
        ...
        let mut n: libc::c_int = intr(gv(0x1 as libc::c_int)) as libc::c_int;
        let mut s: libc::c_int = ((*vtop).type_0.t & 0x10 as libc::c_int == 0)
            as libc::c_int;
        let mut l: uint32_t = ((*vtop).type_0.t & 0xf as libc::c_int == 4 as libc::c_int)
            as libc::c_int as uint32_t;
        vtop = vtop.offset(-1);
        vtop;
        d = get_reg(0x2 as libc::c_int);
        vtop = vtop.offset(1);
        vtop;
        (*vtop.offset(0 as libc::c_int as isize)).r = d as libc::c_ushort;
        o(
            0x1e220000 as libc::c_int as uint32_t
                | ((s == 0) as libc::c_int as uint32_t) << 16 as libc::c_int
                | ((t != 8 as libc::c_int) as libc::c_int as uint32_t)
                    << 22 as libc::c_int | fltr(d) | l << 31 as libc::c_int
                | (n << 5 as libc::c_int) as uint32_t,
        );
    };
}
#[no_mangle]
pub unsafe extern "C" fn gen_cvt_ftoi(mut t: libc::c_int) {
    if (*vtop).type_0.t & 0xf as libc::c_int == 10 as libc::c_int {
        ...
        let mut d: libc::c_int = 0;
        let mut n: libc::c_int = fltr(gv(0x2 as libc::c_int)) as libc::c_int;
        let mut l: uint32_t = ((*vtop).type_0.t & 0xf as libc::c_int != 8 as libc::c_int)
            as libc::c_int as uint32_t;
        vtop = vtop.offset(-1);
        vtop;
        ...
        (*vtop.offset(0 as libc::c_int as isize)).r = d as libc::c_ushort;
        o(
            0x1e380000 as libc::c_int as uint32_t
                | ((t & 0x10 as libc::c_int != 0) as libc::c_int as uint32_t)
                    << 16 as libc::c_int
                | ((t & 0xf as libc::c_int == 4 as libc::c_int) as libc::c_int
                    as uint32_t) << 31 as libc::c_int | intr(d) | l << 22 as libc::c_int
                | (n << 5 as libc::c_int) as uint32_t,
        );
    };
}
...
pub unsafe extern "C" fn gen_cvt_ftof(mut t: libc::c_int) {
    let mut f: libc::c_int = (*vtop.offset(0 as libc::c_int as isize)).type_0.t
        & 0xf as libc::c_int;
    if t == 8 as libc::c_int || t == 9 as libc::c_int || t == 10 as libc::c_int {} else {
        __assert_fail(
            b"t == VT_FLOAT || t == VT_DOUBLE || t == VT_LDOUBLE\0" as *const u8
                as *const libc::c_char,
            b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                as *const u8 as *const libc::c_char,
    ...
    'c_23811: {
        if t == 8 as libc::c_int || t == 9 as libc::c_int || t == 10 as libc::c_int
        {} else {
            __assert_fail(
                b"t == VT_FLOAT || t == VT_DOUBLE || t == VT_LDOUBLE\0" as *const u8
                    as *const libc::c_char,
    ...
    if f == 8 as libc::c_int || f == 9 as libc::c_int || f == 10 as libc::c_int {} else {
        __assert_fail(
            b"f == VT_FLOAT || f == VT_DOUBLE || f == VT_LDOUBLE\0" as *const u8
                as *const libc::c_char,
            b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                as *const u8 as *const libc::c_char,
    ...
    'c_23754: {
        if f == 8 as libc::c_int || f == 9 as libc::c_int || f == 10 as libc::c_int
        {} else {
            __assert_fail(
                b"f == VT_FLOAT || f == VT_DOUBLE || f == VT_LDOUBLE\0" as *const u8
                    as *const libc::c_char,
    ...
    if t == 10 as libc::c_int || f == 10 as libc::c_int {
        let mut func: libc::c_int = 0;
        vpush_helper_func(func);
        vrott(2 as libc::c_int);
        gfunc_call(1 as libc::c_int);
        ...
        {} else {
            __assert_fail(
                b"vtop[0].r < VT_CONST\0" as *const u8 as *const libc::c_char,
                b"/mnt/c/Users/mazin/Downloads/School/Research/datasets/tinycc/arm64-gen.c\0"
                    as *const u8 as *const libc::c_char,
        ...
        a = fltr((*vtop.offset(0 as libc::c_int as isize)).r as libc::c_int)
            as libc::c_int;
        vtop = vtop.offset(-1);
        vtop;
        x = get_reg(0x2 as libc::c_int);
        vtop = vtop.offset(1);
        vtop;
        (*vtop.offset(0 as libc::c_int as isize)).r = x as libc::c_ushort;
        x = fltr(x) as libc::c_int;
        if f == 8 as libc::c_int {
            o((0x1e22c000 as libc::c_int | x | a << 5 as libc::c_int) as libc::c_uint);
        } else {
            o((0x1e624000 as libc::c_int | x | a << 5 as libc::c_int) as libc::c_uint);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn gen_increment_tcov(mut sv: *mut SValue) {
    ...
    o(0x90000000 as libc::c_uint | r1 as libc::c_uint);
    greloca(
        (*tcc_state).cur_text_section,
        (*sv).c2rust_unnamed_0.sym,
        ind as libc::c_ulong,
    ...
    o(
        0xf9400000 as libc::c_uint | r1 as libc::c_uint
            | (r1 << 5 as libc::c_int) as libc::c_uint,
    );
    o(0xf9400000 as libc::c_uint | intr(r1) << 5 as libc::c_int | intr(r2));
    o(0x91000400 as libc::c_uint | intr(r2) << 5 as libc::c_int | intr(r2));
    o(0xf9000000 as libc::c_uint | intr(r1) << 5 as libc::c_int | intr(r2));
    vpop();
}
#[no_mangle]
pub unsafe extern "C" fn ggoto() {
    arm64_gen_bl_or_b(1 as libc::c_int);
    vtop = vtop.offset(-1);
    vtop;
}
#[no_mangle]
pub unsafe extern "C" fn gen_clear_cache() {
    let mut beg: uint32_t = 0;
    let mut end: uint32_t = 0;
    let mut dsz: uint32_t = 0;
    let mut isz: uint32_t = 0;
    let mut p: uint32_t = 0;
    let mut lab1: uint32_t = 0;
    let mut b1: uint32_t = 0;
    gv2(0x1 as libc::c_int, 0x1 as libc::c_int);
    vpushi(0 as libc::c_int);
    (*vtop).r = get_reg(0x1 as libc::c_int) as libc::c_ushort;
    vpushi(0 as libc::c_int);
    (*vtop).r = get_reg(0x1 as libc::c_int) as libc::c_ushort;
    vpushi(0 as libc::c_int);
    (*vtop).r = get_reg(0x1 as libc::c_int) as libc::c_ushort;
    beg = intr((*vtop.offset(-(4 as libc::c_int) as isize)).r as libc::c_int);
    end = intr((*vtop.offset(-(3 as libc::c_int) as isize)).r as libc::c_int);
    dsz = intr((*vtop.offset(-(2 as libc::c_int) as isize)).r as libc::c_int);
    isz = intr((*vtop.offset(-(1 as libc::c_int) as isize)).r as libc::c_int);
    p = intr((*vtop.offset(0 as libc::c_int as isize)).r as libc::c_int);
    vtop = vtop.offset(-(5 as libc::c_int as isize));
    o(0xd53b0020 as libc::c_uint | isz);
    o(0x52800080 as libc::c_int as uint32_t | p);
    o(0x53104c00 as libc::c_int as uint32_t | dsz | isz << 5 as libc::c_int);
    o(
        0x1ac02000 as libc::c_int as uint32_t | dsz | p << 5 as libc::c_int
            | dsz << 16 as libc::c_int,
    );
    o(0x12000c00 as libc::c_int as uint32_t | isz | isz << 5 as libc::c_int);
    o(
        0x1ac02000 as libc::c_int as uint32_t | isz | p << 5 as libc::c_int
            | isz << 16 as libc::c_int,
    );
    o(0x51000400 as libc::c_int as uint32_t | p | dsz << 5 as libc::c_int);
    o(0x8a240004 as libc::c_uint | p | beg << 5 as libc::c_int | p << 16 as libc::c_int);
    b1 = ind as uint32_t;
    o(0x14000000 as libc::c_int as libc::c_uint);
    lab1 = ind as uint32_t;
    o(0xd50b7b20 as libc::c_uint | p);
    o(0x8b000000 as libc::c_uint | p | p << 5 as libc::c_int | dsz << 16 as libc::c_int);
    write32le(
        ((*(*tcc_state).cur_text_section).data).offset(b1 as isize),
        0x14000000 as libc::c_int as uint32_t
            | (ind as uint32_t).wrapping_sub(b1) >> 2 as libc::c_int,
    );
    o(0xeb00001f as libc::c_uint | p << 5 as libc::c_int | end << 16 as libc::c_int);
    o(
        0x54ffffa3 as libc::c_int as uint32_t
            | lab1.wrapping_sub(ind as uint32_t) << 3 as libc::c_int
                & 0xffffe0 as libc::c_int as uint32_t,
    );
    o(0xd5033b9f as libc::c_uint);
    o(0x51000400 as libc::c_int as uint32_t | p | isz << 5 as libc::c_int);
    o(0x8a240004 as libc::c_uint | p | beg << 5 as libc::c_int | p << 16 as libc::c_int);
    b1 = ind as uint32_t;
    o(0x14000000 as libc::c_int as libc::c_uint);
    lab1 = ind as uint32_t;
    o(0xd50b7520 as libc::c_uint | p);
    o(0x8b000000 as libc::c_uint | p | p << 5 as libc::c_int | isz << 16 as libc::c_int);
    write32le(
        ((*(*tcc_state).cur_text_section).data).offset(b1 as isize),
        0x14000000 as libc::c_int as uint32_t
            | (ind as uint32_t).wrapping_sub(b1) >> 2 as libc::c_int,
    ...
    o(0xd5033b9f as libc::c_uint);
    o(0xd5033fdf as libc::c_uint);
}
#[no_mangle]
pub unsafe extern "C" fn gen_vla_sp_save(mut addr: libc::c_int) {
    let mut r: uint32_t = intr(get_reg(0x1 as libc::c_int));
    o(0x910003e0 as libc::c_uint | r);
    arm64_strx(3 as libc::c_int, r as libc::c_int, 29 as libc::c_int, addr as uint64_t);
}
#[no_mangle]
pub unsafe extern "C" fn gen_vla_sp_restore(mut addr: libc::c_int) {
    let mut r: uint32_t = 30 as libc::c_int as uint32_t;
    arm64_ldrx(
        0 as libc::c_int,
        3 as libc::c_int,
        r as libc::c_int,
    ...
    o(0x9100001f as libc::c_uint | r << 5 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn gen_vla_alloc(mut type_0: *mut CType, mut align: libc::c_int) {
    ...
    r = intr(gv(0x1 as libc::c_int));
    if (*tcc_state).do_bounds_check != 0 {
        o(0x91004000 as libc::c_uint | r | r << 5 as libc::c_int);
    } else {
        o(0x91003c00 as libc::c_uint | r | r << 5 as libc::c_int);
    }
    o(0x927cec00 as libc::c_uint | r | r << 5 as libc::c_int);
    o(0xcb2063ff as libc::c_uint | r << 16 as libc::c_int);
    vpop();
    if (*tcc_state).do_bounds_check != 0 {
        vpushi(0 as libc::c_int);
        (*vtop).r = TREG_R(0 as libc::c_int) as libc::c_ushort;
        o(0x910003e0 as libc::c_uint | (*vtop).r as libc::c_uint);
        vswap();
...
unsafe extern "C" fn run_static_initializers() {
    reg_classes = [
        ...
        0x1 as libc::c_int | RC_R(8 as libc::c_int),
        0x1 as libc::c_int | RC_R(9 as libc::c_int),
        0x1 as libc::c_int | RC_R(10 as libc::c_int),
        0x1 as libc::c_int | RC_R(11 as libc::c_int),
        0x1 as libc::c_int | RC_R(12 as libc::c_int),
        0x1 as libc::c_int | RC_R(13 as libc::c_int),
        0x1 as libc::c_int | RC_R(14 as libc::c_int),
        0x1 as libc::c_int | RC_R(15 as libc::c_int),
        0x1 as libc::c_int | RC_R(16 as libc::c_int),
        0x1 as libc::c_int | RC_R(17 as libc::c_int),
        0x1 as libc::c_int | RC_R(18 as libc::c_int),
        ::core::mem::transmute::<

...
pub static mut cmd_kill_session_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"kill-session\0" as *const u8 as *const libc::c_char,
            alias: 0 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"aCt:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-aC] [-t target-session]\0" as *const u8 as *const libc::c_char,

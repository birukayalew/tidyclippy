...
#[no_mangle]
pub unsafe extern "C" fn ti_pbands_start(
...
#[no_mangle]
pub unsafe extern "C" fn ti_pbands(
    mut size: libc::c_int,
    ...
    let period: libc::c_int = *options.offset(0 as libc::c_int as isize) as libc::c_int;
    let mut pbands_lower: *mut libc::c_double = *outputs
        .offset(0 as libc::c_int as isize);
    let mut pbands_upper: *mut libc::c_double = *outputs
        .offset(1 as libc::c_int as isize);
    if period < 1 as libc::c_int {
        return 1 as libc::c_int;
    }
    if size <= ti_pbands_start(options) {
    ...
    let fresh0 = pbands_upper;
    pbands_upper = pbands_upper.offset(1);
    *fresh0 = the_max;
    let fresh1 = pbands_lower;
    pbands_lower = pbands_lower.offset(1);
    *fresh1 = the_min;
    i += 1;
    i;
    while i < size {
        ...
        let fresh2 = pbands_upper;
        pbands_upper = pbands_upper.offset(1);
        *fresh2 = the_max_0;
        let fresh3 = pbands_lower;
        pbands_lower = pbands_lower.offset(1);
        *fresh3 = the_min_0;
        i += 1;
        i;
...
#[no_mangle]
pub unsafe extern "C" fn ti_pbands_ref(
    mut size: libc::c_int,
    mut inputs: *const *const libc::c_double,
    mut options: *const libc::c_double,
    mut outputs: *const *mut libc::c_double,
    ...
    while i < size {
        ...
        let fresh4 = pbands_upper;
        pbands_upper = pbands_upper.offset(1);
        *fresh4 = the_max;
        let fresh5 = pbands_lower;
        pbands_lower = pbands_lower.offset(1);
        *fresh5 = the_min;
        i += 1;
        i;
...
#[no_mangle]
pub unsafe extern "C" fn ti_pbands_stream_free(mut stream: *mut ti_stream) {
    free(stream as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn ti_pbands_stream_run(
    mut stream_in: *mut ti_stream,
    mut size: libc::c_int,
    mut inputs: *const *const libc::c_double,
    mut outputs: *const *mut libc::c_double,
) -> libc::c_int {
    let mut stream: *mut ti_stream_pbands = stream_in as *mut ti_stream_pbands;
    let mut high: *const libc::c_double = *inputs.offset(0 as libc::c_int as isize);
    let mut low: *const libc::c_double = *inputs.offset(1 as libc::c_int as isize);
    let mut close: *const libc::c_double = *inputs.offset(2 as libc::c_int as isize);
    let mut pbands_lower: *mut libc::c_double = *outputs
    ...
    let period: libc::c_int = (*stream).options.period as libc::c_int;
    ...
    if i > 0 as libc::c_int && progress == 1 as libc::c_int {
        ...
        let fresh6 = pbands_upper;
        pbands_upper = pbands_upper.offset(1);
        *fresh6 = the_max;
        let fresh7 = pbands_lower;
        pbands_lower = pbands_lower.offset(1);
        *fresh7 = the_min;
        progress += 1;
        progress;
    ...
    while i < size {
        ...
        *((&mut (*stream).buf_info as *mut C2RustUnnamed)
        ...
        let fresh8 = pbands_upper;
        pbands_upper = pbands_upper.offset(1);
        *fresh8 = the_max_0;
        let fresh9 = pbands_lower;
        pbands_lower = pbands_lower.offset(1);
        *fresh9 = the_min_0;
        i += 1;
        i;

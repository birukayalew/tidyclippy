...
pub unsafe extern "C" fn zand(mut a: *mut zahl, mut b: *mut zahl, mut c: *mut zahl) {
    ...
    || ((zzero(c) != 0) as libc::c_int as libc::c_long != 0) {
    ...
    if a == b {
        ...
        while i__ < n__ {
            *a__
                .offset(
                    i__.wrapping_add(0 as libc::c_int as size_t) as isize,
                ) = *b__.offset(i__.wrapping_add(0 as libc::c_int as size_t) as isize)
                & *c__.offset(i__.wrapping_add(0 as libc::c_int as size_t) as isize);
            *a__
                .offset(
                    i__.wrapping_add(1 as libc::c_int as size_t) as isize,
                ) = *b__.offset(i__.wrapping_add(1 as libc::c_int as size_t) as isize)
                & *c__.offset(i__.wrapping_add(1 as libc::c_int as size_t) as isize);
            *a__
                .offset(
                    i__.wrapping_add(2 as libc::c_int as size_t) as isize,
                ) = *b__.offset(i__.wrapping_add(2 as libc::c_int as size_t) as isize)
                & *c__.offset(i__.wrapping_add(2 as libc::c_int as size_t) as isize);
            *a__
                .offset(
                    i__.wrapping_add(3 as libc::c_int as size_t) as isize,
                ) = *b__.offset(i__.wrapping_add(3 as libc::c_int as size_t) as isize)
                & *c__.offset(i__.wrapping_add(3 as libc::c_int as size_t) as isize);
        ...
        while i___0 < n___0 {
            *a___0
                .offset(
                    i___0.wrapping_add(0 as libc::c_int as size_t) as isize,
                ) = *b___0
                .offset(i___0.wrapping_add(0 as libc::c_int as size_t) as isize)
                & *c___0.offset(i___0.wrapping_add(0 as libc::c_int as size_t) as isize);
            *a___0
                .offset(
                    i___0.wrapping_add(1 as libc::c_int as size_t) as isize,
                ) = *b___0
                .offset(i___0.wrapping_add(1 as libc::c_int as size_t) as isize)
                & *c___0.offset(i___0.wrapping_add(1 as libc::c_int as size_t) as isize);
            *a___0
                .offset(
                    i___0.wrapping_add(2 as libc::c_int as size_t) as isize,
                ) = *b___0
                .offset(i___0.wrapping_add(2 as libc::c_int as size_t) as isize)
                & *c___0.offset(i___0.wrapping_add(2 as libc::c_int as size_t) as isize);
            *a___0
                .offset(
                    i___0.wrapping_add(3 as libc::c_int as size_t) as isize,
                ) = *b___0
                .offset(i___0.wrapping_add(3 as libc::c_int as size_t) as isize)
                & *c___0.offset(i___0.wrapping_add(3 as libc::c_int as size_t) as isize);

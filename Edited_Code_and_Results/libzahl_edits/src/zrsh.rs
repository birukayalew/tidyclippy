...
unsafe extern "C" fn libzahl_memmovef(
    ...
    if n != 0 && n < 4 as libc::c_int as size_t {
        ...
        *d.offset(2 as libc::c_int as isize) = *s.offset(2 as libc::c_int as isize);
        ...
        while i < n {
            *d
                .offset(
                    i.wrapping_add(0 as libc::c_int as size_t) as isize,
                ) = *s.offset(i.wrapping_add(0 as libc::c_int as size_t) as isize);
            *d
                .offset(
                    i.wrapping_add(1 as libc::c_int as size_t) as isize,
                ) = *s.offset(i.wrapping_add(1 as libc::c_int as size_t) as isize);
            *d
                .offset(
                    i.wrapping_add(2 as libc::c_int as size_t) as isize,
                ) = *s.offset(i.wrapping_add(2 as libc::c_int as size_t) as isize);
            *d
                .offset(
                    i.wrapping_add(3 as libc::c_int as size_t) as isize,
                ) = *s.offset(i.wrapping_add(3 as libc::c_int as size_t) as isize);

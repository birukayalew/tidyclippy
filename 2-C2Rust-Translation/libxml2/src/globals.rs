...
#[no_mangle]
pub static mut xmlParserVersion: *const libc::c_char = b"20908\0" as *const u8
...
pub unsafe extern "C" fn xmlInitializeGlobalState(mut gs: xmlGlobalStatePtr) {
    ...
    (*gs)
        .xmlFree = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(*mut libc::c_void) -> ()>,
        xmlFreeFunc,
    >(Some(free as unsafe extern "C" fn(*mut libc::c_void) -> ()));
    (*gs)
        .xmlMalloc = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(libc::c_ulong) -> *mut libc::c_void>,
        xmlMallocFunc,
    >(Some(malloc as unsafe extern "C" fn(libc::c_ulong) -> *mut libc::c_void));
    (*gs)
        .xmlMallocAtomic = ::core::mem::transmute::<
        Option::<unsafe extern "C" fn(libc::c_ulong) -> *mut libc::c_void>,
        xmlMallocFunc,
    >(Some(malloc as unsafe extern "C" fn(libc::c_ulong) -> *mut libc::c_void));
    (*gs)
        .xmlRealloc = ::core::mem::transmute::<
        Option::<
    ...
    (*gs)
        .xmlMemStrdup = ::core::mem::transmute::<
    ...
    (*gs).xmlParserVersion = b"20908\0" as *const u8 as *const libc::c_char;
    ...
    (*gs)
        .xmlParserInputBufferCreateFilenameValue = xmlParserInputBufferCreateFilenameValueThrDef;

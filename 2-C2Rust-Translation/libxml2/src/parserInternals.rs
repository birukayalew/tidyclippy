...
pub unsafe extern "C" fn xmlCheckVersion(mut version: libc::c_int) {
    let mut myversion: libc::c_int = 20908 as libc::c_int;
    xmlInitParser();
...
pub unsafe extern "C" fn xmlParserInputShrink(mut in_0: xmlParserInputPtr) {
    ...
    if used > 250 as libc::c_int as size_t {
        ret = xmlBufShrink(
            (*(*in_0).buf).buffer,
            used.wrapping_sub(80 as libc::c_int as size_t),
        );
        if ret > 0 as libc::c_int as size_t {
            (*in_0).cur = ((*in_0).cur).offset(-(ret as isize));
            (*in_0).consumed = ((*in_0).consumed).wrapping_add(ret);
        }
        (*in_0).end = xmlBufEnd((*(*in_0).buf).buffer);
    }
    if xmlBufUse((*(*in_0).buf).buffer) > 250 as libc::c_int as size_t {
        return;
    }
    ...
    if (*ctxt).charset == XML_CHAR_ENCODING_UTF8 as libc::c_int {
        ...
        if c as libc::c_int & 0x80 as libc::c_int != 0 {
            if c as libc::c_int == 0xc0 as libc::c_int {
                current_block = 1143056534217965449;
            } else {
                    ...
                    & 0xc0 as libc::c_int != 0x80 as libc::c_int)
                {
                    if c as libc::c_int & 0xe0 as libc::c_int == 0xe0 as libc::c_int {
                        ...
                        if *cur.offset(2 as libc::c_int as isize) as libc::c_int
                            & 0xc0 as libc::c_int != 0x80 as libc::c_int
                        {
                            current_block = 15719398691947399150;
                ...
                & 0xc0 as libc::c_int != 0x80 as libc::c_int)
            {
                if c as libc::c_int & 0xe0 as libc::c_int == 0xe0 as libc::c_int {
                    if *cur.offset(2 as libc::c_int as isize) as libc::c_int
                        & 0xc0 as libc::c_int != 0x80 as libc::c_int
                    {
                        current_block = 1812979488672820160;
                    } else if c as libc::c_int & 0xf0 as libc::c_int
                        == 0xf0 as libc::c_int
                    {
...
pub unsafe extern "C" fn xmlCopyCharMultiByte(
    ...
    if val >= 0x80 as libc::c_int {
        ...
        while bits >= 0 as libc::c_int {
            let fresh3 = out;
            out = out.offset(1);
            *fresh3 = (val >> bits & 0x3f as libc::c_int | 0x80 as libc::c_int)
                as xmlChar;
            bits -= 6 as libc::c_int;
        }
        ...
        match enc as libc::c_int {
            ...
            4 => {
                __xmlErrEncoding(
                    ...
                    b"USC4 little endian\0" as *const u8 as *const libc::c_char
                        as *mut xmlChar,
                    0 as *const xmlChar,
                );
            }
            5 => {
                __xmlErrEncoding(
                    ...
                    XML_ERR_UNSUPPORTED_ENCODING,
                    b"encoding not supported %s\n\0" as *const u8 as *const libc::c_char,
                    b"USC4 big endian\0" as *const u8 as *const libc::c_char
                        as *mut xmlChar,
                    0 as *const xmlChar,
                );
            }
            6 => {
                __xmlErrEncoding(
                    ...
                    XML_ERR_UNSUPPORTED_ENCODING,
                    b"encoding not supported %s\n\0" as *const u8 as *const libc::c_char,
                    b"EBCDIC\0" as *const u8 as *const libc::c_char as *mut xmlChar,
                    0 as *const xmlChar,
                );
            }
            7 => {
                __xmlErrEncoding(
                    ...
                    XML_ERR_UNSUPPORTED_ENCODING,
                    b"encoding not supported %s\n\0" as *const u8 as *const libc::c_char,
                    b"UCS4 2143\0" as *const u8 as *const libc::c_char as *mut xmlChar,
                    0 as *const xmlChar,
                );
            }
            8 => {
                __xmlErrEncoding(
                    ...
                    XML_ERR_UNSUPPORTED_ENCODING,
                    b"encoding not supported %s\n\0" as *const u8 as *const libc::c_char,
                    b"UCS4 3412\0" as *const u8 as *const libc::c_char as *mut xmlChar,
                    0 as *const xmlChar,
                );
            }
            9 => {
                __xmlErrEncoding(
                    ...
                    XML_ERR_UNSUPPORTED_ENCODING,
                    b"encoding not supported %s\n\0" as *const u8 as *const libc::c_char,
                    b"UCS2\0" as *const u8 as *const libc::c_char as *mut xmlChar,
                    0 as *const xmlChar,
                );
            }
            ...
            19 => {
                __xmlErrEncoding(
                    ...
                    XML_ERR_UNSUPPORTED_ENCODING,
                    b"encoding not supported %s\n\0" as *const u8 as *const libc::c_char,
                    b"ISO-2022-JP\0" as *const u8 as *const libc::c_char as *mut xmlChar,
                    0 as *const xmlChar,
                );
            }
            20 => {
                __xmlErrEncoding(
                    ...
                    XML_ERR_UNSUPPORTED_ENCODING,
                    b"encoding not supported %s\n\0" as *const u8 as *const libc::c_char,
                    b"Shift_JIS\0" as *const u8 as *const libc::c_char as *mut xmlChar,
                    0 as *const xmlChar,
                );
            }
            21 => {
                __xmlErrEncoding(
                    ...
                    XML_ERR_UNSUPPORTED_ENCODING,
                    b"encoding not supported %s\n\0" as *const u8 as *const libc::c_char,
                    b"EUC-JP\0" as *const u8 as *const libc::c_char as *mut xmlChar,
                    0 as *const xmlChar,
                );
            }
            2 | 3 | _ => {}
...
unsafe extern "C" fn xmlSwitchInputEncodingInt(
    ...
    if !((*input).buf).is_null() {
        ...
        if xmlBufIsEmpty((*(*input).buf).buffer) == 0 as libc::c_int {
            ...
            (*(*input).buf)
                .rawconsumed = ((*(*input).buf).rawconsumed)
                .wrapping_add(
                    (use_0 as size_t).wrapping_sub(xmlBufUse((*(*input).buf).raw)),
                );
        }
        return 0 as libc::c_int;
    } else if (*input).length == 0 as libc::c_int {
        xmlErrInternal(
            ctxt,
...
pub unsafe extern "C" fn xmlNewInputStream(
    ...
    input = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlParserInput>() as libc::c_ulong)
...
pub unsafe extern "C" fn xmlNewEntityInputStream(
    ...
    if !((*entity).URI).is_null() {
        (*input)
            .filename = xmlStrdup((*entity).URI as *mut xmlChar) as *mut libc::c_char;
    }
    ...
    (*input)
        .end = &mut *((*entity).content).offset((*input).length as isize)
        as *mut xmlChar;
    return input;
}
#[no_mangle]
        ...
        && (*((*ctxt).node_seq.buffer).offset(pos as isize)).node == (*info).node
    {
        *((*ctxt).node_seq.buffer).offset(pos as isize) = *info;
            ...
            > (*ctxt).node_seq.maximum || ((*ctxt).node_seq.buffer).is_null()
        {
            ...
            byte_size = (::core::mem::size_of::<xmlParserNodeInfo>() as libc::c_ulong)
                .wrapping_mul(

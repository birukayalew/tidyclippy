    ...
    loop {
        ...
        if *in_0 as libc::c_int == '<' as i32 {
            ...
            *fresh33 = ';' as i32 as libc::c_uchar;
            ...
            || *in_0 as libc::c_int == '\n' as i32 || *in_0 as libc::c_int == '\t' as i32
        {
            let fresh34 = in_0;
            in_0 = in_0.offset(1);
            let fresh35 = out;
            ...
            *fresh35 = *fresh34;
            ...
            if (*in_0 as libc::c_int) < 0xc0 as libc::c_int {
                ...
                in_0 = in_0.offset(1);
                in_0;
                current_block = 9522391430464417605;
                break;
            } else {
...
unsafe extern "C" fn xmlNewSaveCtxt(
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlSaveCtxt>() as libc::c_ulong) as xmlSaveCtxtPtr;
    if ret.is_null() {
        xmlSaveErrMemory(
    ...
    memset(
        ...
        0 as libc::c_int,
        ::core::mem::size_of::<xmlSaveCtxt>() as libc::c_ulong,
    );
    if !encoding.is_null() {
...
unsafe extern "C" fn xmlAttrListDumpOutput(
    mut ctxt: xmlSaveCtxtPtr,
    mut cur: xmlAttrPtr,
) {
    if cur.is_null() {
...
unsafe extern "C" fn xmlNodeListDumpOutput(
    mut ctxt: xmlSaveCtxtPtr,
    mut cur: xmlNodePtr,
) {
    let mut buf: xmlOutputBufferPtr = 0 as *mut xmlOutputBuffer;
    ...
    buf = (*ctxt).buf;
    while !cur.is_null() {
        if (*ctxt).format == 1 as libc::c_int && *__xmlIndentTreeOutput() != 0
...
unsafe extern "C" fn xmlNodeDumpOutputInternal(
    ...
    buf = (*ctxt).buf;
    if (*cur).type_0 as libc::c_uint == XML_XINCLUDE_START as libc::c_int as libc::c_uint
    {
        return;
    }
    if (*cur).type_0 as libc::c_uint == XML_XINCLUDE_END as libc::c_int as libc::c_uint {
        return;
    }
    ...
    if (*cur).type_0 as libc::c_uint == XML_ELEMENT_DECL as libc::c_int as libc::c_uint {
        xmlBufDumpElementDecl((*buf).buffer, cur as xmlElementPtr);
        return;
    }
    if (*cur).type_0 as libc::c_uint == XML_ATTRIBUTE_DECL as libc::c_int as libc::c_uint
    {
    ...
    {
        if ((*cur).content).is_null() || *(*cur).content as libc::c_int == '\0' as i32 {
            xmlOutputBufferWrite(
                buf,
                12 as libc::c_int,
    ...
    if ((*cur).type_0 as libc::c_uint == XML_ELEMENT_NODE as libc::c_int as libc::c_uint
        ...
        && (*ctxt).options & XML_SAVE_NO_EMPTY as libc::c_int == 0 as libc::c_int
    {
        if (*ctxt).format == 2 as libc::c_int {
            xmlOutputBufferWriteWSNonSig(ctxt, 0 as libc::c_int);
        }
    ...
    if !((*cur).children).is_null() {
        ...
        if *__xmlIndentTreeOutput() != 0 && (*ctxt).format == 1 as libc::c_int {
            xmlOutputBufferWrite(
                buf,
                (*ctxt).indent_size
                    * (if (*ctxt).level > (*ctxt).indent_nr {
...
unsafe extern "C" fn xmlDocContentDumpOutput(
    ...
    } else if (*cur).charset != XML_CHAR_ENCODING_UTF8 as libc::c_int {
        encoding = xmlGetCharEncodingName((*cur).charset as xmlCharEncoding)
            as *const xmlChar;
    }
    if (*cur).type_0 as libc::c_uint
        == XML_HTML_DOCUMENT_NODE as libc::c_int as libc::c_uint
...
unsafe extern "C" fn xhtmlNodeListDumpOutput(
    mut ctxt: xmlSaveCtxtPtr,
    mut cur: xmlNodePtr,
) {
    let mut buf: xmlOutputBufferPtr = 0 as *mut xmlOutputBuffer;
...
unsafe extern "C" fn xhtmlNodeDumpOutput(mut ctxt: xmlSaveCtxtPtr, mut cur: xmlNodePtr) {
    let mut format: libc::c_int = 0;
    let mut addmeta: libc::c_int = 0 as libc::c_int;
    let mut tmp: xmlNodePtr = 0 as *mut xmlNode;
    let mut start: *mut xmlChar = 0 as *mut xmlChar;
    let mut end: *mut xmlChar = 0 as *mut xmlChar;
    let mut buf: xmlOutputBufferPtr = 0 as *mut xmlOutputBuffer;
    ...
    {
        if (((*cur).ns).is_null() || ((*(*cur).ns).prefix).is_null())
            && (xhtmlIsEmpty(cur) == 1 as libc::c_int && addmeta == 0 as libc::c_int)
        {
            xmlOutputBufferWrite(
                buf,
                3 as libc::c_int,
    ...
    if addmeta == 1 as libc::c_int {
        ...
        if !((*ctxt).encoding).is_null() {
            xmlOutputBufferWriteString(buf, (*ctxt).encoding as *const libc::c_char);
        } else {
            xmlOutputBufferWrite(
                buf,
                5 as libc::c_int,
    ...
    if !((*cur).children).is_null() {
        let mut indent: libc::c_int = (*ctxt).format;
        if format == 1 as libc::c_int {
            xmlOutputBufferWrite(
                buf,
                1 as libc::c_int,
        ...
        (*ctxt).format = indent;
        if *__xmlIndentTreeOutput() != 0 && format == 1 as libc::c_int {
            xmlOutputBufferWrite(
                buf,
                (*ctxt).indent_size
                    * (if (*ctxt).level > (*ctxt).indent_nr {
...
pub unsafe extern "C" fn xmlSaveToBuffer(
    ...
    if !encoding.is_null() {
        ...
        handler = 0 as xmlCharEncodingHandlerPtr;
    }
...
pub unsafe extern "C" fn xmlBufAttrSerializeTxtContent(
    ...
    while *cur as libc::c_int != 0 as libc::c_int {
        if *cur as libc::c_int == '\n' as i32 {
            ...
            && *cur.offset(1 as libc::c_int as isize) as libc::c_int != 0 as libc::c_int
...
pub unsafe extern "C" fn xmlNodeDump(
    ...
    ret = xmlBufNodeDump(buffer, doc, cur, level, format) as libc::c_int;
    xmlBufBackToBuffer(buffer);
...
pub unsafe extern "C" fn xmlNodeDumpOutput(
    ...
    let mut ctxt: xmlSaveCtxt = _xmlSaveCtxt {

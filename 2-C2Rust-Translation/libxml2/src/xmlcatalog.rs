    ...
    loop {
        ...
        if i == 0 as libc::c_int {
            ...
            memset(
                ...
                0 as libc::c_int,
                ::core::mem::size_of::<[*mut libc::c_char; 20]>() as libc::c_ulong,
            );
                ...
                ) == 0
            {
                ...
                ) == 0
                {
                    ...
                    } else if nbargs != 3 as libc::c_int && nbargs != 2 as libc::c_int {
                        printf(
                            b"add requires 2 or 3 arguments\n\0" as *const u8
                                as *const libc::c_char,
                        );
                            ...
                            ) == 0
                        {
                            ...
                            if no_super_update == 0 {
                                super_0 = xmlLoadSGMLSuperCatalog(
                                    b"/etc/sgml/catalog\0" as *const u8 as *const libc::c_char,
                                );
                                if super_0.is_null() {

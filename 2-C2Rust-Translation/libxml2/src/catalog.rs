...
unsafe extern "C" fn xmlNewCatalogEntry(
    ...
    ret = xmlMalloc
        ...
        )(::core::mem::size_of::<xmlCatalogEntry>() as libc::c_ulong)
...
unsafe extern "C" fn xmlCreateNewCatalog(
    ...
    ret = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlCatalog>() as libc::c_ulong) as xmlCatalogPtr;
    if ret.is_null() {
    ...
    memset(
        ...
        0 as libc::c_int,
        ::core::mem::size_of::<xmlCatalog>() as libc::c_ulong,
    );
    (*ret).type_0 = type_0;
    ...
    {
        (*ret).sgml = xmlHashCreate(10 as libc::c_int);
    }
    return ret;
}
#[no_mangle]
    ...
    while !cur.is_null() {
        if (*cur).group == cgroup {
            match (*cur).type_0 as libc::c_int {
                2 | 1 => {
                    current_block_49 = 491847596226624717;
                ...
                3 => {
                    current_block_49 = 13526798064656797086;
                    match current_block_49 {
                        491847596226624717 => {
                            if cur == catal {
                                cur = (*cur).children;
                ...
                4 => {
                    current_block_49 = 1835195504419306793;
                    match current_block_49 {
                        491847596226624717 => {
                            if cur == catal {
                                cur = (*cur).children;
                ...
                5 => {
                    current_block_49 = 1897675015960989267;
                    match current_block_49 {
                        491847596226624717 => {
                            if cur == catal {
                                cur = (*cur).children;
                ...
                6 => {
                    current_block_49 = 4116089576692000574;
                    match current_block_49 {
                        491847596226624717 => {
                            if cur == catal {
                                cur = (*cur).children;
                ...
                7 => {
                    current_block_49 = 702581807130710806;
                    match current_block_49 {
                        491847596226624717 => {
                            if cur == catal {
                                cur = (*cur).children;
                ...
                8 => {
                    current_block_49 = 15919043161921125625;
                    match current_block_49 {
                        491847596226624717 => {
                            if cur == catal {
                                cur = (*cur).children;
                ...
                9 => {
                    current_block_49 = 14220523932482161753;
                    match current_block_49 {
                        491847596226624717 => {
                            if cur == catal {
                                cur = (*cur).children;
                ...
                10 => {
                    current_block_49 = 1822579226956249074;
                    match current_block_49 {
                        491847596226624717 => {
                            if cur == catal {
                                cur = (*cur).children;
                ...
                11 => {
                    current_block_49 = 11501179246451496135;
                    match current_block_49 {
                        491847596226624717 => {
                            if cur == catal {
                                cur = (*cur).children;
                ...
                12 => {
                    current_block_49 = 10020721271032481955;
                    match current_block_49 {
                        491847596226624717 => {
                            if cur == catal {
                                cur = (*cur).children;
...
unsafe extern "C" fn xmlCatalogUnWrapURN(mut urn: *const xmlChar) -> *mut xmlChar {
    ...
    while *urn as libc::c_int != 0 as libc::c_int {
        if i as libc::c_ulong
            > (::core::mem::size_of::<[xmlChar; 2000]>() as libc::c_ulong)
        ...
        if *urn as libc::c_int == '+' as i32 {
                ...
                && *urn.offset(2 as libc::c_int as isize) as libc::c_int == 'B' as i32
            {
                ...
                && *urn.offset(2 as libc::c_int as isize) as libc::c_int == 'A' as i32
            {
                let fresh6 = i;
                i = i.wrapping_add(1);
                result[fresh6 as usize] = ':' as i32 as xmlChar;
            } else if *urn.offset(1 as libc::c_int as isize) as libc::c_int == '2' as i32
                && *urn.offset(2 as libc::c_int as isize) as libc::c_int == 'F' as i32
            {
                let fresh7 = i;
                i = i.wrapping_add(1);
                ...
                && *urn.offset(2 as libc::c_int as isize) as libc::c_int == 'B' as i32
            {
                ...
                && *urn.offset(2 as libc::c_int as isize) as libc::c_int == '7' as i32
            {
                let fresh9 = i;
                i = i.wrapping_add(1);
                ...
                && *urn.offset(2 as libc::c_int as isize) as libc::c_int == 'F' as i32
            {
                ...
                && *urn.offset(2 as libc::c_int as isize) as libc::c_int == '3' as i32
            {
                let fresh11 = i;
                i = i.wrapping_add(1);
                result[fresh11 as usize] = '#' as i32 as xmlChar;
            } else if *urn.offset(1 as libc::c_int as isize) as libc::c_int == '2' as i32
                && *urn.offset(2 as libc::c_int as isize) as libc::c_int == '5' as i32
            {
                let fresh12 = i;
                i = i.wrapping_add(1);
    ...
    while *p as libc::c_int != 0 as libc::c_int {
            ...
            || *p as libc::c_int == 0xd as libc::c_int
        {
            ...
            if white != 0 {
                let fresh15 = q;
                q = q.offset(1);
                *fresh15 = 0x20 as libc::c_int as xmlChar;
                white = 0 as libc::c_int;
            }
            let fresh16 = q;
            q = q.offset(1);
            ...
            if (*cur).type_0 as libc::c_int == XML_CATA_NEXT_CATALOG as libc::c_int {
                ...
                if !((*cur).children).is_null() {
                    ...
                    if !ret.is_null() {
                        ...
                        (*catal).depth;
                        return ret;
                    } else if (*catal).depth > 50 as libc::c_int {
                        return 0 as *mut xmlChar
                    }
                }
            }
    ...
    while !catal.is_null() {
        if (*catal).type_0 as libc::c_int == XML_CATA_CATALOG as libc::c_int {
            ...
            if !((*catal).children).is_null() {
                ...
                if !((*catal).children).is_null()
                    && (*(*catal).children).depth > 50 as libc::c_int
                {
            ...
            && *cur.offset(1 as libc::c_int as isize) as libc::c_int == '-' as i32
        {
                ...
                || *cur as libc::c_int == 0xd as libc::c_int)
            {
                ...
                ) != 0
                {
                    ...
                    name,
                    b"OVERRIDE\0" as *const u8 as *const libc::c_char as *const xmlChar,
                ) != 0
                {
                    xmlFree
                ...
                match type_0 as libc::c_int {
                    15 => {
                        ...
                        current_block_55 = 5593470657357338297;
                    }
                    16 | 17 | 18 | 19 => {
                        current_block_55 = 5593470657357338297;
                    }
                    14 | 13 | 20 => {
                        ...
                        current_block_55 = 16231175055492490595;
                    }
                    21 | 22 | 23 | 24 => {
                        cur = xmlParseSGMLCatalogPubid(cur, &mut sysid);
                        cur.is_null();
...
pub unsafe extern "C" fn xmlACatalogAdd(
        ...
        == XML_XML_CATALOG_TYPE as libc::c_int as libc::c_uint
    {
        ...
        if cattype as libc::c_int != XML_CATA_NONE as libc::c_int {
            ...
            if ((*catal).sgml).is_null() {
                (*catal).sgml = xmlHashCreate(10 as libc::c_int);
            }
...
pub unsafe extern "C" fn xmlInitializeCatalog() {
    ...
    if xmlDefaultCatalog.is_null() {
        ...
        catalogs = getenv(b"XML_CATALOG_FILES\0" as *const u8 as *const libc::c_char)
            as *const libc::c_char;
        if catalogs.is_null() {
            catalogs = b"file:///etc/xml/catalog\0" as *const u8 as *const libc::c_char;
        }
        catal = xmlCreateNewCatalog(XML_XML_CATALOG_TYPE, xmlCatalogDefaultPrefer);
        if !catal.is_null() {
            cur = catalogs;
    ...
    if !xmlDefaultCatalog.is_null() {
        ...
        if !ret.is_null() && ret != -(1 as libc::c_int) as *mut xmlChar {
            snprintf(
                ...
                (::core::mem::size_of::<[xmlChar; 1000]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
                b"%s\0" as *const u8 as *const libc::c_char,
                ret as *mut libc::c_char,
            );
            result[(::core::mem::size_of::<[xmlChar; 1000]>() as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)

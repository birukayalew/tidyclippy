...
unsafe extern "C" fn xmlC14NVisibleNsStackCreate() -> xmlC14NVisibleNsStackPtr {
    ...
    ret = xmlMalloc
        ...
        )(::core::mem::size_of::<xmlC14NVisibleNsStack>() as libc::c_ulong)
...
unsafe extern "C" fn xmlC14NStrEqual(
    ...
    if str1.is_null() {
        return (*str2 as libc::c_int == '\0' as i32) as libc::c_int;
    }
    if str2.is_null() {
        return (*str1 as libc::c_int == '\0' as i32) as libc::c_int;
    }
    loop {
        let fresh2 = str1;
        str1 = str1.offset(1);
...
unsafe extern "C" fn xmlC14NProcessNamespacesAxis(
    ...
    if visible != 0 && has_empty_ns == 0 {
        static mut ns_default: xmlNs = _xmlNs {
            next: 0 as *mut _xmlNs,
            type_0: 0 as xmlNsType,
            href: 0 as *const xmlChar,
            prefix: 0 as *const xmlChar,
...
unsafe extern "C" fn xmlExcC14NProcessNamespacesAxis(
        ...
        && has_empty_ns_in_inclusive_list == 0
    {
        ...
        static mut ns_default_0: xmlNs = _xmlNs {
            next: 0 as *mut _xmlNs,
            type_0: 0 as xmlNsType,
            href: 0 as *const xmlChar,
            prefix: 0 as *const xmlChar,
...
unsafe extern "C" fn xmlC14NProcessElementNode(
    ...
    let mut state: xmlC14NVisibleNsStack = _xmlC14NVisibleNsStack {
        nsCurEnd: 0,
        nsPrevStart: 0,
        nsPrevEnd: 0,
        nsMax: 0,
...
unsafe extern "C" fn xmlC14NProcessNode(
    ...
    match (*cur).type_0 as libc::c_uint {
        1 => {
            ...
            current_block_76 = 16779030619667747692;
        }
        4 | 3 => {
        ...
        7 => {
            if visible != 0 {
                ...
                if !((*cur).content).is_null()
                    && *(*cur).content as libc::c_int != '\0' as i32
                {
        ...
        21 => {
            current_block_76 = 14877710230710643196;
        }
        9 | 11 | 13 => {
            current_block_76 = 14877710230710643196;
        }
...
unsafe extern "C" fn xmlC14NNewCtx(
    ...
    if (*doc).charset != XML_CHAR_ENCODING_UTF8 as libc::c_int {
        xmlC14NErr(
            ctx,
            doc as xmlNodePtr,
            XML_C14N_REQUIRES_UTF8 as libc::c_int,
    ...
    ctx = xmlMalloc
        .expect(
            "non-null function pointer",
        )(::core::mem::size_of::<xmlC14NCtx>() as libc::c_ulong) as xmlC14NCtxPtr;
    if ctx.is_null() {
    ...
    memset(
        ctx as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<xmlC14NCtx>() as libc::c_ulong,
    );
    (*ctx).doc = doc;
...
pub unsafe extern "C" fn xmlC14NDocDumpMemory(
    ...
    *doc_txt_ptr = 0 as *mut xmlChar;
    ...
    if (*doc_txt_ptr).is_null() && ret > 0 as libc::c_int {
        xmlC14NErrMemory(
            b"coping canonicanized document\0" as *const u8 as *const libc::c_char,
        );
        return -(1 as libc::c_int);
    }
    return ret;
...
pub unsafe extern "C" fn xmlC14NDocSave(
    ...
    if ret < 0 as libc::c_int {
        xmlC14NErrInternal(
            b"cannicanize document to buffer\0" as *const u8 as *const libc::c_char,
        );
        xmlOutputBufferClose(buf);
        return -(1 as libc::c_int);
    }

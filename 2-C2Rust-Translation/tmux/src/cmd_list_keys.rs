...
extern "C" {
    ...
    fn key_bindings_RB_MINMAX(_: *mut key_bindings, _: libc::c_int) -> *mut key_binding;
    fn key_tables_RB_MINMAX(_: *mut key_tables, _: libc::c_int) -> *mut key_table;
...
pub static mut cmd_list_keys_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"list-keys\0" as *const u8 as *const libc::c_char,
            alias: b"lsk\0" as *const u8 as *const libc::c_char,
            args: {
            ...
            usage: b"[-T key-table]\0" as *const u8 as *const libc::c_char,
...
pub static mut cmd_list_commands_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"list-commands\0" as *const u8 as *const libc::c_char,
            alias: b"lscm\0" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_31 {
                    template: b"F:\0" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
                    upper: 0 as libc::c_int,
                };
                init
            },
            usage: b"[-F format]\0" as *const u8 as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
                flags: 0,
...
unsafe extern "C" fn cmd_list_keys_exec(
        ...
        && (key_bindings_get_table(tablename, 0 as libc::c_int)).is_null()
    {
        cmdq_error(
            item,
            b"table %s doesn't exist\0" as *const u8 as *const libc::c_char,
            tablename,
        );
    ...
    while !table.is_null() {
            ...
            && strcmp((*table).name, tablename) != 0 as libc::c_int)
        {
            ...
            while !bd.is_null() {
                key = key_string_lookup_key((*bd).key);
                if repeat == 0 {
                    r = b"\0" as *const u8 as *const libc::c_char;
                } else if (*bd).flags & 0x1 as libc::c_int != 0 {
                    r = b"-r \0" as *const u8 as *const libc::c_char;
                } else {
                    r = b"   \0" as *const u8 as *const libc::c_char;
                }
                xsnprintf(
                ...
                cmdq_print(
                    item,
                    b"bind-key %s\0" as *const u8 as *const libc::c_char,
                    tmp.as_mut_ptr(),
                );
                bd = key_bindings_RB_NEXT(bd);
            }
...
unsafe extern "C" fn cmd_list_keys_commands(
    ...
    if template.is_null() {
        template = b"#{command_list_name}#{?command_list_alias, (#{command_list_alias}),} #{command_list_usage}\0"
    ...
    while !(*entryp).is_null() {
        ...
        format_add(
            ft,
            b"command_list_name\0" as *const u8 as *const libc::c_char,
        ...
        format_add(
            ft,
            b"command_list_alias\0" as *const u8 as *const libc::c_char,
            b"%s\0" as *const u8 as *const libc::c_char,
            s,
        );
        ...
        format_add(
            ft,
            b"command_list_usage\0" as *const u8 as *const libc::c_char,
            b"%s\0" as *const u8 as *const libc::c_char,
            s,
        );
        line = format_expand(ft, template);
        if *line as libc::c_int != '\0' as i32 {
            cmdq_print(item, b"%s\0" as *const u8 as *const libc::c_char, line);
        }

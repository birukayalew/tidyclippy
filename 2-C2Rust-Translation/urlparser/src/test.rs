...
pub unsafe extern "C" fn strdup(mut str: *const libc::c_char) -> *mut libc::c_char {
    let mut n: libc::c_int = (strlen(str))
...
unsafe extern "C" fn get_part(
    ...
    let mut tmp_url: *mut libc::c_char = strdup(url);
    let mut fmt_url: *mut libc::c_char = strdup(url);
...
pub unsafe extern "C" fn url_parse(mut url: *mut libc::c_char) -> *mut url_data_t {
    ...
    let mut tmp_url: *mut libc::c_char = strdup(url);
    let mut is_ssh: bool = 0 as libc::c_int != 0;
    let mut protocol: *mut libc::c_char = url_get_protocol(tmp_url);
    if protocol.is_null() {
        return 0 as *mut url_data_t;
    }
    let mut protocol_len: libc::c_int = strlen(protocol) as libc::c_int
        + 3 as libc::c_int;
    (*data).protocol = protocol;
    is_ssh = url_is_ssh(protocol);
    let mut auth: *mut libc::c_char = malloc(
        ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
    ) as *mut libc::c_char;
    let mut auth_len: libc::c_int = 0 as libc::c_int;
    ...
    let mut hostname_len: libc::c_int = strlen(hostname) as libc::c_int;
    let mut tmp_hostname: *mut libc::c_char = strdup(hostname);
    (*data).hostname = hostname;
    let mut host: *mut libc::c_char = malloc(
        (strlen(tmp_hostname))
    ...
    let mut host_len: libc::c_int = strlen(host) as libc::c_int;
    (*data).host = host;
    let mut tmp_path: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    let mut fmt: *mut libc::c_char = (if is_ssh as libc::c_int != 0 {
        b"%s\0" as *const u8 as *const libc::c_char
    } else {
        b"/%s\0" as *const u8 as *const libc::c_char
    }) as *mut libc::c_char;
    ...
    let mut pathname: *mut libc::c_char = malloc(
        ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
    ) as *mut libc::c_char;
    if pathname.is_null() {
        return 0 as *mut url_data_t;
    ...
    let mut pathname_len: libc::c_int = strlen(pathname) as libc::c_int;
    (*data).pathname = pathname;
    let mut search: *mut libc::c_char = malloc(
    ...
    (*data).search = search;
    let mut search_len: libc::c_int = strlen(search) as libc::c_int;
    free(tmp_path as *mut libc::c_void);
    let mut query: *mut libc::c_char = malloc(
        ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
    ) as *mut libc::c_char;
    if query.is_null() {
        return 0 as *mut url_data_t;
    ...
    (*data).query = query;
    let mut hash: *mut libc::c_char = malloc(
        ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
    ) as *mut libc::c_char;
    if hash.is_null() {
        return 0 as *mut url_data_t;
    ...
    (*data).hash = hash;
    free(tmp_path as *mut libc::c_void);
    let mut port: *mut libc::c_char = malloc(
        ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
    ) as *mut libc::c_char;
    if port.is_null() {
        return 0 as *mut url_data_t;
...
pub unsafe extern "C" fn url_is_protocol(mut str: *mut libc::c_char) -> bool {
    let mut count: libc::c_int = (::core::mem::size_of::<[*mut libc::c_char; 177]>()
        as libc::c_ulong)
...
pub unsafe extern "C" fn url_get_protocol(
    ...
    let mut protocol: *mut libc::c_char = malloc(
...
pub unsafe extern "C" fn url_get_auth(mut url: *mut libc::c_char) -> *mut libc::c_char {
    let mut protocol: *mut libc::c_char = url_get_protocol(url);
    if protocol.is_null() {
        return 0 as *mut libc::c_char;
    }
    let mut l: libc::c_int = strlen(protocol) as libc::c_int + 3 as libc::c_int;
...
pub unsafe extern "C" fn url_get_hostname(
    ...
    let mut l: libc::c_int = 3 as libc::c_int;
    let mut protocol: *mut libc::c_char = url_get_protocol(url);
    let mut tmp_protocol: *mut libc::c_char = strdup(protocol);
    let mut auth: *mut libc::c_char = url_get_auth(url);
    if protocol.is_null() {
        return 0 as *mut libc::c_char;
    }
    if !auth.is_null() {
    ...
    let mut hostname: *mut libc::c_char = if url_is_ssh(tmp_protocol) as libc::c_int != 0
    {
...
pub unsafe extern "C" fn url_get_host(mut url: *mut libc::c_char) -> *mut libc::c_char {
    ...
    let mut hostname: *mut libc::c_char = url_get_hostname(url);
...
pub unsafe extern "C" fn url_get_pathname(
    ...
    let mut path: *mut libc::c_char = url_get_path(url);
    let mut pathname: *mut libc::c_char = malloc(
        ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
    ) as *mut libc::c_char;
...
pub unsafe extern "C" fn url_get_search(
    ...
    let mut path: *mut libc::c_char = url_get_path(url);
    let mut pathname: *mut libc::c_char = url_get_pathname(url);
    let mut search: *mut libc::c_char = malloc(
        ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
    ) as *mut libc::c_char;
    ...
    let mut tmp_path: *mut libc::c_char = strff(path, strlen(pathname) as libc::c_int);
    strcat(search, b"\0" as *const u8 as *const libc::c_char);
    sscanf(tmp_path, b"%[^#]\0" as *const u8 as *const libc::c_char, search);
...
pub unsafe extern "C" fn url_get_query(mut url: *mut libc::c_char) -> *mut libc::c_char {
    let mut search: *mut libc::c_char = url_get_search(url);
    let mut query: *mut libc::c_char = malloc(
        ::core::mem::size_of::<libc::c_char>() as libc::c_ulong,
    ) as *mut libc::c_char;
    if search.is_null() {
...
pub unsafe extern "C" fn url_get_hash(mut url: *mut libc::c_char) -> *mut libc::c_char {
    ...
    let mut pathname_len: libc::c_int = strlen(pathname) as libc::c_int;
    let mut search_len: libc::c_int = strlen(search) as libc::c_int;
    let mut tmp_path: *mut libc::c_char = strff(path, pathname_len + search_len);
    strcat(hash, b"\0" as *const u8 as *const libc::c_char);
    sscanf(tmp_path, b"%s\0" as *const u8 as *const libc::c_char, hash);
...
pub unsafe extern "C" fn url_get_port(mut url: *mut libc::c_char) -> *mut libc::c_char {
    ...
    let mut hostname: *mut libc::c_char = url_get_hostname(url);
    let mut host: *mut libc::c_char = url_get_host(url);
    if port.is_null() || hostname.is_null() {
        return 0 as *mut libc::c_char;
    }
    let mut tmp_hostname: *mut libc::c_char = strff(
        hostname,
...
unsafe fn main_0() -> libc::c_int {
    ...
    let mut url: *mut libc::c_char = b"http://user:pass@subdomain.host.com:8080/p/a/t/h?query=string#hash\0"
        as *const u8 as *const libc::c_char as *mut libc::c_char;
